---
title: "Pearlscale Butterflyfish: Is It Reef Safe? Care Guide & Compatibility"
description: "Is the pearlscale butterflyfish (Chaetodon xanthurus) reef safe? A complete care guide covering tank setup, diet, water parameters, and an honest look at coral and clam compatibility."
slug: "pearlscale-butterflyfish-reef-safe"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A genuinely beautiful butterflyfish — but one that comes with real reef-safety caveats. Here's the honest answer on what it will and won't eat in a coral tank."
tags: ["butterflyfish", "saltwater", "reef caution", "FOWLR"]
quickFacts:
  - label: "Scientific Name"
    value: "Chaetodon xanthurus"
  - label: "Care Level"
    value: "Moderate to difficult"
  - label: "Minimum Tank Size"
    value: "75 gallons (285 L)"
  - label: "Temperament"
    value: "Peaceful but can be territorial toward other butterflyfish"
  - label: "Diet"
    value: "Omnivore, with strong tendency toward coral polyps and tunicates"
  - label: "Reef Safe"
    value: "With caution — risk to LPS corals and clam mantles"
  - label: "Max Size"
    value: "~6 inches (15 cm)"
  - label: "Lifespan"
    value: "5-7 years in captivity"
faq:
  - q: "Will a pearlscale butterflyfish eat my corals?"
    a: "It might. Pearlscale butterflyfish are not reliable coral grazers like tangs, but a meaningful number of individuals will pick at LPS coral polyps — especially euphyllia (frogspawn, hammer, torch), acan, and zoanthids — as well as the mantle tissue of clams. Soft corals and SPS are generally lower risk but not guaranteed safe with every individual."
  - q: "Can I keep a pearlscale butterflyfish in a reef tank with clams?"
    a: "This is one of the higher-risk combinations. Pearlscale butterflyfish are known to pick at the exposed mantle of Tridacna clams, sometimes repeatedly targeting the same animal until it stops opening or dies. If your reef tank's centerpiece is a clam collection, a pearlscale butterflyfish is not a safe pairing."
  - q: "Is the pearlscale butterflyfish reef safe with soft corals only?"
    a: "It's a better bet than an LPS- or clam-heavy tank, but still not guaranteed. Many pearlscale butterflyfish leave soft corals like leathers, mushrooms, and zoanthid-free soft coral colonies alone, but individual behavior varies — some specimens will sample anything with polyps when food is scarce. Heavy, varied feeding reduces but doesn't eliminate this risk."
  - q: "What's the best tank setup for a pearlscale butterflyfish if I don't have a reef tank?"
    a: "A FOWLR (fish-only-with-live-rock) or fish-only system of 75+ gallons with plenty of rockwork is ideal — it removes the coral-compatibility question entirely and lets the fish display its natural grazing behavior on rock-dwelling algae and invertebrates without putting any livestock at risk."
related: ["yellowtail-damselfish", "common-clownfish", "flame-angelfish", "banggai-cardinalfish"]
sources:
  - label: "Chaetodon xanthurus — FishBase"
    url: "https://www.fishbase.se/summary/Chaetodon-xanthurus.html"
  - label: "LiveAquaria: Butterflyfish Care and Compatibility"
...
- **Zoanthids and palythoa** — **moderate to high risk.** These small-polyped colonial corals are commonly sampled by butterflyfish, sometimes to the point of a colony being stripped over weeks.
...
- Clownfish, including the [common clownfish](/common-clownfish/) — different niche, no competition
- Cardinalfish such as the [Banggai cardinalfish](/banggai-cardinalfish/), which occupy the water column and have zero overlap in feeding behavior
- Tangs, wrasses, and other active mid-to-large reef fish
- Semi-aggressive fish like the [flame angelfish](/flame-angelfish/) generally coexist fine, though in a reef tank you're effectively stacking two species with some coral-picking risk — worth considering if you're trying to keep a coral-heavy display

**Approach with care:**

- Other butterflyfish, particularly other *Chaetodon* species, in smaller tanks
- Small, slow damselfish like the [yellowtail damselfish](/yellowtail-damselfish/) can occasionally be picked on by a larger, more active pearlscale butterflyfish, though serious aggression is uncommon
