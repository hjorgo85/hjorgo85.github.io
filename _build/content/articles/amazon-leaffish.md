---
title: "Amazon Leaffish (Monocirrhus polyacanthus) Care Guide: Camouflage, Diet & Tank Setup"
description: "The Amazon leaffish (Monocirrhus polyacanthus) is a near-perfect dead-leaf mimic and a strict live-food ambush predator — here's what its camouflage means for tank design, diet, and tank mates."
slug: "amazon-leaffish"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Shaped, colored, and even angled to look exactly like a dead leaf drifting in slow water, the Amazon leaffish is one of the most extreme camouflage specialists in the freshwater hobby — and one of the most demanding to feed."
tags: ["amazon leaffish", "monocirrhus", "oddball fish", "ambush predator", "live food"]
quickFacts:
  - label: "Scientific Name"
    value: "Monocirrhus polyacanthus"
  - label: "Common Names"
    value: "Amazon leaffish, South American leaffish"
  - label: "Native Range"
    value: "Slow-moving, vegetated waters of the Amazon basin and other South American river systems"
  - label: "Care Level"
    value: "Difficult — specialized live-food diet and water chemistry needs"
  - label: "Minimum Tank Size"
    value: "20+ gallons, heavily planted/decorated with calm water flow"
  - label: "Diet"
    value: "Strict live-food ambush predator — primarily live fish fry and similarly sized live prey"
  - label: "Max Size"
    value: "Around 3-4 inches (8-10 cm)"
  - label: "Water Type"
    value: "Soft, acidic, blackwater-style conditions strongly preferred"
faq:
  - q: "Why does an Amazon leaffish look exactly like a dead leaf?"
    a: "It's camouflage built for **ambush predation**, and it's remarkably complete — the body shape is flattened and angular like a leaf, the coloration ranges through mottled browns and tans similar to decaying leaf litter, and the fish even tends to **orient itself at an angle**, drifting motionlessly in a way that mimics a leaf caught in slow current. This isn't just passive camouflage; it's an active hunting strategy. Prey species that would flee from an obviously fish-shaped predator often don't react to what looks like inert plant debris, allowing the leaffish to drift close before striking with a surprisingly fast lunge."
  - q: "Will an Amazon leaffish eat pellets or flake food?"
    a: "Almost never, and this is the single biggest reason this species is considered difficult. *Monocirrhus polyacanthus* is an **obligate or near-obligate live-food predator** in most individuals, relying on **movement** to trigger a feeding response — a motionless pellet, no matter how nutritious, frequently isn't recognized as food at all. The realistic diet for most individuals is **live fish fry** (livebearer fry are commonly used) or other small live prey of an appropriate size. Some long-term-kept individuals have been trained onto frozen foods presented with movement (via a feeding stick or current), but this isn't reliable across all individuals, and prospective keepers should plan around live food as the default, not the exception."
  - q: "Can Amazon leaffish live with other fish?"
    a: "Generally not well, for two separate reasons. First, **it's a predator** — any tank mate small enough to fit in its mouth is a potential meal, which rules out most small community fish. Second, and less obviously, **it's a slow, deliberate eater** that relies on prey coming close enough for an ambush strike — faster, more active tank mates can out-compete it for food even when the leaffish isn't itself the one being preyed upon. In practice, Amazon leaffish are most often kept alone or in small same-species groups in a dedicated tank, rather than as part of a mixed community."
  - q: "What water conditions does an Amazon leaffish need?"
    a: "**Soft, acidic, blackwater-style conditions** are strongly preferred, reflecting the slow-moving, leaf-litter-strewn waters of its native Amazon basin habitats. This typically means a lower pH (often in the 5.5-6.5 range), soft water, and sometimes the addition of botanicals (leaf litter, driftwood tannins) to replicate the tea-colored water of a true blackwater environment — similar in spirit to setups used for other soft-water specialists, though the leaffish's feeding requirements are a far bigger barrier to success than its water chemistry alone."
related: ["african-butterfly-fish", "coolest-freshwater-aquarium-fish", "what-can-i-feed-my-dragon-goby-fish", "betta-fish-care-guide", "four-eyed-fish", "brackish-water-aquarium-fish"]
sources:
  - label: "Monocirrhus polyacanthus — FishBase"
    url: "https://www.fishbase.se/summary/Monocirrhus-polyacanthus.html"
  - label: "Leaffish Care and Live Food Feeding — Practical Fishkeeping"
...
This level of camouflage commitment earns the Amazon leaffish a spot in our roundup of [the coolest freshwater aquarium fish](/coolest-freshwater-aquarium-fish/), alongside other species that stand out for unusual biology rather than just color — including the [African butterfly fish](/african-butterfly-fish/), an ambush predator that takes the opposite approach by gliding above the water instead of hiding within it.
...
For a different kind of ambush specialist — one that hunts from the water's surface rather than camouflaged among leaf litter — see our [African butterfly fish guide](/african-butterfly-fish/). The two species share an "ambush predator" theme but occupy almost entirely different niches, diets, and tank setups.
