---
title: "Does Coral Dip Kill Aiptasia? What Dipping Can and Can't Do"
description: "Coral dips can kill or dislodge aiptasia attached to a new frag — but dipping is a prevention step for incoming corals, not a treatment for aiptasia already established in your display tank."
slug: "does-coral-dip-kill-aiptasia"
type: "article"
...
image: "/assets/img/articles/does-coral-dip-kill-aiptasia.webp"
imageAlt: "A coral frag being dipped in a container of treatment solution before being added to a reef tank"
imageWidth: 1200
imageHeight: 800
excerpt: "Dipping a new coral frag can kill or dislodge a small aiptasia hitchhiking on it — but once aiptasia is established in your display tank, dipping the whole system isn't the answer."
tags: ["aiptasia", "coral dip", "reef tank", "pest control", "coral care"]
quickFacts:
  - label: "What Coral Dips Are"
    value: "Iodine-based or proprietary chemical solutions used to treat new coral frags before adding them to a tank"
  - label: "Effect on Aiptasia"
    value: "Can kill or dislodge small aiptasia attached directly to a dipped frag"
  - label: "Best Use"
    value: "Preventive — dip new frags and inspect rock before introducing anything to the main tank"
  - label: "Not a Main-Tank Treatment"
    value: "Dipping an entire established tank isn't practical or safe for existing corals and fish"
  - label: "Established Aiptasia Treatments"
    value: "Targeted injection (aiptasia-specific products or kalkwasser paste), biological control (peppermint shrimp, Berghia nudibranchs), or careful manual removal"
  - label: "Reproduction Risk"
    value: "Aiptasia can reproduce from fragments — incomplete removal can make populations worse, not better"
  - label: "Inspection Step"
    value: "Visually inspect new frags and rock for aiptasia before dipping and adding to the tank"
  - label: "Other Pests Addressed"
    value: "Coral dips also help with other hitchhikers — flatworms, pest snail eggs, and some bristle worms"
faq:
  - q: "What is a coral dip and how is it used?"
    a: "A coral dip is a **chemical treatment solution** — commonly iodine-based or a proprietary commercial blend — that a coral frag is briefly submerged in (typically for a few minutes, following the product's specific instructions) **before being added to a tank**. The goal is to dislodge or kill small pests that may be hitchhiking on the frag's base, skeleton, or tissue: aiptasia, flatworms, pest snail eggs, and certain bristle worms are common targets. After dipping, the frag is usually rinsed and inspected, with any dislodged pests removed before the frag goes into the display tank. This is fundamentally a **preventive quarantine step** for incoming corals, not a treatment applied to an already-stocked tank."
  - q: "Will dipping a coral frag kill aiptasia that's already attached to it?"
    a: "**Often, yes, for small aiptasia directly on or near the frag** — a proper coral dip can kill small aiptasia polyps or cause them to detach from the frag, which is exactly the scenario coral dips are designed to address. This is most effective when the aiptasia is **small and recently established** on the frag, rather than a mature anemone with an extensive root system in the rock. After dipping, a careful visual inspection of the frag's base and surrounding rock — looking for any remaining aiptasia tissue — is worth doing before adding the frag to your tank, since a dip that dislodges most but not all of an aiptasia can still leave behind tissue capable of regenerating."
  - q: "Can I use coral dip to get rid of aiptasia already established in my display tank?"
...
sources:
  ...
  - label: "Hydroids and Aiptasia Control — Reef Builders"
