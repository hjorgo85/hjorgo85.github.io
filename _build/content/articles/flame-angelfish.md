---
title: "Flame Angelfish Care Guide: Tank Setup, Diet & Reef Compatibility"
description: "Complete care guide for the flame angelfish (Centropyge loricula): tank size, water parameters, diet, reef compatibility, and tank mates for a home saltwater aquarium."
...
imageWidth: 1200
imageHeight: 800
excerpt: "One of the most striking dwarf angelfish in the hobby — here's how to set up its tank, what to feed it, and how to manage its reputation for nipping coral polyps."
tags: ["angelfish", "saltwater", "dwarf angelfish", "reef caution"]
quickFacts:
  - label: "Scientific Name"
    value: "Centropyge loricula"
  - label: "Care Level"
    value: "Moderate — not a beginner's first fish"
  - label: "Minimum Tank Size"
    value: "55 gallons (210 L)"
  - label: "Temperament"
    value: "Semi-aggressive, territorial toward similar shapes"
  - label: "Diet"
    value: "Omnivore (marine algae, mysis, pellet, nori)"
  - label: "Reef Safe"
    value: "With caution — some risk to LPS and clam mantles"
  - label: "Max Size"
    value: "~4 inches (10 cm)"
  - label: "Lifespan"
    value: "5-7 years (up to 10 with excellent care)"
faq:
  - q: "Is the flame angelfish reef safe?"
    a: "Mostly, but with caveats. Flame angelfish rarely bother soft corals or SPS, but a meaningful percentage of individuals will pick at the polyps of LPS corals (especially zoanthids, clove polyps, and some Acropora-adjacent species) and nip at clam mantles. Many reefers keep them successfully in mixed reef tanks, but it's a gamble worth watching closely after introduction."
  - q: "Can I keep two flame angelfish together?"
    a: "Only in large tanks (125+ gallons) with careful introduction, and even then it's risky. Centropyge angelfish are territorial toward their own species and similarly shaped fish; two flame angels in a tank under 100 gallons will almost always result in one harassing the other to the point of stress-related illness or death. The same territorial dynamic applies to pairing a flame angel with other dwarf angelfish, including the [coral beauty angelfish](/coral-beauty/) — a similarly sized *Centropyge* species with nearly identical care requirements but a different look."
  - q: "Why does my flame angelfish hide all the time?"
...
sources:
  ...
  - label: "Reef2Reef: Flame Angelfish Reef Compatibility Discussion"
...
- Clownfish, including the [common clownfish](/common-clownfish/), which occupy a completely different niche and rarely draw a flame angel's attention
- Peaceful to semi-aggressive damselfish such as the [yellowtail damselfish](/yellowtail-damselfish/), gobies, blennies, and most wrasses
- Cardinalfish, including the [Banggai cardinalfish](/banggai-cardinalfish/), which occupy the water column and have completely different feeding and territorial behavior — a low-conflict pairing in most tanks
...
- Any butterflyfish, including the [pearlscale butterflyfish](/pearlscale-butterflyfish-reef-safe/), if the tank is small — both species can compete for grazing territory and the combined polyp-picking risk in a reef tank compounds
