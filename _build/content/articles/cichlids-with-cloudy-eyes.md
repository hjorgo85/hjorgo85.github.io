---
title: "Cichlids With Cloudy Eyes: Causes, Treatment & When to Worry"
description: "Cloudy or hazy eyes in cichlids are usually a water quality signal first and a disease signal second. Here's how to tell the difference and what to do about each."
slug: "cichlids-with-cloudy-eyes"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Cloudy eyes in cichlids most often start as a water quality problem, not a disease — but injury, infection, and even diet can all produce the same visible symptom. Here's how to tell them apart."
tags: ["cichlids", "freshwater", "fish health", "water quality"]
quickFacts:
  - label: "Most Common Cause"
    value: "Poor water quality (ammonia/nitrite irritation) causing a protective mucus response"
  - label: "Other Causes"
    value: "Physical injury, bacterial/fungal infection, parasites (flukes), cataracts"
  - label: "First Step"
    value: "Test water parameters — ammonia, nitrite, nitrate, pH"
  - label: "Is It Contagious?"
    value: "Water-quality-related cloudy eye is not contagious; infections can spread"
  - label: "Typical Recovery"
    value: "Days to 1-2 weeks once water quality is corrected, if caught early"
  - label: "When Medication Is Needed"
    value: "If cloudiness persists after water quality correction, or with other infection signs"
  - label: "One-Eye vs. Both-Eyes"
    value: "One eye often points to injury; both eyes more often points to water quality/systemic causes"
  - label: "Prevention"
    value: "Consistent water changes, avoiding overstocking and overfeeding"
faq:
  - q: "Why does my cichlid have a cloudy or white film over its eye?"
    a: "The most common cause is poor water quality — particularly elevated ammonia or nitrite — which irritates the eye's surface and triggers a protective mucus response that appears as a cloudy or hazy film. This is sometimes called 'cloudy eye' as a standalone symptom and is one of the more common visible signs that water parameters need attention, even before other symptoms (like reduced appetite) become obvious."
  - q: "Is cloudy eye in cichlids contagious?"
    a: "It depends on the cause. If cloudy eye is a response to water quality, it isn't 'contagious' in the sense of spreading between fish — though if water quality is poor enough to affect one fish's eyes, other fish in the same tank are exposed to the same conditions and may show symptoms too, or be at elevated risk of other problems. If the underlying cause is a bacterial or fungal infection (more likely if cloudiness is accompanied by other signs like fin damage, lethargy, or it's localized to an injury site), that infection can potentially spread to other fish, particularly in a tank with existing injuries or stress."
  - q: "How do I treat cloudy eye in cichlids?"
...
Cichlids are often kept in setups with significant rockwork and, in many cases, real territorial aggression between tankmates (a dynamic covered from the stocking side in our [75-gallon peacock cichlid guide](/75-gallon-peacock-cichlid-tank/)). A scratch or impact to the eye — from a sharp rock edge, a chase into decor, or a bite from a tankmate — can cause localized cloudiness, often in **just one eye**, sometimes alongside other visible damage (torn fins, scale loss).
