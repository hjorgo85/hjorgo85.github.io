---
title: "Malaysian Driftwood vs. Mopani Wood: Which Is Right for Your Aquascape?"
description: "Malaysian driftwood and Mopani wood are two of the most popular aquarium driftwood types — both leach tannins and need pre-soaking, but they differ in sinking time, appearance, and that famous white fuzz."
slug: "malaysian-driftwood-vs-mopani"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Malaysian driftwood and Mopani wood both leach tannins and need pre-soaking before they go in a tank, but they differ in how fast they sink, how they look, and whether you'll see a white fuzzy bloom in the first few weeks."
tags: ["driftwood", "aquascaping", "planted tank", "freshwater", "decor"]
quickFacts:
  - label: "Origins"
    value: "Malaysian driftwood is typically dense Southeast Asian root/branch wood; Mopani wood comes from southern Africa and is known for its two-tone grain"
  - label: "Sinking Time"
    value: "Malaysian driftwood is often dense enough to sink with minimal soaking; Mopani frequently needs a longer soak (or boiling, for smaller pieces) to fully saturate and sink"
  - label: "Tannin Release"
    value: "Both leach tannins, tinting the water amber/tea-colored for weeks to months — more noticeable early on, especially with Mopani"
  - label: "White Fungal Bloom"
    value: "Mopani wood is especially prone to a harmless white fuzzy fungal bloom in the first 1-3 weeks underwater — startling to new keepers but not a problem"
  - label: "Appearance"
    value: "Malaysian driftwood often comes in larger, twisted or branching pieces; Mopani is known for its distinctive two-tone tan-and-dark-brown striated grain"
  - label: "Water Chemistry Effect"
    value: "Both soften and slightly acidify water via tannins — neither is a good fit for hard, alkaline setups like Lake Malawi cichlid tanks"
  - label: "Plant Attachment"
    value: "Both work well as anchor points for mosses, anubias, and java fern, typically secured with thread or aquarium-safe cyanoacrylate gel"
  - label: "Pre-Soak Recommendation"
    value: "Both benefit from a pre-soak (and ideally boiling, for smaller pieces) to speed up sinking and reduce the initial tannin release"
faq:
  - q: "Which one sinks faster and needs less preparation?"
    a: "**Malaysian driftwood generally sinks faster and with less prep.** It tends to be **denser** than Mopani wood right out of the package, and many pieces will sink — or come close to sinking — after a relatively short soak, sometimes needing nothing more than a weight or rubber-band-and-rock arrangement for the first few days while it fully saturates. **Mopani wood is more likely to float persistently**, sometimes for a week or more, until it absorbs enough water to sink on its own. For smaller Mopani pieces, **boiling** (in a pot large enough to fully submerge the piece, for an hour or more) speeds this up significantly and also helps leach out some of the initial tannins. Either type can be temporarily weighted down with a clean rock, a suction-cup anchor, or — once it's positioned where you want it — secured more permanently using the same [cyanoacrylate gel approach covered in our reef tank super glue guide](/super-glue-reef-tank/), which works just as well for anchoring driftwood pieces together or to a base rock in a freshwater aquascape."
  - q: "Is the white fuzzy stuff on my new Mopani wood dangerous?"
    a: "**No — it's a very common and harmless fungal/biofilm bloom, and it's one of the most frequently asked questions from anyone using Mopani wood for the first time.** New driftwood, and Mopani especially, often develops a **white, cottony or fuzzy growth** across some or all of its submerged surface within the first one to three weeks. This is typically a harmless fungus feeding on residual organic matter in the wood's surface layers, and it's a normal part of new wood 'breaking in' underwater — not a sign of contamination, rot, or anything that needs to be removed urgently. It usually fades on its own over a few weeks as the wood's surface stabilizes, though some keepers gently brush or siphon away larger patches if they find it unsightly. Once a tank is more established, this same surface biofilm (along with any algae that develops on the wood) becomes a food source — it's part of what makes driftwood surfaces appealing to grazers like the snails covered in our [nerite vs. mystery snail comparison](/nerite-snails-vs-mystery-snails/)."
  - q: "Will either of these work in an African cichlid tank?"
    a: "**Generally, no — and this isn't really a Malaysian-vs-Mopani question, since both types share the same underlying issue.** Both leach tannins that **soften and slightly acidify** the water, which works against the **hard, alkaline water** (roughly pH 7.8-8.6) that Lake Malawi and other African cichlids need. This is covered in more depth in our guide to [driftwood in cichlid tanks](/driftwood-cichlid-tank/), which goes through why rock-based aquascaping is the better fit for that water chemistry — and the same logic applies whether the driftwood in question is Malaysian, Mopani, or any other type. It's also worth thinking about substrate alongside driftwood: a setup using [crushed coral](/crushed-coral-vs-live-sand/) for its water-hardening effect and a piece of tannin-leaching driftwood are working against each other chemically, regardless of which substrate or wood type is involved."
  - q: "Can I attach plants directly to Malaysian driftwood or Mopani wood?"
    a: "**Yes — both are commonly used as anchor points for epiphyte plants, and the attachment method doesn't really depend on which type of wood it is.** Mosses, anubias, java fern, and similar plants that don't need to be planted in [substrate](/plant-substrate-for-aquariums/) are routinely tied onto driftwood with cotton thread or fine fishing line until their roots/rhizoids grip the wood's surface on their own — at which point the thread can be left in place or removed. Aquarium-safe cyanoacrylate gel (the same type discussed in our [reef tank super glue guide](/super-glue-reef-tank/)) is another common attachment method, particularly for moss, and works on both Malaysian driftwood and Mopani wood without issue. The wood's tannin release doesn't meaningfully affect either attachment method — it's purely a water-chemistry consideration, separate from how well plants will physically attach and grow on the surface."
related: ["driftwood-cichlid-tank", "crushed-coral-vs-live-sand", "super-glue-reef-tank", "plant-substrate-for-aquariums", "cabomba-vs-hornwort", "nerite-snails-vs-mystery-snails"]
sources:
  - label: "Aquarium Driftwood Preparation and Types — Practical Fishkeeping"
    url: "https://www.practicalfishkeeping.co.uk/"
  - label: "Driftwood and Hardscape Discussion — Reef2Reef New to the Hobby"
...
In the meantime, a piece that won't stay down can be temporarily held in place with a clean rock, a suction-cup anchor, or wedged against other hardscape — and once it's positioned where you want it permanently, [aquarium-safe cyanoacrylate gel](/super-glue-reef-tank/) is a reliable way to anchor it to a base rock or to another piece of wood, the same general approach used to attach coral frags to rock in a reef tank.
...
Because both types leach tannins that **soften and slightly acidify** water, neither is a good match for setups that need **hard, alkaline water** — most notably African cichlid tanks. Our guide to [driftwood in cichlid tanks](/driftwood-cichlid-tank/) covers this in more detail, including why rock-based aquascaping is the better fit for that water chemistry. The same consideration extends to substrate choice: if a tank is using [crushed coral](/crushed-coral-vs-live-sand/) for its water-hardening properties, adding either Malaysian driftwood or Mopani wood works against that effect, regardless of which wood type is chosen.
