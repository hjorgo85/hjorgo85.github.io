---
title: "Firefish Goby Care Guide: Tank Setup, Jumping Risk & Tank Mates"
description: "Care guide for the firefish goby (Nemateleotris magnifica): tank size, water parameters, diet, the well-known jumping/escape risk, and compatible tank mates."
slug: "firefish"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A peaceful, strikingly colored reef fish with one well-known quirk: a tendency to jump out of open tanks. Here's how to keep one safely."
tags: ["firefish", "goby", "saltwater", "reef safe", "beginner fish"]
quickFacts:
  - label: "Scientific Name"
    value: "Nemateleotris magnifica"
  - label: "Care Level"
    value: "Easy, with one caveat (see jumping risk)"
  - label: "Minimum Tank Size"
    value: "10-20 gallons (38-75 L)"
  - label: "Temperament"
    value: "Peaceful, can be shy"
  - label: "Diet"
  ...
  - label: "Lifespan"
    value: "3-5 years typical, longer reported in stable tanks"
faq:
  - q: "Why do firefish jump out of aquariums?"
    a: "Firefish have a strong startle response — when frightened (by a sudden light change, a loud noise, a predatory tank mate, or being chased), their instinct is to dart for cover. In the wild this means diving into a burrow; in an open-top aquarium, it can mean launching themselves over the edge. This is well-documented enough in the hobby that a secure lid or sufficient water-line clearance is considered a standard requirement for keeping firefish, not an optional precaution."
  - q: "Can I keep more than one firefish together?"
    a: "A mated pair or a small group introduced together (in a larger tank, 30+ gallons) can work, but two unrelated, separately-introduced firefish in a small tank will often fight — sometimes seriously. If you want a pair, the safest approach is to buy two similarly-sized individuals at the same time and introduce them simultaneously."
  - q: "What's the difference between a firefish and a purple firefish?"
