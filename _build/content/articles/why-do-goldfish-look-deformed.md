---
title: "Why Do Some Goldfish Look Deformed? Breeding vs. Health Issues"
description: "Many 'deformed-looking' goldfish are fancy varieties bred that way on purpose — but sudden changes in shape or posture can signal a real health problem. Here's how to tell the difference."
slug: "why-do-goldfish-look-deformed"
type: "article"
category: "freshwater"
...
image: "/assets/img/articles/why-do-goldfish-look-deformed.webp"
imageAlt: "A fancy goldfish with a rounded body shape swimming in a planted aquarium"
imageWidth: 1200
imageHeight: 800
excerpt: "Bubble eyes, rounded bodies, curled fins — many 'deformed' goldfish traits are intentional breeding results. But a sudden change in shape or posture is a different story."
tags: ["goldfish", "freshwater", "fancy goldfish", "fish health"]
quickFacts:
  - label: "Most Common Cause"
    value: "Selective breeding for 'fancy' body shapes — the unusual appearance is often the intended trait"
  - label: "Examples of Bred-In Traits"
    value: "Rounded bodies (ranchu, lionhead), bubble-like eye sacs (bubble eye), upturned eyes (celestial eye)"
  - label: "Welfare Considerations"
    value: "Rounded body shapes are associated with higher rates of swim bladder issues in some fancy varieties"
  - label: "Is It Always Breeding-Related?"
    value: "No — a sudden new change in shape or posture in a previously normal fish suggests illness or injury, not breeding"
  - label: "Swim Bladder Disease"
    value: "Can cause abnormal floating, sinking, or tilted swimming — sometimes mistaken for body 'deformity'"
  - label: "Key Distinguishing Question"
    value: "Has the fish always looked this way, or did the shape/posture change recently?"
  - label: "When to Be Concerned"
    value: "Recent onset, especially with abnormal swimming or buoyancy — not a lifelong consistent body shape"
faq:
  - q: "Why does my goldfish have such an unusual body shape?"
  ...
  - q: "Are fancy goldfish body shapes a welfare concern?"
    a: "It's a genuinely mixed picture, and worth being honest about. Some fancy goldfish traits are primarily cosmetic with limited functional impact, while others — particularly **very rounded body shapes** common in varieties like ranchu and lionhead — have been associated with **higher rates of swim bladder issues**, since the internal organs (including the swim bladder) are compressed into a shape quite different from the more elongated body of common or wild-type goldfish. This doesn't mean every fancy goldfish will develop problems, but it's a real consideration for anyone choosing a variety, and it's part of a broader pattern in ornamental fish breeding where appearance-driven selection can have functional tradeoffs — something also worth considering with the tall, disc-shaped body of [discus](/55-gallon-discus-tank/), though discus haven't been bred to the same body-shape extremes as some fancy goldfish varieties."
  - q: "What's the difference between a bred body shape and swim bladder disease?"
