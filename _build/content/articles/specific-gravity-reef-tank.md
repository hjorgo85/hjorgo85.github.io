---
title: "Ideal Specific Gravity for a Reef Tank: Target Range & How to Measure It"
description: "The correct specific gravity range for a reef tank, why corals and invertebrates need tighter tolerances than fish, and how to measure SG accurately with a refractometer."
slug: "specific-gravity-reef-tank"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Reef tanks need specific gravity held in a narrower, higher band than fish-only systems — here's the exact target, why corals demand that precision, and how to measure it without the common errors that throw readings off."
tags: ["saltwater", "reef tank", "water chemistry", "specific gravity", "aquarium maintenance"]
quickFacts:
  - label: "Ideal Specific Gravity (Reef)"
    value: "1.025-1.026 SG"
  - label: "Equivalent in ppt"
    value: "Roughly 33.5-35 ppt"
  - label: "Recommended Measurement Tool"
    value: "Calibrated optical refractometer (not a swing-arm hydrometer)"
  - label: "Calibration Reference Point"
    value: "1.026 SG calibration fluid, used at the refractometer's specified temperature"
  - label: "Why Reef Tanks Need Tighter Range"
    value: "Corals and invertebrates are largely osmoconformers with little ability to buffer salinity swings"
  - label: "Temperature Sensitivity"
    value: "Refractometers are calibrated for a specific temperature (often 20°C/68°F or 25°C/77°C ATC); samples outside that range read incorrectly"
  - label: "Common Measurement Mistakes"
    value: "Skipping calibration, reading a cold sample, using an aging or scratched hydrometer"
  - label: "Acceptable Drift Range"
    value: "Day-to-day variation should stay within about 0.0005 SG once stable"
faq:
  - q: "What specific gravity should a reef tank be?"
    a: "Target 1.025-1.026 SG, which corresponds to roughly 33.5-35 ppt salinity. This is narrower and slightly higher than the range often quoted for fish-only tanks (1.020-1.025 SG) because corals, clams, and most reef invertebrates need salinity to closely match natural seawater and have little ability to tolerate swings outside that band."
  - q: "Is 1.023 too low for a reef tank?"
...
sources:
  ...
  - label: "Refractometers & Salinity Testing — Bulk Reef Supply"
...
This is narrower and sits at the higher end compared to the 1.020-1.025 SG range often cited for fish-only tanks, as covered from the fish side in our [clownfish salinity guide](/clownfish-salinity-aquarium/). That article explains why clownfish and many other reef fish tolerate a wider salinity band without much issue. This article covers the same underlying salinity-tolerance concept from the other side of the tank — the corals and invertebrates that don't have that flexibility, and why their needs should set your target, not the fish's.
