---
title: "Amazon Sword Runners: What They Are and How to Use Them"
description: "Runners on an Amazon sword plant are a sign of a healthy, mature plant producing free new plantlets — here's how to recognize, separate, and replant them."
slug: "amazon-sword-runners"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A long stem trailing away from your Amazon sword with a tiny new plant on the end isn't a problem — it's the plant propagating itself, and a free new plant if you know what to do with it."
tags: ["amazon sword", "aquarium plants", "plant propagation", "echinodorus"]
quickFacts:
  - label: "What a Runner Is"
    value: "A horizontal stem (stolon) extending from the base of the plant, producing a new plantlet at its tip or along its length"
  - label: "What It Means"
    value: "A sign of a mature, healthy plant with good growing conditions — not a problem to fix"
  - label: "When It Appears"
    value: "Typically after a sword plant has been established for several months to a year under good conditions"
  - label: "When to Separate"
    value: "Once the plantlet has developed several leaves and visible roots of its own"
  - label: "How to Separate"
    value: "Cut the runner stem on either side of the plantlet's root mass with clean scissors"
  - label: "Replanting"
    value: "Plant the separated plantlet in substrate with the crown above the surface, same as the parent plant"
  - label: "If No Runners Appear"
    value: "Not a problem — many swords reproduce mainly by sending up flower stalks instead, or simply don't runner under given conditions"
  - label: "Multiple Plantlets"
    value: "A single runner can sometimes produce more than one plantlet along its length"
faq:
  - q: "My Amazon sword is sending out a long stem with a tiny plant on the end — is something wrong?"
    a: "No — this is a **runner** (a type of stolon), and it's one of the more reliable signs that an Amazon sword (*Echinodorus* species) is healthy and well-established. Runners are a form of vegetative propagation: the parent plant sends out a horizontal stem, and a new plantlet forms at its tip (or sometimes at multiple points along its length). It's not a stress response, deformity, or anything to correct — left alone, the plantlet will continue developing its own leaves and root system while still attached to the parent."
  - q: "When should I separate a runner plantlet from the parent plant?"
    a: "Wait until the plantlet has developed **several leaves of its own and a visible root system** — separating too early, before the plantlet can support itself, reduces its chances of establishing well once independent. There's no strict timeline since it depends on tank conditions and how quickly the plantlet develops, but a plantlet with 3-4 leaves and roots a half-inch or more long is generally ready. Until then, the runner connection is actually helping the plantlet by supplying it with resources from the established parent plant."
  - q: "How do I separate and replant a sword plant runner?"
    a: "Using clean scissors, cut the runner stem on **both sides of the plantlet's root mass** — close to the plantlet itself, leaving a short stub rather than a long trailing piece of stem. Then plant the separated plantlet in substrate the same way you would the parent plant: roots and crown base buried, with the crown (where leaves emerge) sitting at or just above the substrate surface — not buried, which can cause the same kind of rot issue covered in our [anubias rot guide](/anubias-rot/) for a different plant, though swords are root-feeders and somewhat more tolerant of this than anubias. The remaining stub on the parent plant will typically wither on its own and can be trimmed off."
  - q: "Why isn't my Amazon sword producing any runners?"
    a: "Not producing runners isn't itself a sign of a problem — many Amazon swords reproduce primarily through **flower stalks** (a tall stem that emerges above the water line and can produce both flowers and plantlets, in tanks with enough light and an open top) rather than runners, and some plants simply don't runner under typical aquarium conditions regardless of health. If the plant otherwise looks healthy — producing new leaves, good color, root system filling out — the absence of runners specifically isn't something to chase. A plant that's stunted, pale, or not producing new growth at all has a different underlying issue (light, substrate nutrients, or root competition with other plants), which is a separate question from runner production specifically."
related: ["algae", "anubias-rot", "hornwort-turning-brown", "how-to-trim-hornwort", "can-anubias-grow-out-of-water", "grey-algae"]
sources:
  - label: "Echinodorus Propagation Discussion — The Planted Tank Forum"
