---
title: "Best Food for Mbuna Cichlids: Why Diet Matters More Than for Almost Any Other Fish"
description: "What to actually feed Mbuna cichlids (Lake Malawi rock-dwelling cichlids) — and why the wrong protein-heavy diet is the leading cause of 'Malawi bloat' and premature death in this group."
slug: "best-food-for-mbuna-cichlids"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Mbuna cichlids are sold in the same aisle as every other 'cichlid pellet' — but feeding them like a generic cichlid is one of the most common causes of bloat, organ damage, and early death in this group."
tags: ["cichlids", "freshwater", "mbuna", "diet"]
quickFacts:
  - label: "Diet Type in the Wild"
    value: "Herbivore/grazer — algae and biofilm (aufwuchs) scraped from rocks"
  - label: "Ideal Captive Diet"
    value: "Spirulina-based flake/pellet, vegetable matter, low protein"
  - label: "Protein Level to Target"
    value: "Roughly 30-35% or less, plant-based protein preferred over animal"
  - label: "Foods to Avoid or Limit"
    value: "Beefheart, large amounts of bloodworms/tubifex, feeder fish"
  - label: "Main Risk of Wrong Diet"
    value: "'Malawi bloat' — a serious digestive/organ condition, often fatal"
  - label: "Feeding Frequency"
    value: "2-3 small feedings per day rather than one large one"
  - label: "Vegetable Matter Options"
    value: "Blanched zucchini, spirulina flake, algae wafers"
  - label: "Genera Commonly Called Mbuna"
    value: "Pseudotropheus, Metriaclima, Labidochromis, Melanochromis, and others"
faq:
  - q: "What is the best staple food for Mbuna cichlids?"
    a: "A high-quality spirulina-based flake or pellet formulated specifically for herbivorous African cichlids is the best staple. In the wild, Mbuna spend most of the day grazing 'aufwuchs' — the algae and biofilm layer on rocks — which is a high-fiber, plant-based diet very different from the higher-protein diets often marketed for cichlids in general. A spirulina-forward staple, fed 2-3 times daily in small amounts, most closely matches this natural feeding pattern."
  - q: "Why is bloodworm or beefheart bad for Mbuna cichlids?"
    a: "These are high-protein, high-fat foods that are appropriate for some other cichlid groups (many Central and South American cichlids tolerate or even benefit from richer diets) but are a poor match for Mbuna's herbivorous digestive system. Regularly feeding rich, protein-heavy foods to Mbuna is one of the most well-documented contributing factors to 'Malawi bloat' — a serious and often fatal digestive condition. Occasional small amounts of meaty food aren't an emergency, but it shouldn't be a staple."
  - q: "What is Malawi bloat and how is it connected to diet?"
...
sources:
  ...
  - label: "African Cichlid Care Resources — Practical Fishkeeping"
...
If you're seeing early bloat symptoms (swelling, reduced appetite) in a Mbuna, our [guide to epsom salt for African cichlids](/epsom-salt-for-african-cichlids/) covers a commonly used supportive treatment — but prevention through diet is far more reliable than treatment after symptoms appear.
