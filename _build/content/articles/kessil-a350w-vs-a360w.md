---
title: "Kessil A350W vs. A360W: Choosing Between Kessil's A-Series Tiers"
description: "The Kessil A350W and A360W share the same point-source LED design philosophy, but sit at different output tiers — here's how to decide which fits your tank's depth and coral mix."
slug: "kessil-a350w-vs-a360w"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "If you're trying to decide between two tiers in Kessil's A-series lineup, the decision usually comes down to tank depth and which corals dominate the stocking plan — not a fundamental design difference."
tags: ["Kessil", "reef lighting", "A-series", "aquarium lighting", "LED"]
quickFacts:
  - label: "Shared Design Philosophy"
    value: "Both are part of Kessil's A-series point-source LED lights, using a lens behind a single bright LED source to create the characteristic 'shimmer' effect"
  - label: "Tier Difference"
    value: "The A360-series sits as Kessil's higher-output flagship tier; the A350-series sits a tier below in intensity"
  - label: "Best Tank Depth"
    value: "A360-series suits deeper tanks or SPS-dominant setups that need more light penetration; A350-series suits shallower tanks or softie/LPS-leaning setups"
  - label: "Coverage Footprint"
    value: "Both use the same point-source-behind-a-lens design, so footprint shape is similar — the main difference is intensity and penetration depth"
  - label: "Spectrum Naming"
    value: "Kessil uses 'Tuna Sun' and 'Tuna Blue' style spectrum names across the A-series lineup"
  - label: "Controller Compatibility"
    value: "Both work with Kessil's wireless dial and Spectral Controller accessories for dimming and scheduling"
  - label: "Mounting"
    value: "Gooseneck arm or rail mount — the same mounting approach used across Kessil's A-series"
  - label: "Deciding Factor"
    value: "Choose based on tank depth and whether the stocking plan leans toward SPS (more light) or LPS/softies (less intense light)"
faq:
  - q: "What's actually different between the A350-series and A360-series?"
  ...
  - q: "Which one do I need for a deep SPS tank vs. a shallow mixed-reef tank?"
    a: "**As a starting point: the A360-series for a deep, SPS-leaning tank, and the A350-series for a shallower, mixed-reef or LPS/softie-leaning tank** — but this is a starting point, not a hard rule. Light intensity requirements depend on **tank depth, how many fixtures are running per tank, mounting height, and which specific corals are being kept** (some SPS species tolerate a wider range than others, and some LPS/softies can adapt to brighter light over time with acclimation). If you're already running Kessil fixtures and considering whether to step up or down a tier, our guide on [how much white light corals actually need](/how-much-white-light-do-corals-need/) covers the broader question of matching light output to coral needs, which applies regardless of which specific fixture tier you're using."
  - q: "Do they produce the same 'shimmer' effect as the A80?"
    a: "**Yes — the shimmer effect comes from the point-source-behind-a-lens design that's shared across Kessil's A-series, including the A80, A350-series, and A360-series.** A point source of light passing through a lens creates the rippling shimmer pattern on the substrate that's often cited as one of the main aesthetic advantages of point-source LED fixtures over wide, flat LED panels. Our [Kessil A80 vs. AI Prime 16HD comparison](/kessil-a80-vs-ai-prime-16-hd/) covers this point-source design philosophy — including its trade-off against the AI Prime's wide-angle lens approach — in more depth, and the same trade-off (concentrated point-source vs. broader even coverage) applies when comparing any Kessil A-series fixture to a wide-angle alternative."
  - q: "Should I consider a non-Kessil LED chip-based DIY build instead of either?"
    a: "**It depends on what's driving the decision.** A commercial fixture like either A-series tier is a complete package — lens, driver, and Kessil's control ecosystem all integrated and tested together, with the trade-offs being primarily about output tier rather than build complexity. A **DIY build** using LED chips directly (covered in our [Bridgelux vs. Cree comparison](/bridgelux-led-vs-cree/)) trades that integration for more flexibility — more potential color channels, custom intensity targets, and generally lower cost per watt, at the expense of needing to handle lens, heatsink, and driver decisions yourself. If the appeal of a commercial fixture is mainly **output and reliability without a build project**, staying within the A-series and picking the right tier (this comparison) is the simpler path; if the appeal is **custom spectrum tuning or cost-per-watt**, a DIY build is the alternative worth researching."
related: ["kessil-a80-vs-ai-prime-16-hd", "bridgelux-led-vs-cree", "how-much-white-light-do-corals-need", "fluval-chi-aquarium-light-not-working", "aquarium-hood-light-not-working", "best-lighting-for-40-gallon-breeder"]
sources:
  - label: "Reef Lighting Fixture Comparisons — Reef2Reef Lighting Forum"
    url: "https://www.reef2reef.com/forums/lighting.145/"
  - label: "Coral Lighting Requirements — Practical Fishkeeping"
...
This isn't an absolute rule — individual coral species vary, and lighting acclimation over time matters too (our guide on [how much white light corals need](/how-much-white-light-do-corals-need/) covers this in more general terms) — but it's a reasonable starting framework for choosing between the two tiers.

## Shimmer, Coverage, and the Point-Source Trade-off

Because both tiers share the point-source-behind-a-lens design, the **shimmer effect and general footprint shape** are similar between them — this isn't a factor that differs much by tier. What the point-source design *does* trade off against is **wide-angle, even-coverage** designs, which is the comparison covered in our [Kessil A80 vs. AI Prime 16HD guide](/kessil-a80-vs-ai-prime-16-hd/). If shimmer and a point-source aesthetic are part of why Kessil is on the shortlist at all, that factor is consistent across the A350W/A360W decision — it only becomes relevant again if comparing against a non-point-source fixture entirely.
