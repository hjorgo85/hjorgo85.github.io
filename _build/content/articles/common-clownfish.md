---
title: "Common Clownfish Care Guide: Tank Size, Diet, Tank Mates & Anemones"
description: "Everything you need to know about keeping common clownfish (Amphiprion ocellaris): tank setup, water parameters, diet, breeding pairs, and whether you actually need an anemone."
slug: "common-clownfish"
type: "article"
category: "saltwater"
...
imageAlt: "Pair of common clownfish (Amphiprion ocellaris) swimming near a host anemone"
imageWidth: 1200
imageHeight: 800
excerpt: "The fish that made reef keeping mainstream — here's how to set up its tank, what it actually eats, and why it doesn't need an anemone to thrive."
tags: ["clownfish", "saltwater", "beginner fish", "reef safe"]
quickFacts:
  - label: "Scientific Name"
    value: "Amphiprion ocellaris"
  - label: "Care Level"
    value: "Easy — excellent first marine fish"
  - label: "Minimum Tank Size"
    value: "20 gallons (75 L) for one or a pair"
  - label: "Temperament"
    value: "Peaceful, becomes territorial if hosting an anemone"
  - label: "Diet"
    value: "Omnivore (marine pellet, flake, mysis, brine)"
  - label: "Reef Safe"
    value: "Yes"
  - label: "Max Size"
    value: "~3-4 inches (8-10 cm)"
  - label: "Lifespan"
    value: "Up to 20 years in captivity with good care"
faq:
  ...
  - q: "How can I tell if I have a male or female clownfish?"
    a: "Clownfish are sequential hermaphrodites: all are born with the potential to be either sex, and the largest, most dominant fish in a group becomes female while the next-largest becomes the breeding male. You generally can't determine sex by appearance alone — it's determined by social hierarchy and size, and can change if the female is removed from the group."
  - q: "Can I keep more than one clownfish together?"
...
sources:
  ...
  - label: "Captive Breeding and Husbandry of Clownfish — Reef Builders"
...
As with the [yellowtail damselfish](/yellowtail-damselfish/), a 2-4 week quarantine period for new arrivals remains the most effective single step to avoid most of these issues reaching your main display.
