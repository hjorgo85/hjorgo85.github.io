---
title: "Driftwood in a Cichlid Tank: Does It Work With African Cichlids?"
description: "Driftwood is a staple of planted and South American aquascapes, but it softens and acidifies water — exactly the opposite of what most African cichlids need. Here's when it works and when to skip it."
slug: "driftwood-cichlid-tank"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Driftwood looks great and is a go-to for planted tanks, but it releases tannins that soften and acidify water — the opposite of the hard, alkaline conditions most African cichlids need."
tags: ["cichlids", "freshwater", "aquascaping", "water chemistry"]
quickFacts:
  - label: "Driftwood's Main Effect"
    value: "Releases tannins — softens water and lowers pH over time"
  - label: "African Cichlid Needs"
    value: "Hard, alkaline water (pH 7.8-8.6, Lake Malawi/Tanganyika conditions)"
  - label: "Direct Conflict?"
    value: "Yes — driftwood's effect works against typical Rift Lake water chemistry"
  - label: "Is It Ever Used Anyway?"
    value: "Sometimes for visual effect in small amounts, with buffering to counteract pH drop"
  - label: "Better Alternatives"
    value: "Rock (lace rock, holey rock, lava rock), ceramic/resin decor"
  - label: "If Using Driftwood"
    value: "Boil/soak first, monitor pH closely, pair with crushed coral/aragonite buffering"
  - label: "Best Fit"
    value: "Driftwood suits soft-water species better than Rift Lake cichlids"
  - label: "Tannin Color"
    value: "Brown tint to water — cosmetic, removable with activated carbon"
faq:
  - q: "Can you put driftwood in an African cichlid tank?"
    a: "You can, but it works against what most African cichlids need. Driftwood releases tannins — organic compounds that soften water and lower pH over time, which is exactly the opposite of the hard, alkaline water (pH roughly 7.8-8.6) that Rift Lake cichlids from Lake Malawi and Lake Tanganyika are adapted to. If you want driftwood for aesthetic reasons, it's possible to use a small piece while actively buffering with crushed coral or aragonite substrate to counteract the pH drop, but for most African cichlid setups, rock-based aquascaping (as discussed in our [75-gallon peacock cichlid tank guide](/75-gallon-peacock-cichlid-tank/)) is a more straightforward match for the water chemistry these fish need."
  - q: "Why does driftwood lower pH in an aquarium?"
    a: "Driftwood releases tannins — naturally occurring organic acids — into the water as it slowly breaks down. These tannins tint the water a light brown/tea color (a cosmetic effect, removable with activated carbon if desired) and also have an acidifying effect, gradually pulling pH downward, especially in water that isn't heavily buffered. In a softer-water setup (many South American or Southeast Asian biotopes), this effect is often desirable and mimics natural blackwater conditions. In a hard, alkaline African cichlid tank, it's working against the water chemistry you're trying to maintain."
  - q: "What's a good alternative to driftwood for African cichlid tanks?"
    a: "Rock is the natural fit — both functionally and visually. Lace rock, holey rock, lava rock, and similar porous or textured rock types create the caves, crevices, and territory divisions that African cichlids (especially Mbuna, as discussed in our [Mbuna diet guide](/best-food-for-mbuna-cichlids/), and other rock-dwelling species) use naturally, and rock doesn't fight against the hard, alkaline water chemistry — in fact, some rock types (and crushed coral or aragonite substrate) actively help maintain it. Ceramic or resin cichlid-specific decor (caves, pots) is another option that provides similar functional value without affecting water chemistry at all."
  - q: "What if I really want driftwood for the look, even in an African cichlid tank?"
    a: "It's not impossible, but it requires active management. A smaller piece of driftwood, pre-soaked or boiled to leach out some tannins before adding it to the tank, combined with a substrate or rock that provides strong buffering capacity (crushed coral, aragonite), can sometimes coexist — but it means you're actively fighting the driftwood's natural effect rather than working with it. Regular pH monitoring becomes more important in this setup than in a tank using only rock. For most keepers, especially those newer to African cichlids, it's simpler to choose decor that supports rather than works against the water chemistry these fish need — similar in spirit to choosing tankmates (like the question of [bala sharks with cichlids](/bala-sharks-with-cichlids/) or a [peacock eel with cichlids](/peacock-eel-with-cichlids/)) that match rather than fight the tank's core requirements."
related: ["75-gallon-peacock-cichlid-tank", "bala-sharks-with-cichlids", "peacock-eel-with-cichlids", "best-food-for-mbuna-cichlids", "cichlids-with-cloudy-eyes", "johanni-vs-maingano"]
sources:
  - label: "African Cichlid Water Chemistry — Cichlid Forum"
    url: "https://www.cichlid-forum.com/"
  - label: "Aquascaping & Driftwood Guide — Practical Fishkeeping"
...
2. **Chemical** — tannins are mildly acidic, and in water without strong buffering capacity, they can gradually pull pH downward. In a softer-water tank, this might be a desirable, even intentional, effect. In a hard, alkaline African cichlid tank — especially one already using buffering substrates as covered in our [75-gallon peacock cichlid tank guide](/75-gallon-peacock-cichlid-tank/) — it's a competing influence that the buffering has to work against.
