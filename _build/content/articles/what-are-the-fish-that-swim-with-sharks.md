---
title: "What Are the Fish That Swim With Sharks? (And What If You Mean Aquarium 'Sharks'?)"
description: "In the ocean, remoras, pilot fish, and jacks are known for swimming alongside sharks — but if you're stocking a freshwater aquarium, 'shark' usually means something else entirely."
slug: "what-are-the-fish-that-swim-with-sharks"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Remoras and pilot fish swim with real sharks in the ocean — but most people searching this phrase in an aquarium context are really asking about freshwater fish marketed as 'sharks.'"
tags: ["freshwater", "shark fish", "fish naming", "tank mates"]
quickFacts:
  - label: "Ocean Fish Associated With Sharks"
    value: "Remoras, pilot fish, certain jacks, and cleaner wrasse are well-known examples"
  - label: "Why They Associate With Sharks"
    value: "Protection from predators, access to leftover food, and in cleaner wrasse's case, feeding on parasites"
  - label: "Are Any of These Aquarium Fish?"
    value: "Not typically — these are open-ocean/reef relationships not usually replicated in home aquariums"
  - label: "Freshwater 'Shark' Fish"
    value: "Bala shark, red tail shark, rainbow shark, roseline (denison barb) — none are true sharks"
  - label: "Are Freshwater 'Sharks' Related to Real Sharks?"
    value: "No — the name refers to body/fin shape, not taxonomy"
  - label: "Colombian/Berney's 'Shark Catfish'"
    value: "Also not true sharks — Ariidae catfish named for a similar shape resemblance"
  - label: "Common Theme"
    value: "'Shark' is one of the most overused descriptive common names in the aquarium trade"
faq:
  - q: "What fish actually swim with sharks in the ocean?"
  ...
  - q: "If I'm stocking a freshwater tank, what does 'shark' usually mean?"
    a: "In freshwater aquarium contexts, 'shark' is almost always a **common name based on body or fin shape**, not any taxonomic relationship to actual sharks. The [Bala shark](/bala-sharks-with-cichlids/) (Balantiocheilos melanopterus) is actually a large cyprinid (related to barbs and carp), named for its sleek, fork-tailed, shark-like silhouette. Red tail sharks and rainbow sharks (genus Epalzeorhynchos) are similarly named for body shape and fin profile. None of these fish are sharks in any biological sense — and this naming pattern extends to catfish too, as discussed in our guides to [Colombian shark catfish](/colombian-shark-catfish/) and [Berney's shark catfish](/berneys-shark-catfish/), both of which are Ariidae catfish named for a passing resemblance to small sharks."
  - q: "Are freshwater 'shark' fish good tank mates for each other?"
    a: "Not necessarily — sharing a common-name pattern doesn't mean these fish share care requirements, temperament, or even water chemistry preferences. The [Bala shark](/bala-sharks-with-cichlids/), for example, needs a very large tank (125+ gallons) and a school of its own kind, and our [African cichlid coverage](/bala-sharks-with-cichlids/) discusses why pairing it with hard-water cichlids is often a mismatch despite both being large, active fish. Similarly, [Colombian shark catfish](/colombian-shark-catfish/) and [Berney's shark catfish](/berneys-shark-catfish/) share a family (Ariidae) and some care overlap, but a red tail shark (a territorial cyprinid) and a Bala shark (a large schooling cyprinid) have quite different social needs despite both being called 'sharks.' The name is a starting point for research, not a stocking shortcut."
  - q: "Why are so many freshwater fish named after sharks?"
    a: "Body shape is the common thread — a sleek body, a forked or pointed caudal fin, and sometimes a dorsal fin profile reminiscent of a shark's are enough for a common name to stick, regardless of the fish's actual family or behavior. This is part of a broader pattern in the aquarium trade where descriptive common names get applied based on appearance across unrelated species — we've covered similar cases with ['stingray' plecos](/stingray-pleco/) (named for a spot pattern, not a relationship to stingrays) and ['banjo' catfish](/how-to-care-for-asian-banjo-catfish/) (named for body outline, with 'Asian banjo catfish' being an entirely different family from true South American banjo catfish). 'Shark' just happens to be one of the more frequently reused names, likely because the silhouette is instantly recognizable."
related: ["bala-sharks-with-cichlids", "colombian-shark-catfish", "berneys-shark-catfish", "red-jardini-arowana", "55-gallon-discus-tank"]
sources:
  - label: "Remora — FishBase"
    url: "https://www.fishbase.se/Nomenclature/FamilySummary.php?Family=Echeneidae"
  - label: "Balantiocheilos melanopterus — FishBase"
    url: "https://www.fishbase.se/summary/Balantiocheilos-melanopterus.html"
---
...
The "shark" naming convention in freshwater fishkeeping comes down to **body and fin shape**: a streamlined body, a forked tail, and sometimes a tall dorsal fin are enough to earn the name, the same way other descriptive trade names get applied based on appearance rather than taxonomy — see also our discussions of ["stingray" plecos](/stingray-pleco/) and ["banjo" catfish](/how-to-care-for-asian-banjo-catfish/) for similar examples of shape-based naming.

## Freshwater Fish Commonly Called "Sharks"

A few of the more commonly encountered examples:

- **Bala shark** (*Balantiocheilos melanopterus*) — a large, schooling cyprinid (related to barbs and carp) with a sleek, fork-tailed shape. We've covered this species in detail, including why its size and water chemistry needs make it a poor match for [African cichlid tanks](/bala-sharks-with-cichlids/) despite both being popular "large showpiece fish."
...
- **"Shark catfish"** — a separate naming pattern entirely, applied to certain Ariidae catfish like [Colombian shark catfish](/colombian-shark-catfish/) and [Berney's shark catfish](/berneys-shark-catfish/), named for a passing resemblance to small sharks in body and fin profile.
...
- [Bala sharks](/bala-sharks-with-cichlids/) need a very large tank (125+ gallons) and their own school, and their water chemistry preferences don't align well with hard-water African cichlid setups
- [Colombian shark catfish](/colombian-shark-catfish/) and [Berney's shark catfish](/berneys-shark-catfish/) share a family and some care overlap with each other, but neither shares much in common, practically speaking, with a small territorial red tail shark beyond the name
