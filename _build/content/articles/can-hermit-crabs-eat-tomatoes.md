---
title: "Can Hermit Crabs Eat Tomatoes? Safe Foods and Feeding Basics"
description: "Tomatoes are generally considered an acceptable occasional food for land hermit crabs as part of a varied diet — here's how they fit into broader feeding practices."
slug: "can-hermit-crabs-eat-tomatoes"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Tomatoes are one of many fruits and vegetables that can be offered to land hermit crabs in moderation — the bigger picture is variety, freshness, and avoiding foods treated with pesticides or preservatives."
tags: ["hermit crab", "land hermit crab", "Coenobita", "hermit crab diet", "terrarium care"]
quickFacts:
  - label: "Can Hermit Crabs Eat Tomatoes?"
    value: "Generally yes, in moderation, as part of a varied diet — not a known toxic or harmful food"
  - label: "Diet Type"
    value: "Omnivorous scavengers — land hermit crabs eat a wide range of plant and animal-derived foods"
  - label: "Preparation"
    value: "Small pieces, fresh, washed — avoid produce treated with pesticides or wax coatings"
  - label: "Variety Matters More Than Any Single Food"
    value: "Tomatoes are one option among many fruits/vegetables, not a dietary staple on their own"
  - label: "Remove Uneaten Portions"
    value: "Fresh food left in a warm, humid terrarium spoils quickly and should be removed"
  - label: "Calcium Still Needed Separately"
    value: "Fruits/vegetables don't replace calcium sources needed for molting"
  - label: "Commercial Hermit Crab Food"
    value: "Often forms a base diet, with fresh foods like tomato offered as supplemental variety"
  - label: "When in Doubt"
    value: "Research any specific food before offering it regularly — general omnivore status doesn't mean every food is appropriate"
faq:
  - q: "Can hermit crabs eat tomatoes?"
    a: "**Generally, yes — tomatoes are commonly included among the fruits and vegetables considered acceptable for land hermit crabs in moderation**, as part of a broader varied diet. Land hermit crabs are **omnivorous scavengers**, and in the wild they eat a wide range of plant and animal-derived material, which is part of why a varied captive diet — rather than a single staple food — tends to be the general recommendation. Tomato, offered in **small, fresh pieces**, fits into that variety without being flagged as a problem food. That said, tomato is **one option among many**, not something to rely on as a primary food source."
  - q: "How should tomato (or other fresh produce) be prepared for a hermit crab?"
    a: "**Small pieces, fresh, and washed** are the general guidelines — washing matters because **pesticide residue** on produce intended for human consumption isn't necessarily appropriate for a small invertebrate, and **wax coatings** sometimes applied to produce for shelf life are similarly worth avoiding or removing where possible. Beyond that, the preparation is straightforward: a small piece is easier for a hermit crab to interact with than a large chunk, and **fresh** matters because produce left in a warm, humid terrarium can spoil relatively quickly, which connects to the next point."
  - q: "What happens if a hermit crab doesn't eat the tomato right away?"
    a: "**Uneaten fresh food should be removed before it spoils**, particularly in a terrarium environment that's typically warm and humid — conditions that also accelerate food spoilage. Spoiled food sitting in the terrarium isn't just a feeding question; it connects to general substrate cleanliness and odor management, covered in our [hermit crab waste guide](/do-hermit-crabs-poop/). Offering smaller amounts and checking back after a reasonable period — removing whatever hasn't been eaten — is a simple way to offer variety like tomato without letting spoiled food accumulate."
  - q: "Does feeding tomato (or other produce) cover all of a hermit crab's nutritional needs?"
    a: "**No — fresh fruits and vegetables like tomato are part of dietary variety, not a complete diet on their own.** Land hermit crabs also need **calcium** for molting, similar to the calcium needs covered for other crustaceans in our [fiddler crab diet guide](/what-is-the-best-food-diet-for-fiddler-crabs/) and [red claw crab diet guide](/red-claw-crabs-diet/) — fruits and vegetables generally aren't a significant calcium source, so a separate calcium source (commercial supplements, cuttlebone, or similar) is still part of the picture. Many keepers use a **commercial hermit crab food** as a dietary base, with fresh produce like tomato offered as supplemental variety rather than the foundation of the diet."
related: ["do-hermit-crabs-need-saltwater", "can-hermit-crabs-live-in-freshwater", "do-hermit-crabs-poop", "do-hermit-crabs-need-a-heat-lamp", "what-is-the-best-food-diet-for-fiddler-crabs"]
sources:
  - label: "Land Hermit Crab Diet Discussion — Reef2Reef"
    url: "https://www.reef2reef.com/forums/inverts.85/"
  - label: "Terrestrial Invertebrate Feeding Guides — Practical Fishkeeping"
...
**Tomatoes are generally considered acceptable for land hermit crabs in moderation, as part of a varied diet** — they're not flagged as a toxic or problem food. Land hermit crabs are **omnivorous scavengers** that benefit from dietary variety, and small, fresh, washed pieces of tomato fit into that variety reasonably well. That said, tomato is **one option among many fruits and vegetables**, not a staple, and it doesn't replace other dietary essentials like **calcium for molting** — covered in more depth in our [hermit crab saltwater guide](/do-hermit-crabs-need-saltwater/) and the molting-related calcium discussion in our [fiddler crab](/what-is-the-best-food-diet-for-fiddler-crabs/) and [red claw crab](/red-claw-crabs-diet/) diet guides.
