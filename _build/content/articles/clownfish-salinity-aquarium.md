---
title: "Clownfish Salinity Requirements: Ideal Range, Measurement & Safe Changes"
description: "The salinity clownfish need in a home aquarium: ideal specific gravity, why clownfish tolerate swings better than most reef invertebrates, hyposalinity as an ich treatment, and how to measure salinity correctly."
slug: "clownfish-salinity-aquarium"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Clownfish are some of the most salinity-tolerant fish in the hobby — but 'tolerant' isn't the same as 'unaffected.' Here's the right range, how to measure it, and when tolerance matters most."
tags: ["clownfish", "saltwater", "salinity", "water parameters", "aquarium maintenance"]
quickFacts:
  - label: "Ideal Specific Gravity"
    value: "1.020-1.025 SG"
  - label: "Ideal Salinity (ppt)"
    value: "Roughly 26-34 ppt, targeting ~32-33 ppt for reef tanks"
  - label: "Tolerance Range"
    value: "Clownfish can survive short-term swings from ~1.009 to 1.026 SG, though not without stress"
  - label: "Recommended Measurement Tool"
    value: "Calibrated refractometer (hydrometers are less accurate)"
  - label: "Hyposalinity Used For"
    value: "Treating marine ich (Cryptocaryon irritans) and some other external parasites"
  - label: "Safe Salinity Change Rate"
    value: "No more than about 0.001 SG per day for routine changes; hyposalinity drops are done gradually over several days"
  - label: "Reef-Safe for Hyposalinity?"
    value: "No — invertebrates, corals, and most inverts cannot tolerate low salinity; hyposalinity requires a separate treatment tank"
  - label: "Risk of Salinity Swings"
    value: "Osmotic stress, weakened immune response, and increased susceptibility to disease with repeated swings"
faq:
  - q: "What is the ideal salinity for clownfish?"
    a: "A specific gravity of 1.020-1.025 (roughly 27-34 ppt) is the generally accepted range for clownfish, with most reef-focused aquarists targeting the higher end, around 1.024-1.026 SG (32-35 ppt), to match conditions corals and invertebrates need. Clownfish themselves are comfortable across most of this range and don't require the precision that corals, clams, or sensitive invertebrates do."
  - q: "Can clownfish survive low salinity?"
    a: "Yes, better than almost any other fish commonly kept in reef tanks. Clownfish can tolerate salinity well below normal reef levels — down to roughly 1.009-1.012 SG — for extended periods, which is the basis for using hyposalinity as an ich treatment. That said, 'can survive' isn't the same as 'thrives' — prolonged low salinity is still a stressor, and any drop should be done gradually, not as a quick fix for an unrelated problem."
  - q: "Should I use a refractometer or a hydrometer for my saltwater tank?"
...
sources:
  ...
  - label: "Saltwater Aquarium Salinity and Specific Gravity — Reef2Reef"
