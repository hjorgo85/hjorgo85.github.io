---
title: "Azure Damselfish Care Guide: Tank Setup, Diet & Behavior"
description: "Complete care guide for the azure damselfish (Chrysiptera hemicyanea): tank size, water parameters, diet, tank mates, and temperament in a home reef aquarium."
slug: "azure-damselfish"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A compact, vividly two-toned damsel that's tougher than it looks — here's how to set up its tank, feed it right, and manage its territorial streak."
tags: ["damselfish", "saltwater", "beginner fish", "reef safe"]
quickFacts:
  - label: "Scientific Name"
    value: "Chrysiptera hemicyanea"
  - label: "Care Level"
    value: "Easy — good for beginners"
  - label: "Minimum Tank Size"
    value: "20 gallons (75 L)"
  - label: "Temperament"
    value: "Semi-aggressive, territorial as it matures"
  - label: "Diet"
    value: "Omnivore (marine flake, pellet, mysis, algae)"
  - label: "Reef Safe"
    value: "Yes"
  - label: "Max Size"
    value: "~2.5 inches (6.5 cm)"
  - label: "Lifespan"
    value: "5-8 years"
faq:
  - q: "How big do azure damselfish get?"
    a: "Azure damselfish max out around 2.5 inches (6.5 cm), making them one of the smaller Chrysiptera damsels. They reach close to full size within their first year, so don't expect much growth after that initial period in your tank."
  - q: "Are azure damselfish reef safe?"
    a: "Yes. Azure damselfish won't pick at corals, clams, or other sessile invertebrates, so they're a safe addition to a reef tank from a coral-health standpoint. The only compatibility concerns are with other fish, particularly similarly sized or similarly colored species added after them."
  - q: "Can I keep azure damselfish with other damselfish?"
...
sources:
  ...
  - label: "Reef2Reef: Chrysiptera Damselfish Identification and Care Discussion"
