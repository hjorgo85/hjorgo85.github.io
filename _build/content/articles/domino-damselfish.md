---
title: "Domino Damselfish Care Guide: Tank Setup, Diet & Breeding"
description: "Complete care guide for the domino damselfish / threespot dascyllus (Dascyllus trimaculatus): tank size, water parameters, diet, tank mates, and breeding behavior."
slug: "domino-damselfish"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Bold, almost comically friendly as a juvenile and a different fish entirely as an adult — here's what to know before you buy a domino damselfish."
tags: ["damselfish", "saltwater", "reef safe", "hardy fish"]
quickFacts:
  - label: "Scientific Name"
    value: "Dascyllus trimaculatus"
  - label: "Care Level"
    value: "Easy, but plan ahead for adult size and temperament"
  - label: "Minimum Tank Size"
    value: "55 gallons (210 L) for an adult"
  - label: "Temperament"
    value: "Aggressive and territorial as it matures"
  - label: "Diet"
    value: "Omnivore (marine flake, pellet, mysis, algae)"
  - label: "Reef Safe"
    value: "Yes (won't eat corals, but large adults can topple loose rockwork)"
  - label: "Max Size"
    value: "~5.5 inches (14 cm)"
  - label: "Lifespan"
    value: "10-15+ years"
faq:
  - q: "How big do domino damselfish get?"
    a: "Domino damselfish (threespot dascyllus) can reach about 5.5 inches (14 cm) in captivity, considerably larger than most damsels sold alongside them as juveniles. That size jump, combined with their growing aggression, is the most common reason owners end up rehoming one."
  - q: "Are domino damselfish reef safe?"
    a: "Yes, in the sense that they won't eat or sting corals and other sessile invertebrates. The caveat is size and behavior: a full-grown domino is a powerful, somewhat clumsy swimmer that can dislodge unsecured frags or rockwork while patrolling its territory, so secure your aquascape well."
  - q: "Why is my domino damselfish so aggressive?"
    a: "This is normal adult behavior, not a sign of a problem. Juveniles are famously bold and almost curious toward people, but as Dascyllus trimaculatus matures it becomes one of the more aggressive commonly kept damsels, fiercely defending a territory against fish of similar or even larger size. This shift typically becomes obvious by the time the fish reaches 2-3 inches."
  - q: "Can I keep a domino damselfish with other damselfish?"
    a: "Only with careful planning. A mature domino damselfish will usually dominate smaller damsels like the [yellowtail damselfish](/yellowtail-damselfish/) or [azure damselfish](/azure-damselfish/) in anything but a large, heavily rock-aquascaped tank. If you want to keep a domino with other damsels long-term, add them as similarly sized juveniles at the same time, or plan on a tank of 75+ gallons with multiple separated territories."
related: ["yellowtail-damselfish", "azure-damselfish", "blue-devil-damselfish", "firefish"]
sources:
  - label: "Dascyllus trimaculatus — FishBase"
    url: "https://www.fishbase.se/summary/Dascyllus-trimaculatus.html"
  - label: "LiveAquaria: Damselfish Species Information and Care"
...
- Strong aggression toward smaller or similarly sized fish, especially other damsels. A domino will typically out-compete and bully smaller *Chrysiptera* species like the [azure damselfish](/azure-damselfish/) or [blue devil damselfish](/blue-devil-damselfish/) unless the tank is large enough for both to hold separate territories.
...
- The [yellowtail damselfish](/yellowtail-damselfish/) and other small *Chrysiptera* can coexist with a domino only in larger tanks with abundant rockwork dividing territories — in anything under about 75 gallons, expect the domino to dominate.
