---
title: "Female Melanurus Wrasse: How to Tell Males and Females Apart (and Why It Can Change)"
description: "How to identify a female melanurus wrasse (Halichoeres melanurus), how its coloration differs from males, and why sex in this species isn't necessarily fixed for life."
slug: "female-melanurus-wrasse"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Male and female melanurus wrasses look different enough to be mistaken for separate species — and in this fish, 'female' isn't necessarily a permanent label. Here's how identification and sex change actually work."
tags: ["wrasse", "saltwater", "fish identification", "reef safe"]
quickFacts:
  - label: "Scientific Name"
    value: "Halichoeres melanurus"
  - label: "Sexual Dimorphism"
    value: "Yes — males and females have distinctly different coloration"
  - label: "Can Change Sex"
    value: "Yes — protogynous hermaphrodite (females can become males)"
  - label: "Female Coloration"
    value: "Generally more muted greens/browns with simpler striping"
  - label: "Male (Terminal Phase) Coloration"
    value: "Brighter green/blue body with bold orange/yellow markings and a dark tail spot"
  - label: "Minimum Tank Size"
    value: "30 gallons (115 L)"
  - label: "Reef Safe"
    value: "Yes"
  - label: "Diet"
    value: "Carnivore — small invertebrates, meaty foods; helps control pest snails/pyramid snails"
faq:
  - q: "How can you tell a female melanurus wrasse from a male?"
    a: "Female melanurus wrasses (Halichoeres melanurus) generally show more muted coloration — greens and browns with relatively simple striping — while males in their terminal phase develop brighter green or blue base coloring with bold orange and yellow markings and a distinctive dark spot near the tail (the source of the species' common name, 'melanurus,' meaning 'black tail'). That said, juveniles of both sexes can look broadly similar, and coloration alone isn't always a perfectly reliable indicator without some familiarity with the species' typical color progression."
  - q: "Can a female melanurus wrasse turn into a male?"
    a: "Yes. Like many wrasse species, Halichoeres melanurus is a protogynous hermaphrodite — individuals generally start life as females (or in an undifferentiated 'initial phase'), and some females can later transition into males, typically developing the brighter 'terminal phase' coloration as part of that change. This is a well-documented pattern across the wrasse family (Labridae) and isn't unique to this species, though the specific triggers (often related to social structure — the loss of a dominant male) vary."
  - q: "Is the melanurus wrasse reef safe?"
    a: "Yes — melanurus wrasses don't bother corals and are a popular choice specifically because they help control pest snails, including pyramid snails that can target clams, and other small unwanted invertebrates. They're a genuinely useful addition to a reef tank's 'natural pest control' alongside being an attractive, active fish — covered in our broader [reef-safe stocking guide](/best-fish-for-reef-tank/)."
  - q: "Do melanurus wrasses need a sand bed?"
    a: "Yes — like most Halichoeres wrasses, melanurus wrasses bury themselves in fine sand to sleep and when startled. A sand bed of at least 2-3 inches of fine sand (not crushed coral, which can be abrasive) is an important setup requirement, not just a preference. A tank without an adequate sand bed can leave this species with nowhere to retreat to at night, which is a meaningful stress factor."
related: ["bluestreak-cleaner-wrasse-labroides-dimidiatrus", "best-fish-for-reef-tank", "saltwater-fish-for-10-gallon-tank", "chain-link-moray-eel", "specific-gravity-reef-tank"]
sources:
  - label: "Halichoeres melanurus — FishBase"
    url: "https://www.fishbase.se/summary/Halichoeres-melanurus.html"
  - label: "Wrasse Identification & Sexual Dimorphism — Reef2Reef"
...
- **Reef safe and beneficial** — melanurus wrasses are a popular addition specifically for pest control, including pyramid snails that target clam mantles, fitting well into the kind of coral-and-invertebrate reef setups discussed in our [reef-safe stocking guide](/best-fish-for-reef-tank/).
- **Minimum tank size around 30 gallons** — comparable to the lower end of what's recommended for [common clownfish](/common-clownfish/) and other small reef fish, though as with the considerations in our [10-gallon stocking guide](/saltwater-fish-for-10-gallon-tank/), an active swimming fish like this benefits from more open space than the bare minimum.
