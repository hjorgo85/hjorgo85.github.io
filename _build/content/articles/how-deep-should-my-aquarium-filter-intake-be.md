---
title: "How Deep Should My Aquarium Filter Intake Be?"
description: "Filter intake depth affects what gets pulled into the filter first — too shallow misses sinking debris, too deep pulls in substrate. Here's the practical middle ground."
slug: "how-deep-should-my-aquarium-filter-intake-be"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Too shallow and the intake misses debris that sinks; too deep and it starts pulling in substrate. Here's the practical depth range and how to adjust for your tank."
tags: ["aquarium filter", "filter intake", "tank setup", "water flow", "equipment"]
quickFacts:
  - label: "General Range"
    value: "A few inches below the surface to a few inches above the substrate — avoid both extremes"
  - label: "Too Shallow"
    value: "Misses debris that has settled toward the bottom; mainly captures floating particles and surface scum"
  - label: "Too Deep"
    value: "Pulls in substrate, settled debris, and puts small fish/fry/shrimp near the substrate at more risk"
  - label: "Adjustable Intakes"
    value: "Telescoping intake tubes/strainers let you fine-tune height without buying new parts"
  - label: "Pre-Filter Sponges"
    value: "Reduce what reaches the impeller regardless of exact depth — a useful safety margin"
  - label: "Low Water Level Tanks"
    value: "Shallow planted or turtle tanks may need a shorter intake tube and more careful positioning"
  - label: "Surface Skimming"
    value: "Some setups intentionally position an intake near the surface to remove oily film/debris — a different goal than general filtration"
  - label: "Observe and Adjust"
    value: "The right depth often becomes clear after watching where debris collects over the first few days"
faq:
  - q: "What's the ideal depth for an aquarium filter intake?"
    a: "**As a general starting point, a few inches above the substrate and a few inches below the water's surface** — avoiding both extremes. An intake sitting right on or very close to the substrate tends to pull in gravel, sand, and settled debris (and puts small bottom-dwelling fish, fry, or shrimp closer to the intake). An intake right at the surface mostly captures floating particles and surface film, missing the debris that's settled lower in the water column. The middle of the water column, or somewhat toward the lower half but with clearance above the substrate, tends to capture a good mix of suspended debris without the substrate-related issues. This pairs with the broader placement guidance in our [canister filter intake/outlet placement guide](/canister-filter-inlet-outlet-placement/) — depth is one part of overall intake positioning."
  - q: "What actually goes wrong if the intake is too close to the substrate?"
    a: "**A few related issues: the intake pulls in gravel, sand, and settled detritus more than intended, which can clog the intake strainer faster and put more wear on the impeller** — covered in more depth in our guide on [sand getting into aquarium filters](/aquarium-sand-filter-problems/). There's also a practical risk consideration for **fry, shrimp, or small bottom-dwelling fish**, which spend more time near the substrate and are therefore closer to an intake positioned there. None of this means an intake can never be positioned low — some tanks intentionally run intakes lower to help with substrate-level debris — but it does mean a low intake benefits more from a **pre-filter sponge** and from being held a couple of inches clear of the substrate rather than resting directly on it."
  - q: "What if my intake is too shallow and seems to be missing debris?"
    a: "**This usually shows up as debris visibly settling and accumulating on the substrate or in low-flow areas despite the filter running normally** — the intake simply isn't positioned to catch it. Lowering the intake (within the general range above, with clearance from the substrate) typically helps. If your intake is on a fixed-length tube, many designs are **telescoping or adjustable**, allowing you to change the effective intake height without replacing parts. If adjustability isn't available and the intake genuinely can't reach a useful depth for your tank's water level, that's worth factoring into the next equipment decision — but it's a less common situation than simply not having adjusted what's already there."
  - q: "Does a shallow tank (like a low planted tank or turtle tank) need a different approach?"
    a: "**Generally yes — a shallow tank gives you less vertical range to work with, so the 'few inches from surface, few inches from substrate' guidance compresses into a smaller window, sometimes overlapping entirely.** In these setups, a shorter intake tube (sometimes requiring trimming an adjustable tube to length) and careful positioning matter more, since there's less margin for error. It's also worth checking that the intake stays submerged at your tank's normal water level — a shallow tank with some evaporation between top-offs can expose an intake that was fine when the tank was freshly filled, causing it to draw air and reduce flow. This is a similar 'don't set and forget it' consideration to the one covered in our [turtle tank filter guide](/can-i-turn-my-turtle-tank-filter-off-at-night/), where consistent filter operation matters for water quality."
related: ["canister-filter-inlet-outlet-placement", "can-a-filter-be-too-big-for-a-fish-tank", "aquarium-sand-filter-problems", "cotton-wool-in-my-aquarium-filter", "aquarium-filter-not-working-after-cleaning", "how-often-should-you-change-a-fish-tank-filter"]
sources:
  - label: "Filter Intake Positioning and Adjustment — Practical Fishkeeping"
    url: "https://www.practicalfishkeeping.co.uk/"
  - label: "Aquarium Filter Setup Discussion — Reef2Reef DIY Projects"
...
- **An intake near the substrate** captures settled debris more effectively, but also pulls in more gravel, sand, and substrate-level material — which affects the intake strainer and impeller over time, covered in our guide on [sand getting into aquarium filters](/aquarium-sand-filter-problems/).
