---
title: "Blue Devil Damselfish Care Guide: Tank Setup, Diet & Breeding"
description: "Complete care guide for the blue devil damselfish (Chrysiptera cyanea): tank size, water parameters, diet, tank mates, and breeding in a home reef aquarium."
slug: "blue-devil-damselfish"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "One of the most saturated blues in the hobby, and one of the scrappiest fish for its size — here's how to set up its tank and keep the peace."
tags: ["damselfish", "saltwater", "beginner fish", "reef safe"]
quickFacts:
  - label: "Scientific Name"
    value: "Chrysiptera cyanea"
  - label: "Care Level"
    value: "Easy — great for beginners"
  - label: "Minimum Tank Size"
    value: "20 gallons (75 L)"
  - label: "Temperament"
    value: "Aggressive and territorial, especially males"
  - label: "Diet"
  ...
  - label: "Lifespan"
    value: "6-10 years"
faq:
  - q: "What's the difference between a blue devil damselfish and a yellowtail damselfish?"
    a: "They're different species despite both sometimes being marketed as 'blue damsels.' The blue devil damselfish (Chrysiptera cyanea) is solid blue with a black-edged, often orange-tipped tail in males, while the [yellowtail damselfish](/yellowtail-damselfish/) (Chrysiptera parasema) has a blue body with a bright yellow tail and dorsal fin. The blue devil is also noticeably more aggressive than the yellowtail damselfish."
  - q: "Are blue devil damselfish reef safe?"
    a: "Yes. Blue devil damselfish won't bother corals, clams, or other sessile invertebrates, so they're safe for a reef tank from a coral standpoint. Their compatibility issues are entirely with other fish — they're one of the more pugnacious small damsels in the trade."
  - q: "Can I keep more than one blue devil damselfish together?"
    a: "It's risky in small tanks. Unlike some damsels that do well in groups, blue devil damselfish — especially males — are intensely territorial toward their own species. A male-female pair can work in a larger tank (40+ gallons) if introduced together, but two males in the same tank will almost always fight, often to the point of injury or death."
  - q: "Why did my blue devil damselfish's tail turn orange?"
    a: "That's a sign of a mature male — adult male Chrysiptera cyanea develop an orange or yellow-tinged tail edge, while females and juveniles typically have an all-blue tail with just a thin dark margin. If a previously all-blue fish is developing orange tail coloration, it's maturing into (or already was) a male."
related: ["yellowtail-damselfish", "azure-damselfish", "domino-damselfish", "firefish"]
sources:
  - label: "Chrysiptera cyanea — FishBase"
    url: "https://www.fishbase.se/summary/Chrysiptera-cyanea.html"
  - label: "Reef2Reef: Chrysiptera cyanea Aggression and Pairing Discussion"
    url: "https://www.reef2reef.com/"
---

The blue devil damselfish (*Chrysiptera cyanea*) is, in a lot of ways, the fish people picture when they hear "blue damsel" — a small, electric-blue fish that practically glows under reef lighting. It's also, true to its common name, one of the scrappier small fish you can put in a tank, with a temperament that punches well above its 3-inch weight class. It's frequently confused with the [yellowtail damselfish](/yellowtail-damselfish/) (*Chrysiptera parasema*), a different species entirely with a very different look and a noticeably calmer disposition. This guide covers what the blue devil damselfish actually needs, and how to manage the aggression that comes with it.
...
- Good tank mates include the [common clownfish](/common-clownfish/), [firefish](/firefish/), gobies, blennies, and other fish that either hold their own or occupy different areas of the tank (firefish, for instance, tend to stay in the water column or near a burrow rather than competing for the same rockwork).
- Avoid combining with other small blue damsels in anything but a large tank. A blue devil damselfish housed with an [azure damselfish](/azure-damselfish/) or [yellowtail damselfish](/yellowtail-damselfish/) can result in persistent low-grade conflict, since similarly colored, similarly sized fish read as direct competitors. If you want to keep several *Chrysiptera* species together, a 50+ gallon tank with rockwork broken into distinct zones gives each fish room to claim its own patch.
- A [domino damselfish](/domino-damselfish/) will generally outcompete and dominate a blue devil damselfish once it reaches adult size — not a good long-term pairing in a tank under about 75 gallons.
