---
title: "Colombian Shark Catfish Care Guide: Tank Size, Diet & the Brackish Question"
description: "Colombian shark catfish (Ariopsis seemanni) are sold small for freshwater community tanks — but they grow large, school, and may need brackish water as adults. Here's what to plan for."
slug: "colombian-shark-catfish"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Colombian shark catfish are sold as small, hardy community fish — but they grow to a foot or more, need to be kept in groups, and their natural habitat raises a long-term brackish water question."
tags: ["colombian shark catfish", "freshwater", "catfish", "brackish"]
quickFacts:
  - label: "Scientific Name"
    value: "Ariopsis seemanni (also sold as Hexanematichthys seemanni)"
  - label: "Care Level"
    value: "Moderate — straightforward day-to-day, but adult size/space planning is demanding"
  - label: "Minimum Tank Size"
    value: "75+ gallons for adults, kept in groups"
  - label: "Temperament"
    value: "Active, semi-aggressive as it grows — can outcompete smaller fish"
  - label: "Diet"
    value: "Omnivore — sinking pellets, meaty foods, some plant matter"
  - label: "Water Temperature"
    value: "75-80°F (24-27°C)"
  - label: "Max Size"
    value: "12+ inches"
  - label: "Schooling Needs"
    value: "Should be kept in groups of 3+ — becomes stressed and skittish alone"
faq:
  - q: "How big do Colombian shark catfish get?"
    a: "Colombian shark catfish (Ariopsis seemanni) commonly reach 12 inches or more as adults — substantially larger than the 2-3 inch juveniles typically sold for community tanks. Combined with their schooling requirement (groups of 3 or more for the fish to feel secure), an adult group needs a tank in the range of 75 gallons or more, which is considerably more space than most buyers anticipate based on the fish's appearance and size at purchase — a pattern that shows up across several catfish discussed in our [channel catfish guide](/channel-catfish-tank-conditions/), though Colombian sharks are less extreme than that species."
  - q: "Do Colombian shark catfish need brackish water?"
    a: "It's a genuinely debated and somewhat unresolved point in the hobby. Colombian shark catfish are native to coastal and estuarine waters in South/Central America, habitats that can include brackish conditions, and some keepers and resources suggest that long-term health — particularly as the fish ages — may benefit from some salinity, even if the species can survive in fully freshwater setups for extended periods. There isn't full consensus on whether brackish water is strictly necessary versus simply beneficial, but it's a consideration worth researching before committing to a purely freshwater setup for the fish's entire (potentially long) lifespan, rather than assuming the freshwater community tank it's sold in is its permanent ideal environment."
  - q: "Are Colombian shark catfish aggressive?"
  ...
  - q: "What should I feed a Colombian shark catfish?"
    a: "An omnivorous diet works well — quality sinking pellets or wafers as a staple, supplemented with meaty foods (shrimp, bloodworms) and some plant matter. As an active, fairly large fish, Colombian shark catfish have a correspondingly substantial appetite and waste output as they grow, a bioload consideration similar in principle to the one discussed for plecos in our [pleco waste guide](/pleco-poop-information/) — filtration and maintenance schedules should scale with the fish's actual adult size, not its size at purchase."
related: ["channel-catfish-tank-conditions", "berneys-shark-catfish", "stingray-pleco", "pleco-poop-information", "bloated-cory-catfish"]
sources:
  - label: "Ariopsis seemanni — FishBase"
    url: "https://www.fishbase.se/summary/Ariopsis-seemanni.html"
  - label: "Catfish Care & Compatibility Guide — Practical Fishkeeping"
...
- **Some plant matter** rounds out the diet, though it's a smaller component than for more herbivorous species like the [American flagfish](/american-flagfish/)

As the fish grows, both appetite and waste output increase substantially — a consideration that connects to the broader bioload discussion in our [pleco waste guide](/pleco-poop-information/), where waste volume scales with both diet and body size.
...
- **Stress from inadequate group size or space** — a Colombian shark catfish kept alone or in too small a tank may show increased skittishness, reduced activity, or faded coloration, similar to stress presentations discussed for other schooling species like [Bala sharks](/bala-sharks-with-cichlids/).
