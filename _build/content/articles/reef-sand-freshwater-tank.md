---
title: "Can You Use Reef Sand in a Freshwater Tank? Hardness, pH & Best Uses"
description: "Reef/aragonite sand raises pH and hardness by slowly dissolving — a benefit for African cichlid tanks, but a problem for soft-water species like altum angelfish or brackish setups."
slug: "reef-sand-freshwater-tank"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Reef sand isn't just decor — its calcium carbonate content slowly raises pH and hardness, which makes it a useful tool for some freshwater tanks and a poor fit for others."
tags: ["reef sand", "aragonite", "African cichlids", "water hardness", "freshwater substrate"]
quickFacts:
  - label: "What It Is"
    value: "Crushed coral or aragonite-based sand, marketed for marine/reef tanks, composed largely of calcium carbonate"
  - label: "Effect on Water"
    value: "Slowly dissolves, raising pH and general/carbonate hardness (GH/KH) over time"
  - label: "Best Use Case"
    value: "African cichlid tanks (Lake Malawi, Tanganyika, Victoria) that benefit from hard, alkaline water"
  - label: "Species to Avoid With"
    value: "Soft-water and blackwater species — e.g., altum angelfish, many South American tetras"
  - label: "Typical pH Effect"
    value: "Helps buffer pH toward 7.8-8.5+, depending on tank volume, water source, and amount of sand used"
  - label: "Mixing With Inert Sand"
    value: "Possible, but dilutes and makes the hardening effect harder to predict"
  - label: "Maintenance Note"
    value: "Buffering effect can diminish over time as detritus and biofilm coat the sand's surface"
  - label: "Brackish Tanks"
    value: "A different consideration — salinity, not just hardness, is the main factor for species like green spotted puffers or dragon gobies"
faq:
  - q: "Can you use reef sand in a freshwater tank?"
    a: "Yes, in the right context. Reef sand (often labeled as aragonite sand or crushed coral) is sold for marine and reef tanks, but its defining property — that it's made largely of **calcium carbonate**, which slowly dissolves into the water — isn't exclusive to saltwater applications. In a freshwater tank, that same dissolution **raises pH and general/carbonate hardness (GH/KH)** over time, which is exactly what some freshwater setups, particularly African cichlid tanks, are looking for. The question isn't really 'can you' so much as 'should you for *this* tank' — and that depends entirely on what the fish in that tank actually need."
  - q: "Will reef sand make my freshwater tank's pH too high?"
    a: "It can, depending on your starting water and how much reef sand you use. If your tap water is already moderately hard and alkaline, adding reef sand may push pH and hardness higher than is appropriate for many community fish, which often prefer pH in the 6.5-7.5 range. If your tap water is soft and slightly acidic, reef sand can have a more moderate, stabilizing effect — keeping pH from swinging too low rather than pushing it dramatically high. The practical approach is to **test your water with and without the sand** (or in a small test container) before committing to it as a tank's primary substrate, rather than assuming a fixed effect."
  - q: "Is reef sand the same thing as crushed coral?"
    a: "They're closely related but not always identical. Both are typically **aragonite-based, calcium carbonate substrates** that dissolve slowly and raise pH/hardness — the main practical differences tend to be **particle size and texture**. 'Reef sand' is usually finer and more sand-like, while [crushed coral](/crushed-coral/) often has larger, more angular pieces, sometimes used in canister filters or sumps specifically for its buffering effect rather than as a display substrate. For a display tank where fish will be in regular contact with the substrate, finer reef sand is generally the more comfortable choice — the buffering chemistry is similar either way."
  - q: "What should I use instead for soft-water or blackwater tanks?"
    a: "**Inert substrates** — sand or gravel that doesn't significantly alter water chemistry, such as plain silica sand or pool filter sand — are the standard choice for soft-water and blackwater setups, where the goal is often to **lower** pH and hardness rather than raise it. This is the substrate approach used for species like the [altum angelfish](/how-to-care-for-altum-angelfish/), which needs very soft, acidic water (pH 4.5-6.0) — reef sand in that tank would actively work against the water chemistry the fish needs, slowly pushing pH and hardness in the wrong direction. For blackwater tanks specifically, driftwood and leaf litter (which release tannins and have a mild softening effect) are typically paired with an inert substrate, the opposite combination from a reef-sand cichlid setup."
related: ["driftwood-cichlid-tank", "epsom-salt-for-african-cichlids", "how-to-care-for-altum-angelfish", "green-spotted-pufferfish", "75-gallon-peacock-cichlid-tank", "crushed-coral"]
sources:
...
This pairs well with other approaches used in African cichlid tanks, such as adding [Epsom salt for African cichlids](/epsom-salt-for-african-cichlids/) to adjust magnesium and hardness, or using a [driftwood-based cichlid tank](/driftwood-cichlid-tank/) aquascape — though it's worth noting that driftwood itself can have a mild softening/acidifying tendency, which in a reef-sand tank is often counteracted by the sand's buffering rather than causing a real conflict. The net effect in most reef-sand African cichlid tanks is still a stable, hard, alkaline environment.
