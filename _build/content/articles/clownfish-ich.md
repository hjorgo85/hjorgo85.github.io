---
title: "Clownfish Ich vs. Brooklynella: Symptoms, Treatment & Quarantine"
description: "Clownfish are unusually prone to Brooklynella as well as marine ich, and the two are often confused. Here's how to tell them apart, treat each, and protect new arrivals."
slug: "clownfish-ich"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Marine ich and Brooklynella look similar at a glance but progress very differently — and clownfish are far more vulnerable to one of them than most reef fish."
tags: ["clownfish", "saltwater", "fish health", "quarantine"]
quickFacts:
  - label: "Causative Organism (Ich)"
    value: "Cryptocaryon irritans (protozoan parasite)"
  - label: "Causative Organism (Brooklynella)"
    value: "Brooklynella hostilis (protozoan parasite, 'clownfish disease')"
  - label: "Contagious?"
    value: "Yes — both spread readily to tankmates and via shared equipment"
  - label: "Reef-Safe Treatment Options"
    value: "Freshwater/formalin dips, hyposalinity (fish-only), garlic/herbal additives (limited efficacy)"
  - label: "Non-Reef-Safe Treatments"
    value: "Copper-based medications, chloroquine phosphate (in a separate hospital tank)"
  - label: "Quarantine Recommended?"
    value: "Yes — 2-4 weeks minimum for all new clownfish"
  - label: "Typical Onset After Stress"
    value: "Brooklynella can appear within 24-72 hours of a stressful event; ich often 1-2 weeks"
faq:
  - q: "What's the difference between ich and Brooklynella in clownfish?"
    a: "Marine ich (*Cryptocaryon irritans*) causes small, discrete white spots (roughly salt-grain sized) scattered over the body and fins, and tends to progress over days to weeks. Brooklynella (*Brooklynella hostilis*), often called 'clownfish disease,' causes a hazy, sloughing layer of excess mucus that can make the fish look like it's 'peeling,' along with rapid breathing, and it can kill a clownfish within 24-48 hours of symptoms appearing. Brooklynella is faster, more specific to anemonefish (especially newly imported ones), and more urgent."
  - q: "Why are clownfish more prone to Brooklynella than other fish?"
    a: "Brooklynella hostilis disproportionately affects anemonefish, and clownfish — especially wild-caught or recently shipped individuals — are the textbook case. The parasite thrives on stressed fish with compromised mucus layers, and the stress of capture, shipping, and acclimation hits clownfish hard relative to their size. It's so strongly associated with the group that 'clownfish disease' is a common nickname for the infection itself, even though it can affect other fish too."
  - q: "Can I treat ich or Brooklynella in my reef tank without removing the fish?"
...
sources:
  ...
  - label: "Quarantine Protocols for Marine Fish — LiveAquaria"
    url: "https://www.liveaquaria.com/"
---

If you've ever seen a clownfish covered in white spots or looking like it's shedding a layer of skin, you've likely seen one of two very different parasitic infections — marine ich (*Cryptocaryon irritans*) or Brooklynella (*Brooklynella hostilis*) — and which one it is matters enormously for how fast you need to act. Clownfish, including [common clownfish](/common-clownfish/) and the [maroon clownfish](/maroon-clownfish-premnas-biaculeatus/), are susceptible to both, but they're notably more vulnerable to Brooklynella than most marine fish, particularly when newly imported. This article covers how to tell the two apart, how to treat each safely, and why quarantine matters more for clownfish than for almost any other group of fish in the hobby.
...
This applies across species — the same protocol that protects a [common clownfish](/common-clownfish/) applies to a [maroon clownfish](/maroon-clownfish-premnas-biaculeatus/) or any other anemonefish you're adding to your [saltwater](/saltwater/) tank.
