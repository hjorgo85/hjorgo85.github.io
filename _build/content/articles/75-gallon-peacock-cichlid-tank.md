---
title: "75-Gallon Peacock Cichlid Tank: How Many Fish and What Setup Works"
description: "How to stock a 75-gallon peacock cichlid (Aulonocara) tank — realistic numbers, male-to-female ratios, substrate and aquascaping choices, and which tankmates fit."
slug: "75-gallon-peacock-cichlid-tank"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "75 gallons is a popular and genuinely workable size for a peacock cichlid tank — but how you split that space between males, females, and other species makes or breaks the result."
tags: ["cichlids", "freshwater", "peacock cichlid", "stocking guide"]
quickFacts:
  - label: "Genus"
    value: "Aulonocara (peacock cichlids), Lake Malawi"
  - label: "Recommended Stocking (75 gal)"
    value: "8-12 peacocks, multiple species/color forms with several females per male"
  - label: "Male-to-Female Ratio"
    value: "Roughly 1 male to 3-4 females per species/color form"
  - label: "Substrate"
    value: "Fine sand — peacocks sift sand for food and dig shallow pits"
  - label: "Temperament"
    value: "More peaceful than Mbuna, but males can be territorial toward similar-colored males"
  - label: "Diet"
    value: "Omnivore — more protein-tolerant than Mbuna, but still benefits from varied diet"
  - label: "Water Parameters"
    value: "pH 7.8-8.6, hard water (Lake Malawi conditions)"
  - label: "Compatible Tankmates"
    value: "Other peacocks, peaceful Malawi haps — Mbuna often too aggressive"
faq:
  - q: "How many peacock cichlids can I keep in a 75-gallon tank?"
    a: "A common and workable approach is 8-12 peacock cichlids in a 75-gallon tank, structured as several male/female groups (one male with 3-4 females per color form/species) rather than an even mix of males and females. This ratio reduces aggression toward females from any single male and reduces the chance of unwanted hybridization between similar-looking peacock species or color forms."
  - q: "Why does the male-to-female ratio matter for peacock cichlids?"
    a: "Male peacock cichlids can be persistent toward females, particularly during spawning behavior, and a 1:1 ratio concentrates that attention on a single female, which can become a welfare issue. A ratio of roughly one male to three or four females per species/color form spreads that attention across more individuals. It also reduces the visual competition between males of different species that might otherwise interbreed if housed as isolated pairs rather than as part of a larger group."
  - q: "Can peacock cichlids be kept with Mbuna?"
    a: "It's possible but comes with real tradeoffs. Mbuna — covered from the diet angle in our [Mbuna feeding guide](/best-food-for-mbuna-cichlids/) — are generally more aggressive than peacock cichlids, and in a mixed tank, Mbuna can out-compete peacocks for food and territory, and in some cases stress or injure them. If mixing the two groups, a larger tank than 75 gallons, careful species selection (less aggressive Mbuna species), and close monitoring for one-sided aggression are all important. Many keepers choose to keep peacocks with other peacocks and peaceful Malawi haps instead, avoiding the more aggressive Mbuna entirely."
  - q: "What substrate is best for a peacock cichlid tank?"
    a: "Fine sand is strongly preferred over gravel or crushed coral with sharp edges. Peacock cichlids are sand-dwellers in the wild, sifting through sand for food and often digging shallow pits as part of normal behavior — both because it reflects natural behavior and because sand is gentler on the barbels and undersides of fish that spend significant time near the substrate. Crushed coral can still be useful for buffering pH and hardness (a separate consideration covered in our [driftwood and cichlid tank guide](/driftwood-cichlid-tank/)), but a fine sand cap over or instead of it is generally recommended."
related: ["best-food-for-mbuna-cichlids", "driftwood-cichlid-tank", "bala-sharks-with-cichlids", "cichlids-with-cloudy-eyes", "peacock-eel-with-cichlids", "johanni-vs-maingano"]
sources:
  - label: "Peacock Cichlid (Aulonocara) Stocking & Care — Cichlid Forum"
    url: "https://www.cichlid-forum.com/"
  - label: "Lake Malawi Aquarium Setup — Practical Fishkeeping"
...
- **Diet:** As covered in our [Mbuna diet guide](/best-food-for-mbuna-cichlids/), Mbuna are predominantly herbivorous grazers with a real risk of bloat from rich diets. Peacocks are more omnivorous and somewhat more tolerant of varied diets, though they still benefit from a diet that isn't dominated by fatty, protein-heavy foods.
...
4. **Add fish gradually**, similar to the stocking pace recommended for [marine tanks](/saltwater-aquarium-fish-for-beginners/) — adding an entire stocking list at once to a newly cycled tank doesn't give the biological filtration time to catch up, regardless of which type of fish is involved.
