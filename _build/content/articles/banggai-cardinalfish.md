---
title: "Banggai Cardinalfish Care Guide: Tank Setup, Diet & Breeding"
description: "Complete care guide for the Banggai cardinalfish (Pterapogon kauderni): tank size, water parameters, diet, tank mates, and breeding in a home reef aquarium."
...
imageWidth: 1200
imageHeight: 800
excerpt: "A slow-moving, strikingly patterned reef fish that's both endangered in the wild and one of the easiest marine fish to breed at home — here's how to care for it properly."
tags: ["cardinalfish", "saltwater", "reef safe", "beginner fish"]
quickFacts:
  - label: "Scientific Name"
    value: "Pterapogon kauderni"
  - label: "Care Level"
    value: "Easy — excellent for beginners"
  - label: "Minimum Tank Size"
    value: "30 gallons (115 L)"
  - label: "Temperament"
    value: "Peaceful, shoaling"
  - label: "Diet"
    value: "Carnivore (mysis, brine, finely chopped meaty foods)"
  - label: "Reef Safe"
    value: "Yes"
  - label: "Max Size"
    value: "~3 inches (8 cm) including fin extensions"
  - label: "Lifespan"
    value: "3-5 years in captivity"
faq:
  - q: "How many Banggai cardinalfish can I keep together?"
    a: "Banggai cardinalfish are naturally shoaling and do best in groups. A group of 3-6 in a tank of 30+ gallons with adequate hiding spots will form a loose hierarchy and rarely show serious aggression. Pairs will often split off from the group to spawn."
  - q: "Are Banggai cardinalfish reef safe?"
    a: "Yes, completely. Banggai cardinalfish are slow-moving plankton feeders that ignore corals, clams, and other sessile invertebrates entirely. The only compatibility concern is with small ornamental shrimp, which a hungry cardinalfish may occasionally pick at if underfed."
  - q: "Why is my Banggai cardinalfish not eating?"
    a: "New Banggai cardinalfish are often slow to recognize prepared foods, especially if wild-caught and used to live plankton. Try live or frozen mysis/copepods first, dimming the lights at feeding time, and feeding right where the fish is sheltering — they're not aggressive feeders and won't compete well for food at the surface."
  - q: "Can Banggai cardinalfish breed in a home aquarium?"
    a: "Yes — they're one of the few marine fish that regularly breed in home tanks. The male is a mouthbrooder and carries fertilized eggs, then free-swimming fry, in his mouth for roughly 20-30 days. With a dedicated breeding setup, raising the fry to juvenile size is realistic even for hobbyists without prior breeding experience."
related: ["yellowtail-damselfish", "common-clownfish", "flame-angelfish", "pearlscale-butterflyfish-reef-safe"]
sources:
  - label: "Pterapogon kauderni — FishBase"
    url: "https://www.fishbase.se/summary/Pterapogon-kauderni.html"
  - label: "Reef Builders: Banggai Cardinalfish Care and Conservation"
...
- Clownfish such as the [common clownfish](/common-clownfish/) — both are peaceful, occupy different parts of the tank, and rarely interact
- Gobies, blennies, and peaceful wrasses
- Other slow-to-moderate feeders that won't out-compete them at mealtime
- Even semi-aggressive fish like the [flame angelfish](/flame-angelfish/) generally ignore Banggai cardinalfish, since they occupy completely different niches and don't compete for the same food or territory
...
- Avoid mixing with the [yellowtail damselfish](/yellowtail-damselfish/) in small tanks under 30 gallons, where territorial damsels can bully the slower-moving cardinalfish — in larger tanks with enough separate territory, the two coexist fine
...
1. A bonded pair will go through a courtship ritual involving fin displays and circling, often over several days.
2. The female passes a clutch of large eggs (relatively few compared to most marine fish — often 10-30) to the male, who takes them into his mouth.
3. The male carries the eggs, and later the hatched fry, in his buccal cavity for roughly **20-30 days**, during which he typically stops eating or eats very little.
4. When released, the fry are already relatively large and well-developed compared to the larvae of most marine fish — they don't go through a planktonic larval stage, which is the main reason they're so much easier to raise than, say, clownfish fry.
5. Fry can be moved to a separate rearing tank and fed newly hatched brine shrimp and finely crushed flake almost immediately after release.
