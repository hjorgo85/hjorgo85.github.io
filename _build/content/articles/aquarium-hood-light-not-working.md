---
title: "Aquarium Hood Light Not Working: How to Troubleshoot It"
description: "When the light built into your aquarium hood won't turn on, the cause is usually power, the bulb/LED, a tripped GFCI, or condensation — here's how to narrow it down."
slug: "aquarium-hood-light-not-working"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A hood light that won't turn on is usually a power issue, a dead bulb or LED, a tripped GFCI, or condensation getting where it shouldn't — here's how to work through it."
tags: ["aquarium lighting", "hood light", "LED aquarium light", "equipment troubleshooting", "equipment"]
quickFacts:
  - label: "Start Here"
    value: "Confirm the fixture is getting power before assuming the bulb/LED has failed"
  - label: "GFCI Outlets"
    value: "A tripped GFCI near the tank can cut power to the light without any obvious sign at the fixture itself"
  - label: "Bulb/LED Test"
    value: "Swapping in a known-working bulb (or testing the fixture on another outlet) isolates fixture vs. bulb issues"
  - label: "Condensation"
    value: "Hood lights sit close to humid air — a failed condensation tray or cover glass can let moisture reach electrical components"
  - label: "Fluorescent Ballasts"
    value: "On T5/T8 fixtures, a failed ballast prevents the tube from lighting even if the tube itself is fine"
  - label: "Partial LED Failure"
    value: "Dim sections or dead diode strips on an LED fixture usually mean a driver or strip issue, not total failure"
  - label: "Timers"
    value: "A misprogrammed or malfunctioning timer can make a working light appear 'broken' if it's simply off-schedule"
  - label: "Replace vs. Repair"
    value: "Many hood lights are sealed units — once the LED driver or ballast fails, replacing the fixture is often more practical than repairing it"
faq:
  - q: "My aquarium hood light won't turn on at all — where do I start?"
  ...
  - q: "My light turns on but looks dimmer or has dead sections — what's going on?"
    a: "**This is a different issue from total failure, and points toward the bulb/LED rather than power.** On fluorescent fixtures, a tube that's dim, flickering, or showing dark bands near the ends is typically **near end-of-life** and due for replacement — fluorescent tubes degrade gradually rather than failing all at once. On LED fixtures, **dead sections or color-shifted areas** usually indicate a failed LED strip or segment within the fixture; depending on the fixture's design, this may or may not be a user-replaceable part. Either way, a partial failure like this is a sign to plan for replacement (of the tube, or the fixture if it's an integrated LED unit) rather than something likely to resolve on its own — and it's worth noting that reduced lighting can affect plants or corals before it becomes visually obvious, covered in our guide on [how much white light corals need](/how-much-white-light-do-corals-need/)."
related: ["juwel-aquarium-lights-not-working", "how-long-can-algae-live-without-light", "best-lighting-for-40-gallon-breeder", "how-much-white-light-do-corals-need", "how-long-can-fish-live-without-air-pump-or-filter", "aquarium-heater-light-on-but-heater-not-working"]
sources:
  - label: "Aquarium Lighting Troubleshooting — Practical Fishkeeping"
    url: "https://www.practicalfishkeeping.co.uk/"
  - label: "Aquarium Lighting Equipment Discussion — Reef2Reef DIY Projects"
