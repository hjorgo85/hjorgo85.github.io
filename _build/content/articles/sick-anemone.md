---
title: "My Anemone Looks Sick: How to Tell What's Wrong"
description: "A shrinking, pale, drifting, or closed-up anemone is sending a signal — usually about water quality, lighting, or flow. Here's how to read the signs and what to check first."
slug: "sick-anemone"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Anemones communicate distress through their body, not their behavior — shrinking, paling, drifting, or staying closed are all signals worth reading before assuming the worst."
tags: ["anemone", "reef tank", "anemone health", "bubble tip anemone", "troubleshooting"]
quickFacts:
  - label: "Most Common Causes"
    value: "Water quality swings, insufficient or excessive lighting, poor flow, or being pulled into a pump/overflow"
  - label: "Shrinking/Deflating"
    value: "Can be normal after relocating, or a sign of stress — context and duration matter"
  - label: "Pale or White Anemone"
    value: "Often bleaching — loss of zooxanthellae (symbiotic algae), usually a lighting or water quality issue"
  - label: "Drifting Around the Tank"
    value: "Anemones can move on their own when unhappy with current placement — usually not an emergency by itself"
  - label: "Mouth Gaping Open"
    value: "Can be normal during/after feeding, or a stress sign if prolonged and combined with other symptoms"
  - label: "Foul Smell or Disintegrating Tissue"
    value: "A genuine emergency — a dying anemone can foul an entire tank quickly"
  - label: "First Checks"
    value: "Water parameters (salinity, alkalinity, ammonia/nitrite), flow near the anemone, lighting intensity and duration"
  - label: "Recovery Timeline"
    value: "Stressed but intact anemones can often recover over days to weeks once the underlying issue is corrected"
faq:
  - q: "How can I tell if my anemone is just adjusting versus actually sick?"
    a: "**Context and trajectory matter more than a single snapshot.** An anemone that was recently moved, added to a new tank, or experienced a flow/lighting change may **deflate, close up, or relocate itself** for a few days as part of normal adjustment — this is common and usually resolves on its own. What's more concerning is a **clear downward trend over days to weeks**: progressive shrinking, paling, or staying closed well beyond an initial adjustment period, especially if it's paired with [the anemone's mouth staying open](/anemone-mouth-open/) without feeding, or visibly [expelling brown material](/anemone-expelling-zooxanthellae/). A single bad day is rarely an emergency; a multi-week decline usually points to an ongoing issue with water quality, lighting, or placement that needs to be identified and corrected."
  - q: "What water parameters should I check first if my anemone looks unhealthy?"
    a: "Anemones are generally considered **more sensitive to water quality swings than many corals**, so a quick parameter check is a reasonable first step: **salinity/specific gravity** (sudden swings from top-off water or evaporation are a common culprit — see our guide on [specific gravity in reef tanks](/specific-gravity-reef-tank/)), **ammonia and nitrite** (any detectable reading is a problem in an established tank), and **alkalinity and calcium** (anemones, like corals, draw on these — see our guide on [raising alkalinity](/raise-alkalinity-reef-tank/) if levels have drifted). A recent water change with mismatched parameters, a skipped maintenance cycle, or a sudden temperature swing are all common triggers for a previously healthy anemone to suddenly look stressed."
  - q: "Can lighting cause an anemone to look sick?"
    a: "**Yes, in both directions.** Anemones host symbiotic algae (zooxanthellae) that need adequate light to photosynthesize — **insufficient lighting** (too dim, too short a photoperiod, or an anemone placed in a shaded spot in the tank) can lead to a slow decline as the anemone isn't getting enough energy from its symbionts. On the other end, **a sudden increase in light intensity** (new fixture, anemone moved to a brighter spot, or lights run at higher intensity without acclimation) can cause **bleaching** — the anemone expelling its zooxanthellae as a stress response, which often shows up as the anemone turning noticeably paler or whiter (see our guide on [anemones expelling zooxanthellae](/anemone-expelling-zooxanthellae/)). Any lighting change for an anemone-containing tank is generally worth introducing gradually rather than all at once."
  - q: "When is a sick-looking anemone an emergency?"
    a: "The clearest emergency signal is a **dying anemone starting to disintegrate** — tissue becoming stringy, the anemone deflating completely and not recovering, or a strong foul odor developing. A decomposing anemone can **rapidly foul the water in an entire tank**, causing an ammonia spike that threatens fish and other invertebrates, not just the anemone itself. If an anemone appears to be actively dying (not just stressed or shrunken, but visibly breaking down), the standard advice is to **remove it from the tank as soon as possible** — even if it's not fully dead yet — rather than waiting to see if it recovers, specifically to protect the rest of the tank's inhabitants from the ammonia and toxins released as it decomposes."
related: ["why-is-my-anemone-shrinking", "anemone-mouth-open", "anemone-expelling-zooxanthellae", "black-widow-anemone-or-rose-bta", "amphipods-reef-tank"]
sources:
...
- **Shrinking or deflating** — can be a normal response to a recent move, or a sign of ongoing stress if it persists; see our [dedicated guide on anemone shrinking](/why-is-my-anemone-shrinking/) for a closer look
- **Paling, going white, or losing color** — usually **bleaching**, the anemone expelling its symbiotic algae, often linked to a lighting change or water quality issue; see our guide on [anemones expelling zooxanthellae](/anemone-expelling-zooxanthellae/)
- **Mouth open for extended periods** — can be normal during/after feeding, but worth a closer look if prolonged; see our guide on [anemone mouth behavior](/anemone-mouth-open/)
...
- **Salinity/specific gravity** — check for drift from evaporation or a recent water change with mismatched salinity (see our [specific gravity guide](/specific-gravity-reef-tank/))
- **Ammonia and nitrite** — any detectable reading in an established tank is worth investigating immediately
- **Alkalinity and calcium** — anemones draw on these similarly to corals; a drift here can stress an anemone even if fish seem unaffected (see our guide on [raising alkalinity](/raise-alkalinity-reef-tank/))
