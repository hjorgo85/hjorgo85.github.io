---
title: "Why Do Clownfish Turn Black? (And Lose Their Orange Color)"
description: "Clownfish darkening or fading from orange to black can be completely normal aging, or a sign of stress, poor water quality, or a struggling host anemone. Here's how to tell which."
slug: "why-do-clownfish-turn-black"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "From natural 'black ocellaris' darkening to stress, water quality, and bleached-anemone hosting — here's what's actually behind a clownfish turning black or losing its orange."
tags: ["clownfish", "saltwater", "fish health", "water quality"]
quickFacts:
  - label: "Most Common Cause"
    value: "Normal age-related darkening (ontogenetic color change)"
  - label: "Usually Reversible?"
    value: "Depends — age-related darkening is permanent, stress-related fading often isn't"
  - label: "Linked to Anemone Hosting?"
    value: "Yes — hosting in a bleached or unhealthy anemone can darken a clownfish"
  - label: "Linked to Stress/Water Quality?"
    value: "Yes — poor water quality and chronic stress can cause dulling or darkening"
  - label: "When It's Normal"
    value: "Gradual darkening in mature A. ocellaris/A. percula, especially 'black ice' lines"
  - label: "When to Test Water"
    value: "If darkening is sudden, accompanied by clamped fins, not eating, or rapid breathing"
  - label: "Affects Which Species Most"
    value: "Amphiprion ocellaris and A. percula most commonly reported"
faq:
  - q: "Is it normal for a clownfish to turn black as it gets older?"
    a: "Yes, for many individuals — particularly *Amphiprion ocellaris* and *A. percula*. As these clownfish mature, the orange portions of their body can gradually darken to a deep brown or black, sometimes leaving only the white bars clearly visible. This is a natural pigment change (sometimes called 'black ocellaris') and is permanent, but it doesn't indicate illness — a darkening clownfish that is eating normally, swimming actively, and breathing normally is simply changing color with age."
  - q: "Why did my clownfish turn black after I added an anemone?"
    a: "If a clownfish is hosting in an anemone that becomes stressed or bleached (loses its color due to expelling its symbiotic algae), the clownfish itself can darken in response. The exact mechanism isn't fully settled, but it's a well-documented field observation — a clownfish's coloration can shift to match or respond to the condition of its host anemone. If your anemone has bleached white and your clownfish has darkened around the same time, check your lighting and water parameters for the anemone, since the anemone's health is the more urgent issue."
  - q: "My clownfish is losing its orange color and turning pale, not black — what's wrong?"
...
sources:
  ...
  - label: "Anemone Bleaching and Clownfish Hosting — Reef Builders"
...
## Normal Age-Related Darkening ("Black Ocellaris")
...
## Stress-Related Darkening and Color Loss
