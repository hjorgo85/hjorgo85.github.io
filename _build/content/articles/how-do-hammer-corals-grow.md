---
title: "How Do Hammer Corals Grow? Growth Pattern and Care Basics"
description: "Hammer corals (Euphyllia ancora/parancora) grow by gradually forming new heads along the colony base — a slow, steady process shaped by light, flow, feeding, and water stability."
slug: "how-do-hammer-corals-grow"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Hammer coral growth happens head by head — new growth points form along the skeleton base over a period of months, with overall colony shape developing gradually as heads multiply."
tags: ["hammer coral", "Euphyllia", "LPS corals", "coral growth", "reef tank"]
quickFacts:
  - label: "Species"
    value: "Euphyllia ancora or Euphyllia parancora, commonly called hammer coral"
  - label: "Distinctive Feature"
    value: "Anchor- or hammer-shaped polyp tips, giving the species its common name"
  - label: "Growth Pattern"
    value: "New heads form gradually along the base of the skeleton, similar to other branching Euphyllia"
  - label: "Typical Pace"
    value: "Moderate — comparable to torch corals, with visible new growth typically over a span of months"
  - label: "Colony Shape Over Time"
    value: "Starts as one or a few heads and gradually develops a branching, multi-head structure"
  - label: "Encrusting vs. Branching Forms"
    value: "Hammer corals can present in 'wall' (more clustered) or 'branching' (more spread out) growth forms"
  - label: "What Supports Growth"
    value: "Stable calcium/alkalinity/magnesium, moderate light, moderate flow, and periodic feeding"
  - label: "Sweeper Tentacles"
    value: "As colonies grow, sweeper tentacle reach increases — spacing needs to account for this over time"
faq:
  - q: "What does hammer coral growth look like over time?"
    a: "Similar to other branching Euphyllia (see our guide on [torch coral growth](/how-fast-do-torch-corals-grow/) for a closely related example), hammer coral growth happens through the **gradual formation of new heads** along the base of the existing skeleton. A frag that starts as a single head or a small cluster of heads will, given good conditions, slowly develop **additional heads** branching outward — over a timeframe generally measured in **months rather than weeks**. The overall effect, viewed over a year or more, is a colony that goes from a small clump to a noticeably larger, denser cluster of anchor-shaped polyps. Like torch coral growth, this is usually easier to appreciate by **comparing photos over time** than by watching for day-to-day change."
  - q: "Why does my hammer coral have a 'wall' shape while others look more spread out?"
...
**Hammer corals (Euphyllia ancora/parancora) grow the way most branching Euphyllia do — gradually, head by head, along the base of the existing skeleton, typically over a timeframe of months.** A colony that starts as one or a few heads slowly develops additional heads given **stable parameters, moderate lighting and flow, and periodic feeding** — the same general factors that affect [torch coral growth](/how-fast-do-torch-corals-grow/), since both are closely related Euphyllia species. Growth is usually easier to track by comparing photos across months than by watching for visible day-to-day change.

## The Head-by-Head Growth Process

Hammer coral colonies are made up of individual **"heads"** — each with its own anchor- or hammer-shaped polyp tips, the feature that gives the species its common name. Growth happens as **new heads form along the base** of existing ones, gradually expanding the colony outward. Over a span of months to years, this turns a small frag into a denser, multi-head cluster. The process is **slow and incremental** — much like [torch coral growth](/how-fast-do-torch-corals-grow/), it's typically more visible in retrospect than in the moment.
...
The factors that influence hammer coral growth track closely with [general LPS care](/lps-corals-for-beginners/):
...
- **Regular feeding** — hammer corals readily accept direct feeding of meaty foods, covered in our guide on [what hammer corals eat](/what-do-hammer-corals-eat/), and many keepers associate a consistent feeding routine with better growth and coloration over time

## Planning Space for a Growing Colony

As a hammer coral develops more heads and increases in overall size, its **sweeper tentacle reach tends to increase as well** — these tentacles can sting neighboring corals on contact, as discussed in our [LPS corals for beginners guide](/lps-corals-for-beginners/). A placement that looks comfortably spaced for a small frag can become tight within a year or two of healthy growth. When placing a hammer coral, it's worth thinking about its **likely size down the road**, not just its current footprint, when deciding how much room to give it relative to neighboring corals.
