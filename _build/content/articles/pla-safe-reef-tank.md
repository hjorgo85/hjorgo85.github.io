---
title: "Is PLA Safe for a Reef Tank? 3D Printed Parts Underwater"
description: "PLA filament is the most common material for 3D printed reef tank accessories — here's whether it's actually safe underwater, how long it lasts, and when to use PETG instead."
slug: "pla-safe-reef-tank"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "3D printing your own frag racks and mounts is popular and PLA is the easiest filament to print with — but it's not the material to trust for anything permanent underwater."
tags: ["saltwater", "reef tank", "3D printing", "DIY", "aquascaping"]
quickFacts:
  - label: "Is PLA Reef Safe?"
    value: "Generally yes for short-to-medium-term submerged use — inert once fully cured/printed"
  - label: "What PLA Is"
    value: "Polylactic acid — a biodegradable, plant-derived 3D printing filament"
  - label: "Main Limitation"
    value: "Can hydrolyze (break down) over months in warm saltwater, becoming brittle"
  - label: "Better Long-Term Alternative"
    value: "PETG — more water-resistant for permanent submerged parts"
  - label: "Common DIY Uses"
    value: "Frag racks, coral mounts, aquascaping supports, equipment brackets"
  - label: "Colorant Concern"
    value: "Plain/natural-color filament is the safer choice over heavily dyed filaments"
  - label: "Recommended Practice"
    value: "Rinse printed parts and monitor for early degradation before trusting them long-term"
  - label: "Not Recommended For"
    value: "Permanent structural supports or anything load-bearing over the long term"
faq:
  - q: "Is 3D printed PLA safe for a reef tank?"
    a: "For most practical purposes, yes — PLA (polylactic acid) is a biodegradable, plant-derived plastic that's chemically inert once printed, and reefers have used 3D printed PLA parts (frag racks, mounts, brackets) in tanks without issues affecting water chemistry or livestock. The bigger consideration isn't toxicity, it's durability — PLA isn't intended for indefinite submersion and will degrade over time."
  - q: "How long does PLA last underwater in saltwater?"
    a: "It varies by water temperature and the specific part's thickness, but PLA is prone to hydrolysis — a slow breakdown reaction with water that's accelerated by warmth, which describes most reef tanks running at 75-80°F. Expect PLA parts to remain structurally sound for months, but to gradually become more brittle over time, eventually cracking or failing under load. It's not a 'dissolves overnight' material, but it's also not a 'permanent' one."
  - q: "What's a better alternative to PLA for reef tank parts?"
    a: "PETG is the most commonly recommended alternative for parts that need to stay submerged long-term. It prints with similar ease to PLA on most consumer 3D printers, but has significantly better water and heat resistance, making it a better choice for frag racks, mounts, or any part where you don't want to plan on periodic replacement. ABS is another water-resistant option but is harder to print well and less commonly recommended for beginners."
  - q: "Do 3D printed parts need to be cleaned before going in a tank?"
    a: "Yes — rinse printed parts thoroughly with fresh water to remove any dust, oils from handling, or loose printing residue before submerging them. There's no special 'curing' process needed for PLA or PETG the way there is for some resins (some 3D-printed resin parts require UV curing and careful material selection due to resin toxicity before contact with livestock) — but a basic rinse and a visual check for any loose particles is good practice for any printed part."
related: ["super-glue-reef-tank", "sponges-reef-tank", "raise-alkalinity-reef-tank", "specific-gravity-reef-tank", "acceptable-tds-reef-tank"]
sources:
  - label: "DIY Projects Forum — Reef2Reef"
    url: "https://www.reef2reef.com/forums/diy-projects.45/"
  - label: "DIY Aquascaping & Equipment — Reef Builders"
...
6. **Plan for replacement, not permanence, with PLA.** Treat PLA parts in your [reef tank](/saltwater/) as consumables on a multi-month timeline rather than a one-time install, and you'll avoid the surprise of a rack failing and dumping frags into the sump.
