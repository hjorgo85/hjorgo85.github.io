---
title: "Blue Hippo Tang (Paracanthurus hepatus) Care Guide: Tank Size, Diet & Tank Mates"
description: "Care guide for the blue hippo tang / Pacific blue tang (Paracanthurus hepatus), the real-life 'Dory' fish: tank size, water parameters, diet, and why it's not the beginner fish its fame suggests."
...
imageWidth: 1200
imageHeight: 800
excerpt: "The fish that launched a thousand impulse purchases after Finding Nemo — here's what the blue hippo tang actually needs, and why its real-world care requirements surprise a lot of new owners."
tags: ["tang", "saltwater", "reef safe", "large fish"]
quickFacts:
  - label: "Scientific Name"
    value: "Paracanthurus hepatus"
  - label: "Care Level"
    value: "Moderate to difficult — large adult size and notable stress sensitivity"
  - label: "Minimum Tank Size"
    value: "100 gallons (380 L)"
  - label: "Temperament"
    value: "Generally peaceful, but can be aggressive toward other tangs or similarly shaped fish"
  - label: "Diet"
    value: "Omnivore — heavy on marine algae/nori, plus meaty foods"
  - label: "Reef Safe"
    value: "Yes"
  - label: "Max Size"
    value: "Up to 12 inches (30 cm)"
  - label: "Lifespan"
    value: "8-20 years in captivity with good care"
faq:
  - q: "Is the blue tang from Finding Nemo hard to keep?"
    a: "Harder than its movie fame suggests, yes. The blue hippo tang (Paracanthurus hepatus) — the real-life basis for 'Dory' — is reef safe and not difficult to feed, but it gets large (up to 12 inches), is an extremely active swimmer that needs serious tank space, and is notably prone to stress-related illness, especially marine ich, when kept in undersized tanks. It's a fish that's easy to buy as a small juvenile and genuinely difficult to provide for long-term."
  - q: "How big of a tank does a blue hippo tang need?"
    a: "A minimum of 100 gallons (380 liters), and that's a starting point, not a generous allowance — this species reaches up to 12 inches and is constantly active, cruising long distances in the wild. Many experienced keepers consider 125+ gallons a more realistic minimum for a single adult to do well long-term, especially if it will share the tank with other large, active fish."
  - q: "Can I keep more than one blue hippo tang together?"
...
sources:
  ...
  - label: "Tang Care & Tang Stress Syndrome — Reef2Reef"
...
Blue tangs aren't unusually demanding about water chemistry compared to other reef fish — the bigger factor by far is **tank size and stress level**. That said, in a large reef system, holding [specific gravity](/specific-gravity-reef-tank/) and alkalinity stable matters for the corals sharing the tank with a fish this size, since a 100+ gallon reef setup is almost always a mixed system with significant coral stocking.
...
- Clownfish, including the [common clownfish](/common-clownfish/), which occupy a completely different niche and rarely draw a tang's attention
- Damselfish, cardinalfish, gobies, blennies, and most wrasses
- Other large, robust reef fish that aren't shaped like tangs/surgeonfish — large angelfish, and reef-safe triggers like the [Niger triggerfish](/niger-triggerfish-reef-safe/), assuming the tank is large enough for both species' adult sizes
...
The throughline across all of these is the same: **tank size, diet, and low-stress conditions aren't "nice to haves" for this species — they're the difference between a fish that thrives for a decade or more and one that cycles through repeated illness.** If you're assembling a [beginner saltwater stocking list](/saltwater-aquarium-fish-for-beginners/), this is a fish to plan for later, once your system has grown into the size this species actually needs.
