---
title: "How to Raise Alkalinity in a Reef Tank Safely"
description: "The ideal alkalinity range for a reef tank, why it drops over time, the safe rate to raise it, and the methods (baking soda, two-part dosing, kalkwasser) that work without shocking corals."
slug: "raise-alkalinity-reef-tank"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Alkalinity should sit between 8-12 dKH and should never move more than about 1-2 dKH in a day — here's how to raise it correctly with baking soda, two-part dosing, or kalkwasser."
tags: ["saltwater", "reef tank", "water chemistry", "alkalinity", "aquarium maintenance"]
quickFacts:
  - label: "Ideal Alkalinity Range"
    value: "8-12 dKH (SPS-focused tanks often run 7-9 dKH)"
  - label: "What Alkalinity Measures"
    value: "The water's carbonate/bicarbonate buffering capacity"
  - label: "Safe Rate of Increase"
    value: "No more than about 1-2 dKH per day"
  - label: "Common Cause of Drop"
    value: "Coral and coralline algae calcification consuming carbonate from the water"
  - label: "Methods to Raise It"
    value: "Baking soda (sodium bicarbonate), two-part dosing, kalkwasser"
  - label: "Related Parameters"
    value: "Calcium and magnesium — the 'Big Three' reef parameters"
  - label: "Symptoms of Low Alkalinity"
    value: "Coral tissue recession, slowed growth, brittle or receding coralline algae"
  - label: "Measurement Tool"
    value: "Titration-based alkalinity test kit, checked 2-3x weekly"
faq:
  - q: "What is the ideal alkalinity for a reef tank?"
...
sources:
  ...
  - label: "Alkalinity Buffers & Two-Part Dosing — Bulk Reef Supply"
...
Alkalinity also interacts with the source water you use for mixing and top-off — water carrying contaminants or inconsistent mineral content (see our guide on [acceptable TDS for reef tank source water](/acceptable-tds-reef-tank/)) makes it harder to get consistent, repeatable test readings, which in turn makes it harder to dial in a stable dosing routine.
...
As with most reef chemistry, the goal of [a stable saltwater system](/saltwater/) is consistency over perfection — a tank holding steady at 8 dKH week after week will outperform one that bounces between 7 and 12 chasing an "ideal" number.
