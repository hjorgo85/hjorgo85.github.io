---
title: "Is Super Glue Reef Safe? Using Cyanoacrylate for Frags and Aquascaping"
description: "Cyanoacrylate (super glue) is the standard tool for attaching coral frags and securing rockwork — here's why it's reef safe, which type to buy, and how to use it underwater."
slug: "super-glue-reef-tank"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Cyanoacrylate super glue is the everyday tool reefers reach for to mount frags and stabilize rock — it's reef safe once cured, but not every glue on the shelf qualifies."
tags: ["saltwater", "reef tank", "frags", "aquascaping", "DIY"]
quickFacts:
  - label: "Is Super Glue Reef Safe?"
    value: "Yes — cyanoacrylate (CA) glue, once cured, is widely used and considered reef safe"
  - label: "Recommended Type"
    value: "Gel/thick cyanoacrylate marketed for aquarium or hobby use"
  - label: "How It Cures"
    value: "Reacts with moisture/humidity in the water — cures within seconds underwater"
  - label: "Typical Cure Time Underwater"
    value: "10-30 seconds for an initial secure bond; fully cured within minutes"
  - label: "What to Avoid"
    value: "Glues with added dyes, accelerants, or non-CA additives not labeled aquarium safe"
  - label: "Common Uses"
    value: "Attaching coral frags to plugs/rock, securing rockwork, minor equipment repairs"
  - label: "Safety Precaution"
    value: "Avoid skin and eye contact — CA bonds almost instantly to skin"
  - label: "Accelerator Sprays"
    value: "Optional — speed up curing in tricky spots, but plain CA cures fine underwater alone"
faq:
  - q: "Is super glue safe to use in a reef tank?"
    a: "Yes — cyanoacrylate (CA) glue, the active ingredient in standard 'super glue,' is considered reef safe once cured and is the standard tool reef keepers use to attach coral frags and stabilize rockwork. The key is using plain cyanoacrylate without added dyes, fillers, or other chemical additives — many hobby and aquarium-specific super glues are simply CA formulated as a thicker gel for easier underwater application."
  - q: "What kind of super glue should I use for coral frags?"
    a: "Look for a **gel or thick-bodied cyanoacrylate**, often sold specifically as 'coral glue' or 'aquarium-safe super glue.' The gel consistency matters because it stays in place on a frag plug or rock surface underwater rather than running off before it cures, which is the main practical difference from a thin, runny hardware-store super glue."
  - q: "How long does super glue take to cure underwater?"
...
sources:
  ...
  - label: "Coral Propagation Forum — Reef2Reef"
...
Once you're set up with a reliable gel CA glue, frag attachment and minor aquascaping adjustments become a routine, low-stakes part of maintaining a [reef tank](/saltwater/) — one of the few jobs in the hobby that's genuinely as simple as the forum advice makes it sound.
