---
title: "Potting Soil in Aquariums: The 'Dirted Tank' Method Explained"
description: "Plain organic potting soil, capped with sand or gravel, is the basis of the low-tech 'dirted tank' approach to planted aquariums — here's how it works and what to watch for."
slug: "potting-soil-aquariums"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Capping plain organic potting soil with sand or gravel creates a nutrient-rich substrate that can support heavily planted, low-tech tanks — with a messier setup process than inert substrates."
tags: ["dirted tank", "walstad method", "substrate", "planted tank", "aquascaping"]
quickFacts:
  - label: "What It Is"
    value: "Using ordinary organic potting soil as a nutrient-rich base layer, capped with sand or fine gravel"
  - label: "Best For"
    value: "Low-tech, heavily planted ('Walstad method') tanks where soil nutrients reduce or replace separate fertilizing"
  - label: "Soil Selection"
    value: "Plain organic potting soil without added time-release fertilizers, perlite, vermiculite, or wetting agents"
  - label: "Cap Layer"
    value: "A sand or fine gravel cap (commonly around 1-2 inches) keeps soil from clouding the water and floating"
  - label: "Initial 'Dirt Cloud' Period"
    value: "New dirted tanks often go through a cloudy, nutrient-rich settling period in the first days to weeks"
  - label: "Ammonia Considerations"
    value: "Breaking down organic matter can contribute to elevated ammonia early on — fishless cycling is generally recommended"
  - label: "Floating Debris"
    value: "Perlite, vermiculite, and undecomposed organic bits can float to the surface if present in the soil"
  - label: "Bottom Line"
    value: "A low-cost, nutrient-dense substrate option with a messier and more variable setup process than inert substrates"
faq:
  - q: "What is the 'dirted tank' or Walstad method, and why use potting soil?"
    a: "**The 'dirted tank' approach — popularized by Diana Walstad's writing on low-tech planted aquariums — uses a layer of ordinary organic soil as the substrate's base, capped with sand or gravel, instead of an inert substrate or a commercial aquatic soil product.** The appeal is **nutrient density at low cost**: garden soil contains organic matter and nutrients that plants can draw on directly through their roots, which can reduce or eliminate the need for separate root tabs or liquid fertilizers in a heavily planted, low-tech (often low-light, no-CO2-injection) setup. It's essentially using a cheap, widely available material to get some of the benefits of a [nutrient-rich aquatic substrate](/plant-substrate-for-aquariums/) — with more variability and a messier setup process in exchange for the lower cost."
  - q: "What kind of potting soil should I use — and what should I avoid?"
...
Commercial aquatic plant substrates exist precisely because plants need nutrients in the substrate, not just the water column — our [guide to plant substrate](/plant-substrate-for-aquariums/) covers that case generally. Garden soil contains many of the same nutrients (organic matter, trace minerals) that aquatic substrates are formulated to provide, at a fraction of the cost per gallon. For a **low-tech, heavily planted tank** — often run without CO2 injection and with moderate lighting — this nutrient base can be enough to support strong plant growth with minimal additional fertilizing.
