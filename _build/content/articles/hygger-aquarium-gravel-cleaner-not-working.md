---
title: "Hygger Aquarium Gravel Cleaner Not Working: How to Fix It"
description: "When a Hygger battery gravel cleaner won't turn on, won't draw water, or leaks back through the tube, the cause is usually one of a few specific, fixable issues."
slug: "hygger-aquarium-gravel-cleaner-not-working"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A Hygger gravel cleaner that won't start, won't pull water, or leaks back through the tube usually comes down to batteries, a clogged intake, or how it's being held in the water."
tags: ["gravel cleaner", "aquarium maintenance", "Hygger", "equipment troubleshooting", "equipment"]
quickFacts:
  - label: "First Check"
    value: "Battery freshness and orientation — battery-powered gravel cleaners are sensitive to even slightly weak batteries"
  - label: "Motor Runs, No Suction"
    value: "Usually a clogged intake strainer, debris jammed in the impeller, or a kinked discharge tube"
  - label: "Won't Start at All"
    value: "Check battery contacts for corrosion — these sit close to water and are prone to buildup over time"
  - label: "Leaking Back Through the Tube"
    value: "Often means the unit isn't fully submerged at the intake, breaking the siphon/suction it relies on"
  - label: "Reduced Power Over Time"
    value: "Batteries weaken gradually — a unit that 'used to be stronger' is often just due for fresh batteries"
  - label: "Intake Strainer"
    value: "Gravel and debris can pack into the strainer slots, restricting flow even with a working motor"
  - label: "Discharge Tube"
    value: "Kinks or a tube that's lifted above water level can stop flow even when the unit itself is working"
  - label: "Not a Sand-Safe Tool by Default"
    value: "Running it too close to fine substrate can pull large amounts of sand into the discharge — technique matters as much as the unit"
faq:
  - q: "My Hygger gravel cleaner won't turn on at all — what should I check first?"
...
If you're also dealing with filter issues that started around the same time as a water change or gravel cleaning session, our guide on [filters not working after cleaning](/aquarium-filter-not-working-after-cleaning/) covers that separately — the two are easy to mix up since they often happen during the same maintenance session.
