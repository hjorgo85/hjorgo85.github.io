---
title: "Niger Triggerfish (Odonus niger): Care, Tank Size & Is It Reef Safe?"
description: "Complete care guide for the Niger triggerfish (Odonus niger): tank size, water parameters, diet, and an honest look at its reputation as a 'reef safe' trigger."
slug: "niger-triggerfish-reef-safe"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Most triggerfish will demolish a reef tank — the Niger triggerfish is the well-known exception, but 'reef safe' here comes with real caveats for inverts and tankmates."
tags: ["triggerfish", "saltwater", "reef safe", "large fish"]
quickFacts:
  - label: "Scientific Name"
    value: "Odonus niger"
  - label: "Care Level"
    value: "Moderate — easy to feed, but needs a serious long-term tank commitment"
  - label: "Minimum Tank Size"
    value: "125 gallons (470 L)"
  - label: "Temperament"
    value: "One of the most peaceful triggers, but increasingly territorial with age"
  - label: "Diet"
    value: "Primarily planktivore (zooplankton) — unusual for a triggerfish"
  - label: "Reef Safe"
    value: "Corals: yes — Inverts/cleanup crew: no"
  - label: "Max Size"
    value: "~12 inches (30 cm)"
  - label: "Lifespan"
    value: "15-20 years in captivity with good care"
faq:
  - q: "Is the Niger triggerfish a pufferfish?"
    a: "No. The Niger triggerfish (Odonus niger) is a true triggerfish, family Balistidae — taxonomically unrelated to pufferfish (family Tetraodontidae), though the two groups are often discussed together in casual hobby conversation because they're both large, characterful, semi-aggressive fish from similar reef habitats. Triggerfish have a distinctive locking dorsal spine ('trigger') and powerful jaws built for crushing, while pufferfish inflate and lack that spine entirely."
  - q: "Will a Niger triggerfish eat my cleanup crew?"
    a: "Almost certainly, given time. Snails, hermit crabs, small crabs, and shrimp (including ornamental shrimp like cleaner shrimp) are all realistic targets for a Niger triggerfish, especially as it grows. While it's far less destructive to corals than most triggers, it has not lost the predatory instinct toward small, slow-moving invertebrates — don't expect a cleanup crew to survive long-term in the same tank."
  - q: "Why is the Niger triggerfish considered reef safe when other triggers aren't?"
    a: "Most triggerfish (Balistidae) have powerful jaws adapted for crushing hard-shelled prey like crabs, urchins, clams, and snails, and they'll happily sample coral polyps along the way, often destroying a reef tank's coral population. Odonus niger is unusual within the family because it's primarily planktivorous in the wild, picking zooplankton out of the water column rather than crushing reef structures. That feeding strategy translates to a fish that generally leaves coral colonies alone — hence 'reef safe' for corals specifically — even though it's still a predator toward smaller invertebrates."
  - q: "How big does a Niger triggerfish get and how much space does it need?"
    a: "Niger triggerfish reach about 12 inches (30 cm) in length and are active, constantly cruising swimmers in the wild. A single adult needs a minimum of 125 gallons, with more being better if it's housed with other large tankmates. Undersized tanks are a common cause of stress-related aggression and stunted, unhealthy growth in this species."
related: ["pufferfish-care", "is-valentini-puffer-reef-safe", "flame-angelfish", "yellowtail-damselfish", "common-clownfish"]
sources:
  - label: "Odonus niger — FishBase"
    url: "https://www.fishbase.se/summary/Odonus-niger.html"
  - label: "Niger Triggerfish Care and Reef Compatibility Discussion — Reef2Reef"
    url: "https://www.reef2reef.com/forums/saltwater-fish.124/"
---

The Niger triggerfish (*Odonus niger*) has an odd reputation in the hobby: it's a triggerfish that people actually recommend for reef tanks, in a family of fish that's famous for doing the opposite. Also sold as the blue triggerfish or red-tooth triggerfish — the second name comes from a small red mark at the base of its teeth, visible when it opens its mouth — it's often lumped into the same conversations as large pufferfish because both groups show up in "big, characterful, slightly scary" stocking discussions. But *Odonus niger* is a true triggerfish, family Balistidae, with no closer taxonomic relationship to pufferfish (family Tetraodontidae) than any other two reef fish families. If you're researching both groups at once, our [pufferfish care guide](/pufferfish-care/) covers that separate family in detail. This guide covers what the Niger triggerfish actually needs, and gives an honest answer to the question every prospective owner asks: is it really reef safe?
...
**Corals: generally safe.** Because *Odonus niger* feeds on zooplankton rather than crushing reef structure, it largely leaves coral colonies — LPS, SPS, and soft corals alike — alone. This is the core reason it has the reputation it does, and it's a genuinely unusual trait within Balistidae. Most reefers who keep Niger triggers report no coral damage, which puts this species in a similar "safe with caveats" bracket to fish like the [flame angelfish](/flame-angelfish/) — both are commonly kept in reef tanks with corals present, but for different reasons and with different specific risks.
...
- [ ] Confirm your [saltwater](/saltwater/) system's filtration and stocking plan can support a large, long-lived fish before committing
