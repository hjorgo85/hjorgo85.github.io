---
title: "What Is the Cotton Wool in My Aquarium Filter (And Should I Replace It With Real Cotton)?"
description: "The white fluffy material in most aquarium filters isn't actually cotton — and using real cotton wool as a substitute comes with risks worth knowing about."
slug: "cotton-wool-in-my-aquarium-filter"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "That white fluffy material in your filter is almost always polyester filter floss, not actual cotton — and the difference matters if you're considering a DIY substitute."
tags: ["aquarium filter", "filter media", "filter floss", "mechanical filtration", "equipment"]
quickFacts:
  - label: "What It Usually Is"
    value: "Polyester filter floss/wool — a synthetic mechanical filtration media, not actual cotton"
  - label: "Function"
    value: "Traps fine suspended particles as water passes through, polishing the water"
  - label: "Why Not Real Cotton"
    value: "Cotton degrades and breaks down in water over time, unlike polyester floss"
  - label: "Cosmetic Cotton Balls/Pads"
    value: "May contain bleaches, fragrances, or other additives not meant for aquarium water"
  - label: "Aquarium-Rated Floss"
    value: "Sold in bulk bags specifically for filter use — inexpensive and widely available"
  - label: "Maintenance"
    value: "Rinse regularly, replace when it becomes compacted, discolored beyond rinsing, or starts breaking apart"
  - label: "Placement"
    value: "Typically the last stage before water returns to the tank, polishing water after biological/chemical media"
  - label: "Color Change Is Normal"
    value: "Floss turning brown/gray over time reflects normal mechanical filtration — it's doing its job"
faq:
  - q: "Is the white fluffy stuff in my aquarium filter actually cotton?"
    a: "**Almost certainly not — it's typically polyester filter floss (also called filter wool), a synthetic fiber media designed specifically for mechanical filtration.** It looks similar to cotton wool at a glance — white, soft, fibrous — which is probably where the common name comes from, but the material itself is different. Polyester floss is chosen for aquarium filters specifically because it **doesn't break down or degrade in water** the way natural fibers like cotton do, holding its structure through repeated rinsing and use. If your filter came with this media pre-installed, it's this polyester floss, not cotton, regardless of what it's sometimes informally called."
  - q: "Can I use real cotton balls or cotton wool as filter media if I run out?"
    a: "**It's not recommended, for a couple of reasons.** First, **natural cotton fibers break down in water over time** — unlike polyester floss, which is designed to hold up to repeated soaking, cotton can start disintegrating, potentially releasing fibers into the tank or clogging in ways that are harder to rinse clean. Second, and more importantly, **cosmetic cotton balls and pads often contain additives** — bleaching agents, fragrances, or other chemicals used in their manufacturing for cosmetic/medical use — that aren't intended to end up in aquarium water and haven't been tested for aquarium safety. If you're out of filter floss in a pinch, a clean, unused synthetic sponge or even a piece of clean pantyhose/mesh stretched over the intake (a common temporary DIY fix discussed in fishkeeping communities) is a safer short-term substitute than cosmetic cotton products."
  - q: "How do I know when to rinse versus replace filter floss?"
    a: "**Rinse it regularly as part of normal maintenance — replace it when it's compacted, falling apart, or no longer rinsing back to a reasonably clean state.** This follows the same general logic covered in our guide on [how often to change filter media](/how-often-should-you-change-a-fish-tank-filter/): mechanical media like floss is rinsed often (commonly every one to two weeks, depending on bioload) and replaced less often, only once it's physically degraded rather than just discolored. A floss pad that's turned brown or gray but still holds its shape and rinses out reasonably well is still doing its job — the color change reflects the particles it's trapping, which is the whole point of mechanical filtration."
  - q: "Where does filter floss go in a filter, and does placement matter?"
    a: "**Floss is typically positioned as one of the later stages water passes through, often described as 'polishing' the water before it returns to the tank** — after biological media (where the bacteria live — see our [Fluval BioMax vs. Seachem Matrix comparison](/fluval-biomax-vs-seachem-matrix/) for how different biological media types compare) and any chemical media (like carbon), if the filter has multiple stages. This ordering isn't usually something you need to change on a typical filter, since most multi-stage filters are designed with a specific flow path through their media compartments. If you're noticing the floss clogging unusually fast, that's often more related to **overall bioload or intake placement** — covered in our guides on [filter media replacement frequency](/how-often-should-you-change-a-fish-tank-filter/) and [intake/outlet placement](/canister-filter-inlet-outlet-placement/) — than to where the floss specifically sits within the filter."
related: ["how-often-should-you-change-a-fish-tank-filter", "aquarium-filter-not-working-after-cleaning", "can-a-filter-be-too-big-for-a-fish-tank", "how-deep-should-my-aquarium-filter-intake-be", "aquarium-sand-filter-problems", "canister-filter-inlet-outlet-placement"]
sources:
  - label: "Filter Media Types and Materials — Practical Fishkeeping"
    url: "https://www.practicalfishkeeping.co.uk/"
  - label: "Mechanical Filtration Media Discussion — Reef2Reef New to the Hobby"
...
Filter floss follows the same general mechanical-media pattern covered in our guide on [how often to change filter media](/how-often-should-you-change-a-fish-tank-filter/):
