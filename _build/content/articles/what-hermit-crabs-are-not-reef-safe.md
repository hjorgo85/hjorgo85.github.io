---
title: "Which Hermit Crabs Aren't Reef-Safe? Species and Real Risks to Know"
description: "Most small 'dwarf' hermit crabs sold for reef tanks are fine, but larger or unidentified species can become opportunistic shell-stealers and occasional coral-pickers. Here's what to watch for."
slug: "what-hermit-crabs-are-not-reef-safe"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Hermit crab reef-safety mostly comes down to size and identification. The small dwarf species sold individually are usually fine — the risk is bulk 'assorted' mixes and shell-stealing as crabs outgrow their homes."
tags: ["hermit crab", "reef safe", "cleanup crew", "reef tank", "invertebrates"]
quickFacts:
  - label: "Generally Reef-Safe Species"
    value: "Blue leg hermit crab (Clibanarius tricolor), scarlet/red reef hermit crab (Paguristes cadenati), red leg hermit crab"
  - label: "Main Risk Category"
    value: "Larger or unidentified species sold in bulk 'assorted' cleanup crew mixes"
  - label: "Most Common Real Issue"
    value: "Shell predation — hermit crabs killing snails to take over their shells when they outgrow their own"
  - label: "Size Matters"
    value: "Small 'dwarf' species pose far less risk to corals and tank mates than larger species"
  - label: "Coral Risk"
    value: "Direct coral predation is less common than shell-related snail predation, but some larger species may pick at polyps"
  - label: "Prevention"
    value: "Keep a supply of appropriately-sized empty shells so crabs don't need to evict snails"
  - label: "Behavior to Watch"
    value: "Aggressive shell-swapping, harassment of snails, or picking at coral polyps"
  - label: "Land Hermit Crabs"
    value: "A completely different, terrestrial group — not relevant to marine reef tanks at all"
faq:
  - q: "Which hermit crab species are generally considered reef safe?"
    a: "The small **'dwarf' hermit crab species** most commonly sold individually for reef tanks — particularly the **blue leg hermit crab (Clibanarius tricolor)**, **scarlet/red reef hermit crab (Paguristes cadenati)**, and various **red leg hermit crabs** — have long track records as reasonably reef-safe cleanup crew, valued for eating algae and detritus. These species stay relatively small, which limits the practical damage they can do even if they occasionally engage in shell-related behavior. The bigger uncertainty tends to come from **bulk 'assorted hermit crab' packages** sold by some retailers, where the exact species mix isn't always clearly identified — these can sometimes include larger or more opportunistic species than the well-known dwarf staples."
  - q: "Why do hermit crabs kill snails in reef tanks?"
    a: "This is almost always about **shells, not food**. Hermit crabs don't grow their own shell — they occupy empty gastropod shells and must periodically **move to a larger shell** as they grow (a different process from [molting](/how-often-do-emerald-crabs-molt/), which sheds the crab's own exoskeleton underneath). If a hermit crab outgrows its current shell and **no suitable empty shells are available** in the tank, it may resort to attacking a living snail to evict it from its shell — not primarily to eat the snail, though the snail typically doesn't survive the encounter. This is the **single most commonly reported 'hermit crab problem'** in reef tanks, and it's largely preventable: keeping a small stock of appropriately-sized empty shells gives growing hermit crabs an alternative to evicting your [Nassarius snails](/nassarius-snail-eggs/) or other cleanup crew snails."
  - q: "Can hermit crabs eat coral?"
...
sources:
  ...
  - label: "Hermit Crab Behavior in Reef Tanks — Reef Builders"
...
The practical fix is straightforward: **keep a small stock of empty, appropriately-sized snail shells** in the tank (available from many of the same sources that sell hermit crabs), giving growing crabs an alternative to evicting your [Nassarius snails](/nassarius-snail-eggs/) or other cleanup crew snails.
