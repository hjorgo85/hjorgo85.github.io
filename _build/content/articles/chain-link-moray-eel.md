---
title: "Chain Link Moray Eel (Echidna catenata) Care Guide: Tank Size, Diet & Reef Compatibility"
description: "Care guide for the chain link moray eel (Echidna catenata): one of the smaller, more manageable moray species, including tank size, diet, escape-proofing, and reef tank caveats."
slug: "chain-link-moray-eel"
type: "article"
category: "saltwater"
...
image: "/assets/img/articles/chain-link-moray-eel.webp"
imageAlt: "Chain link moray eel (Echidna catenata) with chain-like brown and cream pattern peeking out of live rock"
imageWidth: 1200
imageHeight: 800
excerpt: "The chain link moray is one of the more approachable morays in the hobby — smaller, often active during the day, and a dedicated crustacean hunter. Here's what it actually needs, and why a secure lid is non-negotiable."
tags: ["moray eel", "saltwater", "reef tank", "predatory fish"]
quickFacts:
  - label: "Scientific Name"
    value: "Echidna catenata"
  - label: "Care Level"
    value: "Moderate — easier than most morays, but escape-prone"
  - label: "Minimum Tank Size"
    value: "30-55 gallons (115-210 L)"
  - label: "Temperament"
    value: "Relatively peaceful toward fish; aggressive predator of crustaceans"
  - label: "Diet"
    value: "Carnivore — crab and shrimp specialist"
  - label: "Reef Safe"
    value: "With caution — safe for corals, not for ornamental crustaceans"
  - label: "Max Size"
    value: "Up to 24 inches (60 cm)"
  - label: "Lifespan"
    value: "10-15+ years in captivity"
faq:
  - q: "How big of a tank does a chain link moray eel need?"
    a: "A minimum of 30-55 gallons for a single chain link moray, which is notably smaller than the 100+ gallons many other moray species need. This species tops out around 24 inches, making it one of the more realistically housed morays for a dedicated predator tank — though as with any moray, more swimming and hiding space is always better, and a tank on the larger end of that range gives more long-term flexibility."
  - q: "Is the chain link moray reef safe?"
    a: "It's reef safe toward corals — chain link morays don't eat or damage coral tissue, and can be kept in a reef tank from that angle. However, they are dedicated crustacean hunters and will eat ornamental shrimp, hermit crabs, and most cleanup crew invertebrates over time. If your reef tank's cleanup crew or display invertebrates matter to you, factor that in the same way you would for the [Niger triggerfish](/niger-triggerfish-reef-safe/) — coral-safe doesn't mean invertebrate-safe."
  - q: "Can a chain link moray eel escape its tank?"
    a: "Yes, and this is one of the most important practical considerations for keeping any moray, including this species. Morays are powerful, flexible, and surprisingly capable of pushing through small gaps in lids, around overflow boxes, or through unsealed openings for equipment cords. A tight-fitting lid with no meaningful gaps — checked and re-checked after any equipment changes — is considered non-negotiable by experienced moray keepers, not an optional precaution."
  - q: "What do chain link morays eat?"
    a: "In the wild, Echidna catenata specializes in crabs and other crustaceans, using a strong sense of smell to hunt in and around rocky crevices — including, somewhat unusually for a moray, sometimes hunting in shallow water or tide pools where it can be briefly out of water. In the aquarium, a diet of pieces of raw shrimp, crab, squid, and silversides — offered on a feeding stick or tongs to avoid hand contact — covers its nutritional needs well."
related: ["bluestreak-cleaner-wrasse-labroides-dimidiatrus", "best-fish-for-reef-tank", "niger-triggerfish-reef-safe", "saltwater-aquarium-fish-for-beginners", "water-cow-goby-fish"]
sources:
  - label: "Echidna catenata — FishBase"
    url: "https://www.fishbase.se/summary/Echidna-catenata.html"
  - label: "Moray Eel Care & Compatibility — Reef2Reef"
...
- Larger, robust fish that won't be viewed as food — large angelfish, tangs like the [blue hippo tang](/blue-hippo-tang/) (assuming the tank is large enough for both), and reef-safe triggers
