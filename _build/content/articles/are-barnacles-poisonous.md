---
title: "Are Barnacles Poisonous? What Happens If You Touch or Eat One"
description: "Barnacles aren't poisonous or venomous — the real risks are sharp shells causing cuts, and the fact that they're filter feeders that can accumulate whatever's in the water around them."
slug: "are-barnacles-poisonous"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Barnacles have no venom and aren't toxic to touch — but their sharp shells can cause cuts, and as filter feeders, what they've absorbed from the water is a separate consideration for eating them."
tags: ["marine biology", "fish facts", "crustaceans", "barnacles", "tide pools"]
quickFacts:
  - label: "Venomous?"
    value: "No — barnacles have no venom or sting of any kind"
  - label: "Toxic To Touch?"
    value: "No — but their shells are sharp-edged and can cause cuts, sometimes called 'barnacle rash'"
  - label: "What Are They?"
    value: "Crustaceans (related to crabs and shrimp), despite their immobile, shell-covered appearance"
  - label: "Are They Edible?"
    value: "Some species (notably gooseneck barnacles, eaten as 'percebes') are eaten in some cuisines"
  - label: "Filter Feeders"
    value: "Barnacles feed by filtering plankton from passing water using feathery appendages"
  - label: "Accumulation Consideration"
    value: "As filter feeders in polluted water, barnacles can accumulate contaminants — a food-safety issue, not a venom issue"
  - label: "Common Injury"
    value: "Scrapes from barnacle-covered rocks or boat hulls are a frequent minor injury at beaches and docks"
  - label: "Infection Risk"
    value: "Like any cut from a marine surface, barnacle cuts can become infected and should be cleaned promptly"
faq:
  - q: "Can touching a barnacle hurt you?"
    a: "Not through any venom or toxin — barnacles have **no stinging or venomous apparatus** of any kind, unlike some other marine animals (jellyfish, certain anemones) that people sometimes lump together as 'things in the ocean that hurt you.' The actual risk from touching barnacles is purely **mechanical**: their shells have sharp, often jagged edges, and brushing against a barnacle-covered rock, piling, or boat hull is a common way to get a scrape or cut at the beach. These cuts — sometimes informally called 'barnacle rash' or 'barnacle cuts' — aren't dangerous in themselves but, like any open wound from a marine environment, should be cleaned to reduce infection risk."
  - q: "Can you eat barnacles?"
    a: "Yes, in some cases — certain barnacle species, most notably **gooseneck barnacles**, are eaten in some coastal cuisines (known as *percebes* in Spanish and Portuguese cooking, among other names). They're harvested, cooked, and eaten similarly to other shellfish. The acorn barnacles most commonly seen crusted on rocks and pilings aren't typically harvested for food in the same way, partly due to their small size and the effort required relative to the amount of edible tissue. As with any wild-harvested shellfish, **where** the barnacles were living matters — filter feeders in polluted water can accumulate contaminants, which is a food-safety consideration separate from any inherent toxicity in the animal itself."
  - q: "Wait — barnacles are crustaceans? They don't look like crabs or shrimp at all."
    a: "It's a genuinely counterintuitive fact, but yes — barnacles are **crustaceans**, in the same broad group as crabs, shrimp, and lobsters. As adults, barnacles are sessile (permanently attached to a surface) and encased in calcareous plates, which makes them look more like a mollusk (similar to how a [conch's shell might suggest something it isn't](/is-conch-a-mollusk-or-crustacean/)) than a relative of a crab. But barnacle larvae are free-swimming and look much more recognizably crustacean-like, and adult barnacles retain crustacean features internally — feathery, jointed appendages (called cirri) that they extend from their shell to filter-feed, functionally similar to the limbs a more mobile crustacean would use to swim or walk. The permanently-attached, plated adult form is a major departure from the 'typical' crustacean body plan, which is exactly why the classification surprises people."
  - q: "Are barnacles harmful to the surfaces (boats, rocks, whales) they attach to?"
    a: "It depends on the surface and the degree of coverage. On **boat hulls**, heavy barnacle growth ('fouling') increases drag and fuel consumption, which is why antifouling paints exist — this is a maintenance and cost issue rather than a 'harm' issue in a biological sense. On **rocks and pilings**, barnacles are simply part of the natural intertidal community and aren't 'harming' anything in a meaningful sense. On **living animals** like whales, the relationship is more nuanced — covered in detail in our [guide to barnacles on whales](/what-are-barnacles-on-whales/), since this is a commonly asked follow-up question once people learn barnacles attach to living surfaces at all."
related: ["is-conch-a-mollusk-or-crustacean", "what-are-barnacles-on-whales", "red-feather-duster-worm", "aiptasia-or-feather-duster", "is-shrimp-a-fish-or-crustacean", "does-coral-dip-kill-aiptasia"]
sources:
  - label: "Barnacle Biology — FishBase Glossary"
...
- **Living animals** — the most commonly asked follow-up is about barnacles on whales specifically, which has its own nuances covered in our [guide to whale barnacles](/what-are-barnacles-on-whales/)
