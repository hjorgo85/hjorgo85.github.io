---
title: "Do Dragon Gobies Bury Themselves? Normal Behavior vs. Warning Signs"
description: "Dragon gobies spend much of their time partially or fully buried in sand — and that's normal. Here's why they do it, what substrate makes it safe, and when burrowing might signal a problem."
slug: "do-dragon-goby-bury-themselves"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "If your dragon goby spends most of the day buried with just its head showing, that's normal — not a sign something's wrong. Here's why they do it, and what substrate makes it safe."
tags: ["dragon goby", "violet goby", "brackish", "freshwater", "fish behavior"]
quickFacts:
  - label: "Do They Burrow?"
    value: "Yes — dragon gobies routinely bury themselves partially or fully in soft substrate"
  - label: "Why"
    value: "Natural behavior reflecting their estuarine habits, poor eyesight, and preference for a sense of security"
  - label: "Substrate Requirement"
    value: "Soft, fine sand, several inches deep — not gravel or coarse/sharp substrate"
  - label: "Normal vs. Concerning"
    value: "Occasional full burial with normal feeding/activity = normal; constant hiding with appetite loss or color change = investigate water quality"
  - label: "Time Spent Buried"
    value: "Can be many hours, especially during the day or shortly after introduction to a new tank"
  - label: "Wrong Substrate Risk"
    value: "Gravel or sharp sand can cause skin irritation during regular burrowing"
  - label: "Tank Design Implication"
    value: "Avoid heavy decor resting directly on sand that could shift or collapse if the goby burrows beneath it"
faq:
  - q: "Is it normal for my dragon goby to be buried all day?"
    a: "Yes — this is one of the most consistently reported behaviors for this species, and it's entirely normal. Dragon gobies (*Gobioides broussonnetii*) are adapted to estuarine and soft-sediment habitats where burrowing provides cover from predators and a sense of security, and they carry this behavior into aquarium settings, often spending **the majority of daylight hours** partially or fully buried with just the head, eyes, or dorsal fin visible. New arrivals in particular may bury themselves almost constantly for the first days to weeks as they acclimate to a new tank — this is a normal stress response to a new environment, not a sign that something is wrong with the tank itself, provided water parameters check out."
  - q: "What substrate do I need for a dragon goby to burrow safely?"
    a: "**Soft, fine sand** — the kind typically marketed for planted tanks or as 'pool filter sand' — is the standard recommendation, at a depth of **several inches** to allow comfortable, full burrowing. **Gravel, crushed coral, or coarse/sharp sand should be avoided**, since a fish that's regularly pushing its body into and through the substrate can suffer skin irritation or abrasion from rough material over time. This is a case where the substrate choice has a much bigger behavioral and welfare impact than it does for many other freshwater species — for most community fish, substrate is largely aesthetic, but for a dedicated burrower like the dragon goby, it's closer to essential equipment."
  - q: "Could burrowing be a sign of stress or illness instead of normal behavior?"
...
sources:
  ...
  - label: "Violet Goby Behavior & Substrate Needs — Practical Fishkeeping"
...
On its own, extensive burrowing — even near-constant burrowing for a newly introduced fish — is the **expected default** for this species, similar to how a [betta](/betta-fish-care-guide/) resting near the surface or a [banjo catfish](/how-to-care-for-asian-banjo-catfish/) staying buried during the day reflects normal species-typical behavior rather than a problem.
