---
title: "Why Is My Black Skirt Tetra Being Aggressive? (And How to Fix It)"
description: "Black skirt tetras have a reputation for fin-nipping and chasing — but the cause is usually group size, not the species being inherently mean. Here's what's going on and how to address it."
slug: "black-skirt-tetra-being-aggressive"
type: "article"
category: "freshwater"
...
imageAlt: "A group of black skirt tetras swimming together in a planted aquarium"
imageWidth: 1200
imageHeight: 800
excerpt: "Black skirt tetra aggression — chasing, fin-nipping — is most often a group-size problem, not a fixed personality trait. Here's why, and what tends to fix it."
tags: ["black skirt tetra", "freshwater", "tetra", "fish aggression"]
quickFacts:
  - label: "Species"
    value: "Gymnocorymbus ternetzi (black skirt tetra / black widow tetra)"
  - label: "Typical Cause of Aggression"
    value: "Insufficient group size — shoaling species redirect social pressure inward when the group is too small"
  - label: "Minimum Group Size"
    value: "6 or more — fewer often means more chasing/nipping within the group"
  - label: "Fin-Nipping Risk to Tank Mates"
    value: "Slow-moving, long-finned fish are most at risk"
  - label: "Minimum Tank Size"
    value: "20 gallons for a proper group, more for community setups"
  - label: "Water Parameters"
    value: "Adaptable — moderately soft to moderately hard, slightly acidic to neutral"
  - label: "Is Some Chasing Normal?"
    value: "Yes — mild pecking-order activity within an adequately-sized group is typical"
  - label: "Main Fix"
    value: "Increase group size to 6+ and review tank mates/space"
faq:
  - q: "Why is my black skirt tetra chasing and nipping other fish?"
    a: "The most common cause isn't that black skirt tetras (Gymnocorymbus ternetzi) are an inherently aggressive species — it's that **they're a shoaling species kept in too small a group**. Tetras in general establish social structure within their school, and when the school is too small (often fewer than 6), that social pressure has fewer outlets and can spill over into more persistent chasing and fin-nipping, both toward other black skirt tetras and toward other tank mates. This is a different mechanism from the territorial aggression discussed for [American flagfish](/are-american-flagfish-aggressive/), where the issue is more about defending space than redirected social pressure within a school."
  - q: "Is some chasing among black skirt tetras normal?"
    a: "Yes — a degree of chasing and minor fin-nipping within an adequately-sized group (6+) is generally considered normal shoaling/pecking-order behavior, and most fish in a healthy group recover from minor fin damage without lasting issues. The distinction worth paying attention to is between **occasional, low-intensity chasing that doesn't result in significant fin damage** (normal) versus **persistent, targeted aggression that leaves fins visibly tattered or causes a specific fish to hide constantly** (a sign the group dynamics or tank setup need adjustment)."
  - q: "What tank mates should I avoid with black skirt tetras?"
    a: "**Slow-moving, long-finned fish** are the main category to be cautious with, since they're the most vulnerable to fin-nipping from an active, schooling tetra. This includes long-finned livebearer varieties — for example, the long-finned [split-tail guppy](/split-tail-guppy/) or fancy [sailfin molly](/sailfin-molly/) varieties — and slow, showy fish generally. This isn't an absolute rule (a well-sized black skirt tetra group in a spacious, well-planted tank is less likely to bother tank mates than an undersized, stressed group), but it's a sensible default when choosing additional fish for a black skirt tetra tank."
  - q: "How do I reduce aggression in my black skirt tetra tank?"
    a: "**Increase the group size to 6 or more** first — this is the single most impactful change for most cases, since it redistributes social pressure across more individuals rather than concentrating it on a few. Beyond that: ensure adequate tank size and swimming space (a cramped tank amplifies social friction, similar to how crowding is discussed as an aggression trigger for [American flagfish](/are-american-flagfish-aggressive/)), add plants or decor to break sightlines and create visual breaks within the school, and reconsider tank mates if a specific fish (especially a long-finned one) is being repeatedly targeted."
related: ["neon-tetra-fungus", "are-american-flagfish-aggressive", "endlers-5-gallon-tank", "split-tail-guppy", "dwarf-gouramis"]
sources:
  - label: "Gymnocorymbus ternetzi — FishBase"
    url: "https://www.fishbase.se/summary/Gymnocorymbus-ternetzi.html"
  - label: "Tetra Shoaling Behavior & Compatibility — Practical Fishkeeping"
...
This is a different mechanism from the aggression discussed in our [American flagfish guide](/are-american-flagfish-aggressive/), where the primary driver is territorial defense of space rather than redirected social pressure within a school — but both cases share a common thread: **the underlying social or spatial need isn't being met**, and the aggression is a symptom of that rather than a fixed trait of the individual fish.
...
- **Long fins** — slower-swimming, long-finned fish present an easy, slow-moving target for nipping. This includes long-finned livebearer varieties like the [split-tail guppy](/split-tail-guppy/) or ornate [sailfin molly](/sailfin-molly/) types.
