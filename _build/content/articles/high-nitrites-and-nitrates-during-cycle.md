---
title: "High Nitrites and Nitrates During Cycling: What's Normal and What to Do"
description: "A nitrite spike partway through the nitrogen cycle is normal and expected — but it's also the most dangerous phase for fish if you're cycling with fish in the tank. Here's what's happening and how to manage it."
slug: "high-nitrites-and-nitrates-during-cycle"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "A nitrite spike midway through the nitrogen cycle is a normal, expected stage — but it's also the riskiest phase for fish if you're cycling with fish present, and it's worth understanding before it happens."
tags: ["nitrogen cycle", "nitrite", "nitrate", "water chemistry", "fish-in cycling"]
quickFacts:
  - label: "What's Happening"
    value: "Ammonia-oxidizing bacteria convert ammonia to nitrite; nitrite-oxidizing bacteria then convert nitrite to nitrate"
  - label: "Nitrite Spike Timing"
    value: "Typically appears 1-2 weeks into a cycle and can persist for several weeks before dropping"
  - label: "Nitrite Toxicity"
    value: "Highly toxic to fish even at low levels — should read 0 ppm in an established, fully cycled tank"
  - label: "Nitrate Toxicity"
    value: "Far less toxic than nitrite; tolerated at higher levels but still managed with regular water changes"
  - label: "Fish-In Cycling Risk"
    value: "Elevated nitrite during fish-in cycling can cause 'brown blood disease' (methemoglobinemia)"
  - label: "What Helps During a Spike"
    value: "Frequent partial water changes, a detoxifying conditioner, and patience while bacteria establish"
  - label: "When It Resolves"
    value: "Nitrite typically drops to 0 once nitrite-oxidizing bacteria establish — often by the end of a 4-6 week cycle"
  - label: "Testing Needs"
    value: "A liquid test kit covering ammonia, nitrite, and nitrate is essential throughout cycling"
faq:
  - q: "Why do nitrite levels spike partway through the nitrogen cycle, and is this normal?"
    a: "**Yes, this is a completely normal and expected stage of cycling — in fact, its absence would be more concerning than its presence.** The nitrogen cycle happens in two main steps, driven by two different groups of bacteria: first, **ammonia-oxidizing bacteria** convert ammonia into nitrite, and second, **nitrite-oxidizing bacteria** convert that nitrite into nitrate. These two bacterial populations don't establish at the same rate — the ammonia-to-nitrite converters tend to get going faster, which means **nitrite accumulates** for a period before the second population catches up and starts converting it to nitrate. Seeing nitrite rise partway through a cycle is a sign the first stage is working; seeing it eventually fall back to zero is a sign the second stage has caught up."
  - q: "How dangerous is high nitrite to fish, and what are the signs?"
    a: "**Nitrite is highly toxic to fish, even at levels that might seem low on a test kit** — this is the main reason **fishless cycling** (cycling a tank before adding any fish) is generally recommended over fish-in cycling. Nitrite interferes with a fish's ability to transport oxygen in its blood, sometimes referred to as 'brown blood disease' (methemoglobinemia) — affected fish may show rapid or labored breathing, lethargy, or gasping at the surface, even if ammonia and oxygen levels seem otherwise fine. If you're fish-in cycling and see nitrite above 0, this is the point where active intervention (described below) matters most, not just patience."
  - q: "Is managing nitrate during cycling the same as managing nitrite?"
    a: "**No — nitrate and nitrite require very different levels of concern, even though the names sound similar.** Nitrite (highly toxic, target 0 ppm) is the more urgent of the two during cycling. **Nitrate**, the end product of the nitrogen cycle, is **far less toxic** — fish tolerate meaningfully higher nitrate levels than nitrite, and ongoing nitrate management (via regular water changes, live plants, or other export methods) is a normal part of long-term aquarium maintenance rather than a cycling-specific emergency. It's worth noting that nitrate isn't always something to remove, either — our [guide to adding nitrate to an aquarium](/how-to-add-nitrate-to-an-aquarium/) covers situations where a tank actually needs *more* nitrate, which can come as a surprise to anyone used to thinking of nitrate purely as waste to be removed."
  - q: "What can I do to get through a nitrite spike safely, especially if I'm fish-in cycling?"
    a: "**Frequent partial water changes are the most direct tool** — they dilute nitrite (and ammonia) without removing the beneficial bacteria colonizing your filter media and surfaces, which is what you actually want to keep growing during a cycle. A water conditioner that **detoxifies ammonia and nitrite** (our guides on [Seachem Prime's shelf life](/does-seachem-prime-go-bad/) and [how quickly Prime works](/how-long-does-prime-take-to-work-in-an-aquarium/) cover one widely used option) is commonly used as a temporary buffer during this phase — it doesn't stop the cycle or remove nitrite permanently, but it can reduce the toxicity of what's present between water changes. **Live plants** are another option worth knowing about — our [guide to plants for nitrite control](/best-plants-for-nitrite-control/) covers species that take up nitrogen compounds directly, which can help take some pressure off during the spike. **Zeolite**, covered in our [guide to how zeolite works in an aquarium](/how-long-does-zeolite-take-to-work-aquarium/), is a different approach — a mineral media that binds ammonia directly, which indirectly reduces how much nitrite the first-stage bacteria produce in the first place."
related: ["does-seachem-prime-go-bad", "how-long-does-prime-take-to-work-in-an-aquarium", "how-long-does-zeolite-take-to-work-aquarium", "how-to-add-nitrate-to-an-aquarium", "best-plants-for-nitrite-control", "aquarium-filter-not-working-after-cleaning"]
sources:
  - label: "The Nitrogen Cycle in Aquariums — Seachem"
    url: "https://www.seachem.com/"
  - label: "Fishless Cycling and Nitrite Toxicity — Practical Fishkeeping"
...
- **A detoxifying water conditioner** — temporarily reduces the toxicity of ammonia and nitrite between water changes; see our guides on [Seachem Prime's shelf life](/does-seachem-prime-go-bad/) and [how quickly Prime works](/how-long-does-prime-take-to-work-in-an-aquarium/)
- **Live plants that take up nitrogen compounds** — our [guide to plants for nitrite control](/best-plants-for-nitrite-control/) covers species that can help reduce pressure during a spike
- **Zeolite media** — binds ammonia directly, which can reduce how much nitrite the first-stage bacteria produce; see our [guide to how zeolite works](/how-long-does-zeolite-take-to-work-aquarium/)
