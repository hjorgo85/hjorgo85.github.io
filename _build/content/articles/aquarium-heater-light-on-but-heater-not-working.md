---
title: "Aquarium Heater Light Is On But It's Not Heating: What's Wrong?"
description: "A heater's indicator light being on doesn't always mean it's working — it depends on whether the light shows power or active heating. Here's how to actually test it."
slug: "aquarium-heater-light-on-but-heater-not-working"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Whether a lit indicator means anything depends on what the light is actually wired to show — here's how to tell, and how to confirm with an independent thermometer."
tags: ["aquarium heater", "equipment troubleshooting", "water temperature", "equipment"]
quickFacts:
  - label: "Two Light Types"
    value: "\"Power\" lights stay on whenever the heater is plugged in; \"heating\" lights cycle on/off based on whether the element is actively drawing power"
  - label: "Power Light ≠ Working"
    value: "A power light being on only confirms electricity reaches the unit — not that the heating element or thermostat is functioning"
  - label: "The Reliable Test"
    value: "An independent thermometer placed away from the heater, checked over several hours against the heater's set temperature"
  - label: "Full Submersion Requirement"
    value: "Many heaters include a safety cutoff that disables heating if the unit isn't submerged to its minimum line"
  - label: "Most Common Failure"
    value: "Thermostat \"stuck off\" — the heating element never engages even when water is below the set temperature"
  - label: "Less Common but Serious"
    value: "Thermostat \"stuck on\" — heater continues past its set point, risking overheating"
  - label: "Gradual Drift"
    value: "Heaters can become less accurate over time before failing outright — set temperature no longer matches actual water temperature"
  - label: "Repair vs. Replace"
    value: "A confirmed-failed heater generally isn't repairable — replacement is the practical option"
faq:
  - q: "My heater's light is on, but the water doesn't seem to be getting warmer. What's wrong?"
...
related: ["how-long-do-aquarium-heaters-last", "how-does-an-aquarium-overflow-box-work", "aquarium-hood-light-not-working", "aquarium-pump-not-working", "how-long-can-fish-live-without-air-pump-or-filter", "fluval-fx6-air-trapped"]
sources:
  - label: "Aquarium Heater Troubleshooting — Practical Fishkeeping"
    url: "https://www.practicalfishkeeping.co.uk/"
  - label: "Heater Diagnostics Discussion — Reef2Reef New to the Hobby"
...
- **Stuck on** (less common, more serious) — the heater continues heating past its set point, risking overheating the tank. This is one of the reasons some keepers replace heaters proactively as they age, covered in [how long aquarium heaters typically last](/how-long-do-aquarium-heaters-last/).
