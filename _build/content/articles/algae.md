---
title: "Algae in Aquariums: Types, Causes, and How to Get It Under Control"
description: "Algae is the most common 'problem' in aquariums — but it's almost always a symptom of light and nutrient balance, not a standalone issue. Here's how to identify what you're dealing with and fix the cause."
slug: "algae"
type: "article"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Nearly every aquarium develops algae at some point — the difference between a tank with a passing algae phase and one with a chronic problem usually comes down to light and nutrients, not luck."
tags: ["algae", "aquarium plants", "tank maintenance", "water quality"]
quickFacts:
  - label: "Root Cause"
    value: "Excess light and/or nutrients (nitrate, phosphate) relative to what plants and algae-eaters consume"
  - label: "Most Common Types"
    value: "Green film/spot algae, brown algae (diatoms), black beard algae (BBA), green spot algae (GSA), cyanobacteria"
  - label: "New Tank Algae"
    value: "A brown diatom film is common during the first few weeks of cycling and is largely harmless"
  - label: "Cyanobacteria Isn't Algae"
    value: "It's a bacteria, and usually needs a different approach than true algae — see our calothrix algae guide"
  - label: "Algae Eaters"
    value: "Help manage existing algae but don't fix an underlying light or nutrient imbalance"
  - label: "Fastest Growth Drivers"
    value: "Excess light duration/intensity and nutrients from overfeeding, overstocking, or fertilizer overdosing"
  - label: "Manual Removal"
    value: "Useful short-term, but algae returns quickly if the underlying cause isn't addressed"
  - label: "When to Worry"
    value: "Rapid, repeated regrowth in the same spots after cleaning signals an imbalance, not a cleaning problem"
faq:
  - q: "Is some algae in a healthy aquarium normal?"
    a: "Yes. A small amount of green film algae on the glass, decor, or older leaves is normal in almost every established aquarium, and many keepers consider a light dusting of algae a sign that a tank has matured and developed a stable microbial community. The goal usually isn't 'zero algae' — it's algae growth slow enough that routine maintenance (glass scraping, water changes) keeps it from becoming visually dominant or smothering plants and slow-moving tank inhabitants."
  - q: "What causes a sudden algae bloom in an established tank?"
    a: "Almost always a recent change to light or nutrients: a longer photoperiod, a brighter bulb or fixture upgrade, a fertilizer dosing increase, overfeeding, a dead fish or plant decaying unnoticed, or a maintenance lapse (skipped water changes, a filter that hasn't been cleaned). Because established tanks are usually in a rough equilibrium, a bloom that appears 'out of nowhere' is a useful signal to think back over the last 1-2 weeks for what changed, rather than assuming the tank has simply 'gone bad.'"
  - q: "Will algae eaters fix an algae problem?"
    a: "They'll help manage it, but they don't address why the algae is growing in the first place. Fish and invertebrates marketed as algae eaters — nerite snails, [otocinclus](/otocinclus-fry/), certain plecos, and species like the [American flagfish](/american-flagfish/) for hair/beard algae — can meaningfully reduce existing algae and slow regrowth, but if light and nutrient levels stay the same, algae production stays the same too, and an algae-eating population that can't keep pace will simply be outpaced by regrowth."
  - q: "Is cyanobacteria ('blue-green algae') the same thing as algae?"
    a: "No, despite the common name. Cyanobacteria is a type of bacteria that photosynthesizes like algae and often forms similar-looking films or tufts, but it responds differently to typical algae treatments and is frequently linked to dead spots with poor flow and organic buildup rather than simple light/nutrient excess. Our [Calothrix algae guide](/calothrix-algae/) covers one common cyanobacteria type in more detail, including how to tell it apart from true algae."
related: ["how-long-does-it-take-for-algae-to-grow", "calothrix-algae", "grey-algae", "anubias-rot", "lawnmower-blenny-and-hair-algae", "american-flagfish"]
sources:
  - label: "Algae Control in the Aquarium — Practical Fishkeeping"
...
- **Brown algae (diatoms)** — a brownish, dusty film that's extremely common in new tanks during the first few weeks of cycling. See our guide on [how long it takes algae to grow](/how-long-does-it-take-for-algae-to-grow/) for the typical new-tank timeline.
...
- **Green spot algae (GSA)** — small, hard, circular green spots, often on glass and slow-growing leaves (anubias, [java fern](/algae-on-java-fern/)), frequently linked to low phosphate relative to other nutrients or aging bulbs.
...
The algae you'll see in a brand-new tank and the algae that suddenly appears in a tank that's been algae-free for months are usually different situations with different causes. New-tank algae (often brown diatoms) is largely a function of the tank still maturing — surfaces are "blank slates" for colonization, and the bacterial/plant community that would normally compete for nutrients hasn't established yet. This typically fades over the first several weeks without intervention, often around the same time the nitrogen cycle itself settles — see our [guide to plants and nitrite during cycling](/best-plants-for-nitrite-control/) for how those two timelines relate. A larger newly-planted tank, like the [75-gallon planted setup](/planted-75-gallon-aquarium/) we cover separately, goes through the same process — size doesn't exempt a tank from this early period.

A sudden bloom in an established tank is different — it usually means **something changed**: more light, more food, a fertilizer increase, a skipped maintenance cycle, or a decaying fish/plant. Our [guide to algae growth timelines](/how-long-does-it-take-for-algae-to-grow/) covers both scenarios in more depth, including how quickly different algae types can take hold.

## Algae Eaters and Manual Removal: Useful, But Not a Fix

Algae-eating fish, snails, and shrimp — along with manual scraping and siphoning — are valuable **management tools**, not solutions to an underlying imbalance. Species like [nerite snails](/nerite-snails-vs-mystery-snails/) (grazing on film algae and diatoms) and the [American flagfish](/american-flagfish/) (one of the more reliable options against hair and beard algae) can meaningfully reduce algae and buy time while you address the root cause, but a tank that keeps producing algae faster than its cleanup crew can eat it will stay ahead of any reasonable population of algae-eaters. It's also worth planning around how [fast these algae eaters grow](/how-fast-do-algae-eaters-grow/) — a species that outgrows the available algae supply ends up needing supplemental feeding regardless of how well it did its job initially.
