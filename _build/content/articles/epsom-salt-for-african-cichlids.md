---
title: "Epsom Salt for African Cichlids: When It Helps and How to Use It"
description: "Epsom salt (magnesium sulfate) is a common home remedy for constipation and early bloat symptoms in African cichlids — here's what it actually does, when it's appropriate, and how to dose it safely."
slug: "epsom-salt-for-african-cichlids"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "Epsom salt is a widely used, low-risk supportive treatment for constipation and early bloat-like symptoms in African cichlids — but it's a supportive measure, not a cure, and dosing matters."
tags: ["cichlids", "freshwater", "fish health", "epsom salt"]
quickFacts:
  - label: "What It Is"
    value: "Magnesium sulfate (MgSO4) — unscented, additive-free Epsom salt"
  - label: "Primary Use"
    value: "Mild laxative for constipation and early bloat-like symptoms"
  - label: "Typical Dosage"
    value: "Roughly 1 tablespoon per 5-10 gallons in a hospital/quarantine tank"
  - label: "How It Works"
    value: "Draws water into the intestine, helping promote bowel movement"
  - label: "Where to Use It"
    value: "A separate hospital/quarantine tank, not the main display"
  - label: "What It Doesn't Treat"
    value: "Infections, parasites, or advanced Malawi bloat with organ involvement"
  - label: "Duration"
    value: "Often used for a few days, alongside fasting and water quality checks"
  - label: "Risk Level"
    value: "Low risk at correct dosage, but not a substitute for diagnosis"
faq:
  - q: "What does Epsom salt do for cichlids?"
    a: "Epsom salt is magnesium sulfate, and in an aquarium context it's most commonly used as a mild laxative. The magnesium sulfate draws water into the intestinal tract, which can help relieve constipation and promote a bowel movement in a fish that's bloated, not eating, or hasn't passed waste normally. It's a widely used home remedy for early-stage digestive issues, including some of the early symptoms sometimes seen before more serious conditions like [Malawi bloat](/best-food-for-mbuna-cichlids/) become advanced."
  - q: "How much Epsom salt should I use for a cichlid with bloat?"
    a: "A commonly cited starting dosage is roughly 1 tablespoon of plain, unscented Epsom salt per 5-10 gallons of water, typically used in a separate hospital or quarantine tank rather than the main display — partly because the goal is treating one fish without affecting your whole tank's chemistry, and partly so you can observe the fish closely. Always use plain Epsom salt with no added fragrances, dyes, or other ingredients, since those additives aren't meant for aquarium use."
  - q: "Can Epsom salt cure Malawi bloat?"
    a: "Epsom salt can help with the early, milder end of bloat-related symptoms — constipation, mild swelling, a fish that's stopped eating but otherwise seems alert — by supporting digestion. It is not a cure for advanced Malawi bloat, which can involve organ damage, a parasitic component (Hexamita), and other factors beyond simple constipation. If a fish doesn't show improvement within a few days, or if symptoms are severe from the start (significant swelling, loss of balance, rapid breathing), Epsom salt alone isn't an adequate response — at that point you're dealing with something that's progressed past what a laxative can address, and the focus should shift to water quality (see our guide on [cloudy eyes in cichlids](/cichlids-with-cloudy-eyes/) for a related water-quality-driven symptom) and potentially veterinary or more targeted medication."
  - q: "Is Epsom salt safe to add to a whole African cichlid tank?"
    a: "It's generally considered safer to treat in a separate hospital or quarantine tank rather than dosing the entire display, for a few reasons: it lets you target the affected fish without changing water chemistry for the whole tank (African cichlids already need carefully maintained hard, alkaline water — see our [75-gallon peacock cichlid tank guide](/75-gallon-peacock-cichlid-tank/) for more on Lake Malawi water parameters), it makes it easier to observe whether the treatment is working, and it avoids exposing healthy fish to a treatment they don't need. A 10-20 gallon tank with basic filtration and a heater is sufficient for this purpose. Epsom salt and general/carbonate hardness aren't the same thing, though — if your goal is maintaining the harder, more alkaline water Lake Malawi cichlids need on an ongoing basis (rather than treating an individual fish), that's more commonly addressed with substrate or filter media like [crushed coral](/how-much-crushed-coral-to-raise-ph/), which works on pH and KH rather than magnesium specifically."
related: ["best-food-for-mbuna-cichlids", "cichlids-with-cloudy-eyes", "75-gallon-peacock-cichlid-tank", "driftwood-cichlid-tank", "bala-sharks-with-cichlids", "how-much-crushed-coral-to-raise-ph"]
sources:
...
This overlaps significantly with the early stages of what's often called "Malawi bloat" — a condition strongly linked to diet in Mbuna and other Lake Malawi cichlids, covered in detail in our [Mbuna diet guide](/best-food-for-mbuna-cichlids/), and relevant to popular Mbuna species like the ones compared in our [johanni vs. maingano guide](/johanni-vs-maingano/). Catching these symptoms early, when they're still primarily digestive rather than involving organ damage, is when Epsom salt has the best chance of helping.
...
- **Water-quality-driven symptoms** — if the underlying issue is poor water quality (a topic also relevant to symptoms like the ones in our [cloudy eyes in cichlids guide](/cichlids-with-cloudy-eyes/)), the fix is correcting water parameters, not a laxative.
