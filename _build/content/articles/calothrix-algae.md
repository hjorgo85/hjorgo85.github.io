---
title: "Calothrix Algae: Identification and How to Get Rid of It"
description: "Calothrix is a cyanobacteria often mistaken for black beard algae — dark, hair-like tufts that respond to flow and nutrient fixes differently than true algae does."
slug: "calothrix-algae"
type: "article"
category: "aquarium-plants"
categoryLabel: "Aquarium Plants & Algae"
categoryUrl: "/aquarium-plants/"
author: "hektor-jorgo"
datePublished: "2028-02-15"
dateModified: "2026-06-14"
image: "/assets/img/articles/calothrix-algae.webp"
imageAlt: "Dark tufted cyanobacteria growth on aquarium hardscape, often confused with black beard algae"
imageWidth: 1200
imageHeight: 800
excerpt: "Calothrix forms dark, hair-like tufts that look a lot like black beard algae — but it's cyanobacteria, not true algae, and that distinction changes how you treat it."
tags: ["algae", "cyanobacteria", "aquarium plants", "tank maintenance"]
quickFacts:
  - label: "What It Is"
    value: "A genus of filamentous cyanobacteria (blue-green algae), not a true algae"
  - label: "Appearance"
    value: "Dark green to black, hair-like or tufted growths on hardscape, plant leaves, and slow-flow areas"
  - label: "Often Confused With"
    value: "Black beard algae (BBA) — but Calothrix is bacteria and responds differently to treatment"
  - label: "Smell Test"
    value: "Cyanobacteria often has a musty/earthy smell when disturbed; true algae generally doesn't"
  - label: "Common Triggers"
    value: "Low flow/dead spots, nutrient imbalances (often low nitrate relative to phosphate), organic buildup"
  - label: "Manual Removal"
    value: "Can be siphoned out, but tends to return quickly if flow and nutrients aren't addressed"
  - label: "Chemical Treatments"
    value: "Erythromycin-based products can work but carry risks to the biofilter and are usually a last resort"
  - label: "Best Long-Term Fix"
    value: "Improve flow to dead spots, correct nutrient imbalance, and manually remove during the adjustment period"
faq:
  - q: "How do I know if it's Calothrix or black beard algae?"
    a: "The two are easy to confuse at a glance because both form dark, hair-like tufts, but there are a few practical differences. Calothrix and other cyanobacteria often have a slimy texture and can be peeled away in sheets, sometimes with a musty or earthy smell when disturbed. Black beard algae (BBA) is a true algae with a coarser, bristle-like texture that's harder to remove and doesn't typically have the same smell. If scraping or siphoning a patch produces a slimy mat that lifts off relatively easily and smells distinctly 'off,' cyanobacteria like Calothrix is the more likely culprit; if it's tough, wiry, and clings stubbornly to leaves and hardscape, BBA is more likely. Our [general algae guide](/algae/) covers BBA and other true algae types for comparison."
  - q: "What causes Calothrix to start growing?"
    a: "Cyanobacteria generally takes hold in **low-flow areas** where organic matter accumulates — behind decor, in substrate corners with poor circulation, or anywhere debris settles without being swept away by filter flow. It's also frequently associated with nutrient imbalances, particularly low nitrate relative to phosphate, which can happen in tanks that are heavily planted (using up nitrate quickly) but still accumulating phosphate from food and fertilizers. Our [canister filter placement guide](/canister-filter-inlet-outlet-placement/) covers how flow patterns affect dead spots, which is directly relevant to where cyanobacteria tends to establish."
  - q: "Will a UV sterilizer get rid of Calothrix?"
...
Because it photosynthesizes and forms similar-looking mats to true algae, it's commonly lumped in with "algae problems" — but its biology, causes, and treatment overlap only partially with true algae, which is covered more broadly in our [algae guide](/algae/).
