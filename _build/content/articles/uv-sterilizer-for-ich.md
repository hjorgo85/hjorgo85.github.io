---
title: "Do UV Sterilizers Work for Ich? What They Can and Can't Do"
description: "A UV sterilizer can kill the free-swimming stage of ich as it passes through the unit, but it doesn't reach the parasite while it's on the fish — useful as a supplementary tool, not a standalone cure."
slug: "uv-sterilizer-for-ich"
type: "article"
...
**A UV sterilizer can kill the free-swimming ("theront") stage of the ich parasite as water passes through the unit**, which reduces how many new parasites are available to infect fish and helps limit how fast an outbreak spreads or recurs. **It has no effect on the parasite while it's embedded in a fish** (the trophont stage, producing the visible white spots) or while it's encysted on a surface in the tank (the tomont stage). An active outbreak still needs **medication-based treatment** — covered in our broader [parasite guide](/combating-parasites-in-aquarium-fish/) — with UV as a **supplementary** measure alongside it, not a replacement for it.
...
Either way, UV is **additive to quarantine**, not a substitute for it — [quarantining new fish](/combating-parasites-in-aquarium-fish/) remains the single most effective prevention measure against introducing parasites in the first place.
