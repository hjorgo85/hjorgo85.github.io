---
title: "Acceptable TDS for Reef Tank Source Water: Ideal Readings & TDS Creep"
description: "What TDS means for reef tank RO/DI water, the ideal reading at the RO/DI output, why TDS creep signals exhausted DI resin, and how rising TDS feeds algae and harms corals."
slug: "acceptable-tds-reef-tank"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "TDS at the RO/DI output should read 0 ppm. Here's why 0 is the real target, what a creeping reading actually means for your reef, and when it's telling you the DI resin is done."
tags: ["saltwater", "reef tank", "water chemistry", "RO/DI", "aquarium maintenance"]
quickFacts:
  - label: "Ideal TDS (RO/DI Output)"
    value: "0 ppm"
  - label: "Acceptable TDS Range"
    value: "0-1 ppm; some reefers tolerate up to 2 ppm short-term, but rising readings always warrant action"
  - label: "What TDS Measures"
    value: "Total Dissolved Solids — the combined concentration of dissolved minerals, salts, metals, and ions in water, in parts per million (ppm)"
  - label: "Common Cause of Rising TDS"
    value: "Exhausted DI (deionization) resin no longer stripping ions after the RO membrane stage"
  - label: "Measurement Tool"
    value: "Inline or handheld TDS meter (TDS pen), placed at the RO/DI output"
  - label: "When to Change DI Resin"
    value: "As soon as TDS rises above 0 ppm — this is the standard signal known as 'TDS creep'"
  - label: "Risk of High TDS"
    value: "Silicates and phosphates fueling diatoms and nuisance algae, dissolved organics stressing corals, and contaminant buildup over time"
  - label: "Where to Test"
    value: "At the RO/DI output before storage, not from tap water or display tank water"
faq:
  - q: "What TDS level is safe for a reef tank?"
    a: "Aim for 0 ppm at the RO/DI output. Many reefers consider 1-2 ppm acceptable for short periods without major issues, but 0 ppm is what a correctly functioning RO/DI unit should produce, and any sustained reading above 0 means dissolved solids are reaching your tank that shouldn't be there. There isn't really a 'safe maximum' beyond which damage suddenly occurs — it's a gradual relationship where higher and more sustained TDS means a greater nutrient and contaminant load over time."
  - q: "Why does my TDS keep rising even though my RO/DI unit is new?"
    a: "The most common cause is exhausted DI resin — this is normal and expected, not a defect. DI resin has a finite ion-exchange capacity, and once it's used up, TDS at the output starts climbing even though the RO membrane stage may still be working fine. Check the TDS reading between the RO and DI stages: if it's stable there but rising after the DI stage, the resin needs replacing. If it's rising before the DI stage too, the RO membrane itself may be at fault."
  - q: "Can I use tap water for reef tank top-off if my RO/DI unit isn't working?"
    a: "No — tap water typically has a TDS of 50-400+ ppm along with chlorine or chloramine, which is exactly what RO/DI is designed to remove. Using tap water, even temporarily, introduces silicates, phosphates, chlorine, and other dissolved solids directly into your tank, which can trigger algae blooms and stress corals and fish. If your RO/DI unit is down, it's better to use stored RO/DI water you already have on hand, or purchase pre-made RO/DI water from a local fish store, rather than substitute tap water."
  - q: "How often should I replace DI resin in my reef tank's RO/DI unit?"
    a: "There's no fixed time interval — replace it based on TDS readings, not a calendar. As soon as your TDS meter shows a reading above 0 ppm at the DI output, the resin is exhausted and should be replaced. How long that takes depends heavily on your tap water's starting TDS and how much water you run through the unit; high-TDS source water or heavy usage will exhaust resin faster than low-TDS source water and occasional use."
related: ["specific-gravity-reef-tank", "problems-with-high-magnesium-in-a-reef-tank", "raise-alkalinity-reef-tank", "clownfish-salinity-aquarium", "diatoms-reef-tank"]
sources:
  - label: "Water Chemistry Forum — Reef2Reef"
    url: "https://www.reef2reef.com/forums/water-chemistry.23/"
  - label: "RO/DI Systems & Replacement Filters — Bulk Reef Supply"
    url: "https://www.bulkreefsupply.com/ro-di-systems.html"
---
...
This is part of why overall reef water chemistry — TDS, salinity, [alkalinity](/raise-alkalinity-reef-tank/), calcium, and magnesium together — needs to be treated as a connected system rather than a set of isolated numbers. A clean source water foundation makes every other parameter easier to hold stable.
...
This same source water is also what you'll use to mix new saltwater batches, which directly affects your tank's [salinity and specific gravity](/clownfish-salinity-aquarium/) — starting with 0 ppm water means the only dissolved solids going into your mixing bucket are the ones from your salt mix itself, which is exactly what you want.
