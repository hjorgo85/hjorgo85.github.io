---
title: "How Many Azure Damselfish Should I Get? Group Size by Tank Size"
description: "Azure damselfish form loose aggregations in the wild, but home aquariums are a different story. Here's how many you can realistically keep together, and how to do it without constant fighting."
slug: "how-many-azure-damselfish-should-i-get"
type: "article"
category: "saltwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "In the wild, azure damselfish gather in loose groups over open reef flats. In a home aquarium, that same instinct can turn into constant low-grade conflict — unless you set the tank up the right way."
tags: ["damselfish", "saltwater", "stocking guide", "fish behavior"]
quickFacts:
  - label: "Wild Behavior"
    value: "Loose aggregations over open rubble/sand near reef cover"
  - label: "Aquarium Default"
    value: "One azure damselfish per tank is the safest, lowest-conflict option"
  - label: "Minimum Tank for a Group"
    value: "50+ gallons, with rockwork divided into multiple distinct territories"
  - label: "Key Technique"
    value: "Add all individuals simultaneously, not one at a time"
  - label: "Common Mistake"
    value: "Adding a second azure damselfish weeks or months after the first"
  - label: "Mixing With Other Blue Damsels"
    value: "Higher conflict risk — same rivalry response as same-species conflict"
  - label: "Tank Size Scaling"
    value: "Roughly: 1 per 20 gal in a single-species small group, more rock = more individuals tolerated"
  - label: "Signs of Too Many"
    value: "Persistent chasing, one fish hiding constantly, fin damage, refusal to eat"
faq:
  - q: "Can I keep two azure damselfish together?"
    a: "It's possible, but it's a meaningfully different setup than keeping one. Two azure damselfish (Chrysiptera hemicyanea) added to an established tank at different times will very likely result in the established fish aggressively defending its territory against the newcomer. The more reliable approach — covered in our [main azure damselfish guide](/azure-damselfish/) — is adding multiple individuals simultaneously to a tank with at least 50 gallons and rockwork divided into separate territories, ideally as part of the tank's initial stocking rather than added to an existing setup."
  - q: "Is one azure damselfish enough, or do they need company?"
    a: "One is enough — and for most home aquariums, it's the recommended approach. Unlike genuinely shoaling fish that show stress or abnormal behavior when kept singly, azure damselfish in captivity do perfectly well as a single individual, claiming a territory and behaving normally without other azure damselfish present. The 'loose aggregation' behavior seen in the wild is a response to open-reef conditions with abundant space and shelter — it doesn't translate into a captive 'need' for company the way it might for a true schooling fish."
  - q: "What happens if I add too many azure damselfish to my tank?"
    a: "The most common outcome is persistent, low-grade aggression — one or two individuals (usually the first-established fish, or the largest) chasing others away from food and shelter, sometimes constantly. Signs this is happening include one or more fish hiding most of the time, visible fin damage or fraying, and reduced feeding in the targeted individual(s). Unlike a single territorial azure damsel (which is a normal, manageable behavior pattern), this kind of sustained one-sided conflict tends to escalate rather than settle down on its own, and usually requires either rehoming the aggressor, the target, or significantly increasing tank size and rockwork."
  - q: "Can azure damselfish be kept with other blue damselfish species?"
    a: "It's riskier than keeping azure damselfish with differently colored or shaped fish. As covered in our guides to the [blue devil damselfish](/blue-devil-damselfish/) and [domino damselfish](/domino-damselfish/), damselfish tend to direct territorial aggression at fish that resemble potential rivals — and other blue Chrysiptera species are the closest visual match an azure damselfish will encounter. The same simultaneous-introduction, large-tank, multiple-territory approach used for same-species groups applies here, but with less margin for error."
related: ["azure-damselfish", "domino-damselfish", "blue-devil-damselfish", "saltwater-aquarium-fish-for-beginners", "saltwater-fish-for-30-gallon-tank"]
sources:
  - label: "Chrysiptera hemicyanea — FishBase"
    url: "https://www.fishbase.se/summary/Chrysiptera-hemicyanea.html"
  - label: "Damselfish Aggression & Group Stocking — Reef2Reef"
...
- **One azure damselfish** — works in almost any appropriately sized tank (20+ gallons per our [main care guide](/azure-damselfish/)). No group dynamics to manage.
...
3. **Avoid adding other blue *Chrysiptera* species** (like the [blue devil damselfish](/blue-devil-damselfish/)) to the same tank as a group of azure damselfish — this multiplies the number of fish reading each other as rivals, on top of the within-species dynamics already at play.
...
- [ ] Avoid combining with other blue *Chrysiptera* species (e.g., [blue devil damselfish](/blue-devil-damselfish/))
- [ ] Some settling-in squabbling is normal; persistent one-sided chasing past 2-3 weeks is not
- [ ] If considering a larger tank for a group, see our [30-gallon](/saltwater-fish-for-30-gallon-tank/) and beyond stocking guides for how this fits into a broader plan
