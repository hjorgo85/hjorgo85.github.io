---
title: "'Neon Tetra Fungus': Is It Actually a Fungal Infection or Neon Tetra Disease?"
description: "What looks like 'fungus' on a neon tetra could be a true fungal infection — or it could be neon tetra disease, an incurable parasitic condition with a very different outlook."
slug: "neon-tetra-fungus"
type: "article"
category: "freshwater"
...
imageWidth: 1200
imageHeight: 800
excerpt: "'Fungus' on a neon tetra usually means one of two very different things — a treatable fungal infection, or neon tetra disease, which isn't a fungus and has no reliable cure."
tags: ["neon tetra", "freshwater", "fish health", "tetra disease"]
quickFacts:
  - label: "True Fungal Infections"
    value: "Cottony, white, thread-like growths on the body or fins — generally treatable with antifungal medication"
  - label: "'Neon Tetra Disease' (NTD)"
    value: "Caused by Pleistophora hyphessobryconis, a microsporidian parasite — not a fungus"
  - label: "Is NTD Curable?"
    value: "No reliable cure once symptoms are visible"
  - label: "Key NTD Symptoms"
    value: "Patchy color loss/fading, restlessness then lethargy, muscle wasting, spinal curvature in advanced cases"
  - label: "Key Visual Difference"
    value: "Visible cottony growth = likely true fungal infection; color loss/wasting without growth = possible NTD"
  - label: "Is NTD Contagious?"
    value: "Yes, particularly to other tetras and related species — isolation is important"
  - label: "What to Do for Suspected NTD"
    value: "Isolate affected fish; many keepers consider humane euthanasia to prevent spread, given the lack of cure"
  - label: "Prevention"
    value: "Quarantine new fish, avoid unverified live foods (a known transmission route)"
faq:
  - q: "What does 'neon tetra fungus' usually refer to?"
    a: "It can mean one of two quite different things, and telling them apart matters a lot for what happens next. **True fungal infections** in neon tetras look like other fungal infections in fish generally — cottony, white, thread-like growths on the body, fins, or mouth — and are usually treatable with antifungal medication, similar in principle to fungal issues discussed for other species like [betta fish](/betta-fish-care-guide/). **'Neon tetra disease' (NTD)**, despite the name sometimes leading people to search for 'fungus,' is actually caused by a **microsporidian parasite** (Pleistophora hyphessobryconis) — not a fungus at all — and has a much more serious outlook, since there's no reliable cure once it's established."
  - q: "What is neon tetra disease, and how serious is it?"
    a: "Neon tetra disease (NTD) is caused by *Pleistophora hyphessobryconis*, a parasite that infects the muscle tissue of neon tetras and related species. Symptoms typically include **patchy loss of the fish's normal coloration** (especially the neon stripe becoming faded or broken up), **restlessness that progresses to lethargy**, **loss of appetite**, and in advanced cases, **visible muscle wasting and spinal curvature**. Unlike many fish health issues that can be addressed with water quality improvements or medication, **NTD has no reliable treatment** once symptoms are visible — a similarly difficult situation to the [fish tuberculosis discussed for guppies](/guppy-tuberculosis/), where the lack of a cure (rather than the severity of any single symptom) is what makes the diagnosis significant."
  - q: "How can I tell true fungus apart from neon tetra disease?"
    a: "The most useful distinguishing feature is **visible growth**: true fungal infections produce cottony, white, fuzzy material on the fish's body or fins — something physically growing on the surface. Neon tetra disease doesn't produce this kind of growth; instead, it causes **internal muscle changes that show up as color loss, wasting, and eventually skeletal deformity** (like the spinal curvature sometimes discussed in the context of [why goldfish look deformed](/why-do-goldfish-look-deformed/), though the underlying causes differ). A fish with a cottony patch is more likely dealing with a treatable fungal infection; a fish that's losing color and wasting away without any visible growth is more concerning for NTD."
  - q: "What should I do if I suspect neon tetra disease in my tank?"
    a: "**Isolate the affected fish immediately** — NTD is contagious, particularly to other tetras and related species sharing the tank, and a transmission route via live foods (especially tubifex worms from unverified sources) is well-documented. Because there's no reliable cure, many keepers face a difficult decision around **humane euthanasia** for severely affected fish, both to prevent further spread within the tank and because the prognosis for recovery is poor. For the rest of the tank, monitoring for symptoms in other tetras and maintaining good water quality (which won't cure NTD but supports overall fish health) is the realistic next step. Going forward, **quarantining new fish** before adding them to an established tank — a practice that's relevant across many of the health topics covered on this site, including [bloated cory catfish](/bloated-cory-catfish/) — is the main prevention tool."
related: ["black-skirt-tetra-being-aggressive", "guppy-tuberculosis", "bloated-cory-catfish", "endlers-5-gallon-tank", "dwarf-gouramis", "methylene-blue-vs-malachite-green"]
sources:
  - label: "Paraophidium / Pleistophora hyphessobryconis — Freshwater Fish Disease Database"
    url: "https://www.fishbase.se/Nomenclature/FamilySummary.php?Family=Characidae"
  - label: "Neon Tetra Health & Disease Guide — Practical Fishkeeping"
